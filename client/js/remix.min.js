(function(e,n){function i(o,a,k){this.categories={};this.resources={};this.eventListeners=[];this.loadingCount=0;this.callbackQueue=[];this._head=b.getElementsByTagName("head")[0];o&&this.load(o,a,k)}var a,b=e.document,g=e.console;g===n&&(g={log:function(){}});var f=/^(([A-Za-z]+):\/\/)+(([a-zA-Z0-9\._\-]+\.[a-zA-Z]{2,6})|([0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3})|localhost)(\:([0-9]+))*(\/[^#]*)?(\#.*)?$/;if(!Array.prototype.indexOf)Array.prototype.indexOf=function(o){if(this===void 0||this===
null)throw new TypeError;var b=Object(this),a=b.length>>>0;if(a===0)return-1;var c=0;arguments.length>0&&(c=Number(arguments[1]),c!==c?c=0:c!==0&&c!==1/0&&c!==-(1/0)&&(c=(c>0||-1)*Math.floor(Math.abs(c))));if(c>=a)return-1;for(c=c>=0?c:Math.max(a-Math.abs(c),0);c<a;c++)if(c in b&&b[c]===o)return c;return-1};e.Loaderator=i;i.Category=function(o,a){this.name=o;this.resources=[];this.resourcesById={};this.loader=a;this.eventListeners={load:[],single:{}}};i.Category.prototype.addResource=function(a){var b=
...
c);else{if(o.push(a),!r){r=!0;var l=function(){n.removeEventListener("DOMContentLoaded",l,!1);for(var a=0,b=o.length;a<b;a++)o[a].call(n,c);o=null};n.addEventListener("DOMContentLoaded",l,!1)}}else{this.media=(j=d.exec(a))&&j.length&&j[2]?n.getElementById(j[2]):a;this[this.media.nodeName&&this.media.nodeName.toLowerCase()||"video"]=this.media;c.addInstance(this);this.options=b||{};this.data={disabled:[],events:{},history:[],trackEvents:{byStart:[{start:-1,end:-1}],byEnd:[{start:-1,end:-1}],animating:[],
startIndex:0,endIndex:0,previousUpdateTime:-1},loading:[],loadingListener:!1};var f=function(a){if(a.media.readyState>=2){var b=a.media.duration,b=b!=b?Number.MAX_VALUE:b+1;c.addTrackEvent(a,{start:b,end:b});a.media.addEventListener("timeupdate",function(c){a.data.timeupdateEvent=c},!1);var q=function(){var b=a.media.currentTime,d=a.data.trackEvents.previousUpdateTime,j=a.data.trackEvents,h=j.byEnd,l=j.byStart,f=j.animating,s=a.data.timeupdateEvent,v=0;if(d<b){for(;h[j.endIndex]&&h[j.endIndex].end<=
b;)if(!h[j.endIndex]._natives||a[h[j.endIndex]._natives.type]){if(h[j.endIndex]._running===!0)h[j.endIndex]._running=!1,h[j.endIndex]._natives.end.call(a,s,h[j.endIndex]);j.endIndex++}else{c.removeTrackEvent(a,h[j.endIndex]._id);return}for(;l[j.startIndex]&&l[j.startIndex].start<=b;)if(!l[j.startIndex]._natives||a[l[j.startIndex]._natives.type]){if(l[j.startIndex].end>b&&l[j.startIndex]._running===!1&&a.data.disabled.indexOf(l[j.startIndex]._natives.type)===-1)l[j.startIndex]._running=!0,l[j.startIndex]._natives.start.call(a,
s,l[j.startIndex]),l[j.startIndex]._natives.frame&&f.push(l[j.startIndex]);j.startIndex++}else{c.removeTrackEvent(a,l[j.startIndex]._id);return}for(;v<f.length;)f[v]._running==!1?f.splice(v,1):(f[v]._natives.frame.call(a,s,f[v],b),v++)}else if(d>b){for(;l[j.startIndex]&&l[j.startIndex].start>b;)if(!l[j.startIndex]._natives||a[l[j.startIndex]._natives.type]){if(l[j.startIndex]._running===!0)l[j.startIndex]._running=!1,l[j.startIndex]._natives.end.call(a,s,l[j.startIndex]);j.startIndex--}else{c.removeTrackEvent(a,
l[j.startIndex]._id);return}for(;h[j.endIndex]&&h[j.endIndex].end>b;)if(!h[j.endIndex]._natives||a[h[j.endIndex]._natives.type]){if(h[j.endIndex].start<=b&&h[j.endIndex]._running===!1&&a.data.disabled.indexOf(l[j.endIndex]._natives.type)===-1)h[j.endIndex]._running=!0,h[j.endIndex]._natives.start.call(a,s,h[j.endIndex]),h[j.endIndex]._natives.frame&&f.push(h[j.endIndex]);j.endIndex--}else{c.removeTrackEvent(a,h[j.endIndex]._id);return}for(;v<f.length;)f[v]._running==!1?f.splice(v,1):(f[v]._natives.frame.call(a,
...
"function"||typeof b!=="string")){var l={};l[a]=function(a,l){if(!a)return this;var g=this;c.xhr({url:a,dataType:b,success:function(a){var b,c,e=0,a=d(a).data||[];if(b=a.length){for(;e<b;e++){c=a[e];for(var h in c)if(f.call(c,h)&&g[h])g[h](c[h])}l&&l()}}});return this};c.extend(c.p,l);return l}};var t=/\?/,u={url:"",data:"",dataType:"",success:c.nop,type:"GET",async:!0,xhr:function(){return new e.XMLHttpRequest}};c.xhr=function(a){a.dataType=a.dataType&&a.dataType.toLowerCase()||null;if(a.dataType&&
...
json:c};a.dataType&&(b=b[a.dataType]);a.success.call(a.ajax,b)}};return b};c.xhr.getJSONP=function(a,b,d){if(d&&n.querySelectorAll('script[src="'+a+'"]').length)b&&b(!0);else{var f=n.head||n.getElementsByTagName("head")[0]||n.documentElement,g=n.createElement("script"),e=a.split("?")[1],i=!1,m=[],k,o;e&&!d&&(m=e.split("&"));m.length&&(o=m[m.length-1].split("="));k=m.length?o[1]?o[1]:o[0]:"jsonp";!e&&!d&&(a+="?callback="+k);k&&!d&&(window[k]&&(k=c.guid(k)),window[k]=function(a){b&&b(a);i=!0},a=a.replace(o.join("="),
...
i.evaluate("//dc:description",k,b,XPathResult.FIRST_ORDERED_NODE_TYPE,null),n=n&&n.singleNodeValue?n.singleNodeValue.firstChild.nodeValue||"":"",o=i.evaluate("//dc:source",k,b,XPathResult.FIRST_ORDERED_NODE_TYPE,null);o=o&&o.singleNodeValue?o.singleNodeValue.firstChild.nodeValue||"":(o=i.evaluate("//europeana:provider",k,b,XPathResult.FIRST_ORDERED_NODE_TYPE,null))&&o.singleNodeValue?o.singleNodeValue.firstChild.nodeValue||"":"";o&&(o="/"+o);h=(i=i.evaluate("//europeana:object",k,b,XPathResult.FIRST_ORDERED_NODE_TYPE,
...
a.left;g=document.createElement("div");g.style.position="relative";b.appendChild(g);var I=function(){m="http://api.flickr.com/services/feeds/photos_public.gne?";f&&(m+="id="+f+"&");a.tags&&(m+="tags="+a.tags+"&");m+="lang=en-us&format=json&jsoncallback=flickr";e.xhr.getJSONP(m,function(b){g.innerHTML="<p style='padding:"+q+";'>"+b.title+"<p/>";e.forEach(b.items,function(b,f){if(f<r)d=document.createElement("a"),d.setAttribute("href",b.link),d.setAttribute("target","_blank"),o=document.createElement("img"),
o.setAttribute("src",b.media.m),o.setAttribute("height",k),o.setAttribute("width",c),o.setAttribute("style","border:"+s+";padding:"+q),d.appendChild(o),g.appendChild(d),a.loaded=!0;else return!1})})},K=function(){f?setTimeout(function(){K()},5):(m="http://api.flickr.com/services/rest/?method=flickr.people.findByUsername&",m+="username="+a.username+"&api_key="+a.apikey+"&format=json&jsoncallback=flickr",e.getJSONP(m,function(a){f=a.user.nsid;I()}))},D=function(){if(j.media&&j.media.buffered){var b,
d,f=!1,h,l,i=j.media.buffered;for(b=0,d=i.length;b<d;b++)if(h=i.start(b),l=i.end(b),h>j.media.duration&&(h=0),h<=a.end&&l>=a.start){f=!0;break}if(!f){setTimeout(D,10);return}}m="http://api.flickr.com/services/rest/?method=flickr.photos.getInfo";a.apikey&&(m+="&api_key="+a.apikey);m+="&photo_id="+a.photoid+"&lang=en-us&format=json&jsoncallback=flickr";e.xhr.getJSONP(m,function(b){if(b&&b.stat==="ok"&&b.photo){var b=b.photo,d=document.createElement("img");d.src="http://farm"+b.farm+".static.flickr.com/"+
...
B,!1)}})};if(a.url&&!a.photoid){var h=/^((https?:\/\/)?(www\.)?flickr\.com\/photos\/[^\/]+\/)?(\d+)/.exec(a.url);if(h&&h.length>=5)a.photoid=h[4]}a.photoid?D():a.username&&a.apikey?K():(f=a.userid,I());h=a.end-a.start;if(isNaN(a.fadeIn))a.fadeIn=Math.min(0.25,h/8);else if(a.fadeIn>h)a.fadeIn=h;h-=a.fadeIn;if(isNaN(a.fadeOut))a.fadeOut=Math.min(0.25,(a.end-a.start)/8);else if(a.fadeOut>h)a.fadeIn=h;return{start:function(a,c){var d=function(){c.loaded?b.style.display="":setTimeout(d,1)};d()},end:function(){b.style.display=
...
c=document.createElement("div");c.style.position="relative";k.appendChild(c);var K=function(){if(u.media&&u.media.buffered){var a,b,f=!1,g,i,j=u.media.buffered;for(a=0,b=j.length;a<b;a++)if(g=j.start(a),i=j.end(a),g>u.media.duration&&(g=0),g<=d.end&&i>=d.start){f=!0;break}if(!f){setTimeout(K,10);return}}a="http://maps.googleapis.com/maps/api/staticmap?sensor=false&size=320x320&maptype=roadmap&"+[["center",d.center||d.location],["markers",d.location],["visible",d.location+"|"+d.center]].map(function(a){return a[0]+
...
'</a></div><div class="watch">view map</div>';b.getElementsByClassName("minimize").item(0).addEventListener("click",v,!1);c.appendChild(b);y=d.width;z=d.top;I=d.left;k.addEventListener("load",function(){var a=/(\d*(\.\d*)?)\s*(px|em|\%|em|rem)?/,b;if(d.width&&!d.height&&(b=a.exec(d.width))&&b.length>1)a=b[3]||"",b=parseFloat(b[1]),b=b*k.height/k.width,c.style.height=b+a;d.loaded=!0},!1);c.addEventListener("click",l,!1)};K();var D=d.end-d.start;if(isNaN(d.fadeIn))d.fadeIn=Math.min(0.25,D/8);else if(d.fadeIn>
D)d.fadeIn=D;D-=d.fadeIn;if(isNaN(d.fadeOut))d.fadeOut=Math.min(0.25,(d.end-d.start)/8);else if(d.fadeOut>D)d.fadeIn=D;if(!d.type)d.type="ROADMAP";e=document.createElement("div");e.id="actualmap"+a;e.style.width="100%";e.style.height="100%";e.style.top=0;e.style.left=0;e.style.position="absolute";a++;q=function(){g?d.location?(t=!0,f.geocode({address:d.location},function(a,b){b===google.maps.GeocoderStatus.OK?(d.lat=a[0].geometry.location.lat(),d.lng=a[0].geometry.location.lng(),r=new google.maps.LatLng(d.lat,
...
(new Date).getFullYear()&&(m+="."+a(d.getFullYear()));var o=document.createElement("time");o.setAttribute("datetime",d.getUTCFullYear()+"-"+a(d.getUTCMonth()+1)+"-"+a(d.getUTCDate())+"T"+a(d.getUTCHours())+":"+a(d.getUTCMinutes())+":"+a(d.getUTCSeconds())+"Z");o.innerHTML=m;b.appendChild(o);m=document.createElement("span");m.setAttribute("class","author");m.appendChild(document.createTextNode(e.author||"Anonymous"));b.appendChild(m);m=document.createElement("p");var d=/https?:\/\/([a-zA-Z0-9\.]+\.[a-zA-Z]{2,6}[^\s\n\r\t$]*)/gi,
r;for(r=0;o=d.exec(e.text);)m.appendChild(document.createTextNode(e.text.substr(r,o.index-r))),r=document.createElement("a"),r.setAttribute("href",o[0]),r.setAttribute("target","_new"),o[1].length>20?r.appendChild(document.createTextNode(o[1].substr(0,17)+"...")):r.appendChild(document.createTextNode(o[1])),r.addEventListener("click",function(){g=!1;f.pause()},!0),m.appendChild(r),r=o.index+o[0].length;r<e.text.length&&m.appendChild(document.createTextNode(e.text.substr(r)));b.appendChild(m);m=document.createElement("div");
...
d.style.position="relative";m.appendChild(d);var B=function(){if(u.media&&u.media.buffered){var a,g,i=!1,m,h,n=u.media.buffered;for(a=0,g=n.length;a<g;a++)if(m=n.start(a),h=n.end(a),m>u.media.duration&&(m=0),m<=f.end&&h>=f.start){i=!0;break}if(!i){setTimeout(B,10);return}}c="http://gdata.youtube.com/feeds/api/videos/"+f.videoid+"?v=2&alt=jsonc&callback=youtube";e.xhr.getJSONP(c,function(a){if(a&&a.data){var c=a.data;(a=f.url)||(a="http://www.youtube.com/watch?v="+c.id);var e=document.createElement("img");
...
a+'" target="_new">YouTube</a></span></div><div><a href="'+a+'" target="_new">'+c.title+'</a></div><div class="watch">watch video</div>';d.appendChild(h);a=document.createElement("span");a.innerHTML="minimize window";a.setAttribute("class","minimize");a.addEventListener("click",l,!1);d.appendChild(a);g();o=f.width;r=f.top;k=f.left;e.addEventListener("load",function(){var a=/(\d*(\.\d*)?)\s*(px|em|\%|em|rem)?/,b;if(f.width&&!f.height&&(b=a.exec(f.width))&&b.length>1)a=b[3]||"",b=parseFloat(b[1]),b=
...
c;if(a)if(a.pageX!==void 0||a.pageY!==void 0)b=a.pageX,c=a.pageY;else if(a.clientX!==void 0||a.clientY!==void 0)b=a.clientX+h.body.scrollLeft+h.documentElement.scrollLeft,c=a.clientY+h.body.scrollTop+h.documentElement.scrollTop;return{x:b,y:c}}function g(a,b){var c=b;a.x-=b.clientLeft+b.offsetLeft;for(a.y-=b.clientTop+b.offsetTop;(c=c.offsetParent)&&c.nodeName!=="BODY";)a.x-=c.clientLeft+c.offsetLeft,a.y-=c.clientTop+c.offsetTop}function f(){if(ia){var a=M.height-17,b=a*(1-p.volume),c=ia;c.shadowOffsetX=
0;c.shadowOffsetY=0;c.shadowBlur=0;c.clearRect(0,0,M.width,M.height);c.lineWidth=7;c.lineCap="round";var d=c.createLinearGradient(0,0,7,0);d.addColorStop(0,"rgba(112, 112, 112, 0.38)");d.addColorStop(1,"rgba(241, 241, 241, 0.38)");c.strokeStyle=d;c.beginPath();c.moveTo(8.5,8.5);c.lineTo(8.5,a+8.5);c.stroke();b+=8.5;c.strokeStyle="rgba(0, 0, 0, 0.3)";c.beginPath();c.moveTo(8.5,8.5);c.lineTo(8.5,b);c.stroke();c.beginPath();c.lineWidth=1;c.strokeStyle="rgb(96, 96, 96)";c.fillStyle="rgb(128, 128, 128)";
c.shadowOffsetX=1;c.shadowOffsetY=2;c.shadowBlur=5;c.shadowColor="rgba(0, 0, 0, 0.19)";c.arc(8.5,b,8.5,0,Math.PI*2,!0);c.fill();c.shadowOffsetX=0;c.shadowOffsetY=0;c.shadowBlur=0;c.beginPath();c.fillStyle="#02fdca";c.arc(8.5,b,3.5,0,Math.PI*2,!0);c.fill()}}function m(a){if(p.duration&&ba&&(a||!(wa===p.currentTime&&p.networkState>=4))){var b=C.width-17,a=b*p.currentTime/p.duration,c=ba;c.shadowOffsetX=0;c.shadowOffsetY=0;c.shadowBlur=0;c.clearRect(0,0,C.width,C.height);c.lineWidth=7;c.lineCap="round";
var d=c.createLinearGradient(0,0,0,7);d.addColorStop(0,"rgba(112, 112, 112, 0.38)");d.addColorStop(1,"rgba(241, 241, 241, 0.38)");c.strokeStyle=d;c.beginPath();c.moveTo(8.5,8.5);c.lineTo(b+8.5,8.5);c.stroke();var d=[],e,f,h,i=p.buffered,j=0;if(i){for(e=0,f=i.length;e<f;e++)h=i.start(e),h>p.duration&&(h=0),h!==j&&d.push({start:j,end:h}),j=i.end(e);j!==p.duration&&d.push({start:j,end:p.duration})}if(ca){e=j===p.duration?0:Math.floor(Date.now()/40)%8;c.strokeStyle=ca[e];for(e=0,f=d.length;e<f;e++)j=
d[e].start/p.duration*b,h=d[e].end/p.duration*b,c.beginPath(),c.moveTo(j+8.5,8.5),c.lineTo(h+8.5,8.5),c.stroke()}a+=8.5;c.strokeStyle="rgba(0, 0, 0, 0.3)";c.beginPath();c.moveTo(8.5,8.5);c.lineTo(a,8.5);c.stroke();b={x:da.x,y:da.y};g(b,C);b=Math.sqrt(Math.pow(b.x-a,2)+Math.pow(b.y-8.5,2))-20;b=Math.max(0,b);if(b<100&&(b=8.5*(1-b/100),b*2>7))c.beginPath(),c.lineWidth=1,c.fillStyle="rgb(128, 128, 128)",c.shadowOffsetX=1,c.shadowOffsetY=2,c.shadowBlur=5,c.shadowColor="rgba(0, 0, 0, 0.19)",c.arc(a,8.5,
b,0,Math.PI*2,!0),c.fill(),c.shadowOffsetX=0,c.shadowOffsetY=0,c.shadowBlur=0;c.beginPath();c.fillStyle="#02fdca";c.arc(a,8.5,3.5,0,Math.PI*2,!0);c.fill()}}function d(a){var b=e.innerWidth||800,c=e.innerHeight||b*9/16;if(a||b!==oa||c!==pa||!C.width){oa=b;pa=c;var d=U/V/(b/c),f,g,i,j,l,k;d>1.2?(k=Math.min(1,(d-1.2)/0.25),g=Math.min(k*30,Math.max(b-640,0)*0.1),i=Math.floor(b-g*2),l=i/U,j=Math.floor(V*l),f=(c*1.2/d-j)/2):d<1/1.05?(k=Math.min(1,(1/1.05-d)/0.2),f=Math.min(k*40,Math.max(b-360,0)*0.1),j=
Math.floor(c-f*2),l=j/V,i=Math.floor(U*l),g=(b*d/(1/1.05)-i)/2):(l=Math.min(c/V,b/U),i=Math.floor(U*l),j=Math.floor(V*l),g=(b-i)/2,f=(c-j)/2,k=0);h.body.style.overflow=i<640?"auto":"";if(qa!==k){if(k>0){if(Z.style.display!=="block")Z.style.display="block";Z.style.opacity=k;if($.style.display!=="block")$.style.display="block";$.style.opacity=k}else Z.style.display="none",$.style.display="none";qa=k}h.body.style.fontSize=Math.round(l*8)+"px";P.style.width=i+"px";P.style.height=j+"px";P.style.marginLeft=
g+"px";P.style.marginTop=f+"px";if(a||ra!==i){ra=i;a=C.parentNode;b=a.offsetWidth;for(c=0,d=a.childNodes.length;c<d;c++)f=a.childNodes[c],f.tagName&&f!==C&&(ja[f.id]===void 0&&f.offsetWidth>0&&(ja[f.id]=f.offsetWidth+6),b-=ja[f.id]);C.width=b-6;m(!0)}}J=Date.now()}function o(a){if(N&&(!a||!a.target||!(a.target!==a.currentTarget||a.target.classList.contains("button"))))h.getElementById("volume-controls").style.display="none",h.getElementById("settings-controls").style.display="none",h.getElementById("help-controls").style.display=
"none",h.getElementById("share-controls").style.display="none",N=!1}function r(a){var b=h.getElementById("comment-name"),c=h.getElementById("comment-email"),d=h.getElementById("comment-text"),e=h.getElementById("comment-post"),f;f=c.value;var g,i;for(g=0;g<f.length;g++)if(" \n\r\t\u000c".indexOf(f.charAt(g))<0)break;for(i=f.length-1;i>=g;i--)if(" \n\r\t\u000c".indexOf(f.charAt(i))<0)break;f=f.substring(g,i+1);b=b.value.length;f=!f.length||xa.test(f);if(a&&a.target===c)f?(h.getElementById("comment-email-invalid").style.display=
...
function k(){if(W){var a=Date.now()-J;m(a<=100);N&&a>5E3&&o();var b;if(p.paused||p.ended){if(sa!==(p.paused||p.ended))for(a=0,b=X.length;a<b;a++)X[a].style.opacity=1}else if(a<=5E3&&(a=da,W)){b=0.4*P.offsetWidth;var c=Math.max(0,1-(Date.now()-J)/5E3),d,e,f,h,i,j;for(d=0,e=X.length;d<e;d++)h=X[d],i=h.offsetWidth,j=h.offsetHeight,f={x:a.x,y:a.y},g(f,h),i=f.x<0?-f.x:f.x>i?f.x-i:0,f=f.y<0?-f.y:f.y>j?f.y-j:0,f=Math.sqrt(i*i+f*f),f=1-0.8*(f/b),f<0.2?f=0.2:f>1&&(f=1),h.style.opacity=c*f}sa=p.paused||p.ended;
p.duration?(a=n(p.currentTime),b=a+" / "+n(p.duration)):(a="-:--",b="-:-- / -:--");if(ma.innerHTML!==b)ma.innerHTML=b;if(F&&aa.innerHTML!==a)aa.innerHTML=a}na(k,P)}function c(){p.paused?p.play():p.ended?(p.currentTime=0,p.play()):p.pause()}function t(a){var b=h.getElementById(a+"-toggle");if(b)G[a]?(b.innerHTML=x==="de"?"ein":"On",b.classList.add("on")):(b.innerHTML=x==="de"?"aus":"Off",b.classList.remove("on"))}function u(){function a(b,c){var d=new XMLHttpRequest;d.open("GET","comments.php?"+(c?
"unflag":"flag")+"="+b,!0);d.send(null)}if(x){var b="comments.php?vtime="+(p.currentTime||0)+"&language="+x;if(fa[x]){if(Date.now()-fa[x]<5E3)return;b+="&since="+fa[x]/1E3}var c=new XMLHttpRequest;c.open("GET",b,!0);c.onreadystatechange=function(){if(c.readyState===4&&c.status===200){var b=JSON.parse(c.responseText),d,e,f;for(d=0,e=b.length;d<e;d++)if((f=b[d])&&!ga[f[0]])ga[f[0]]=f,w.videoComment({start:f[2],end:f[2]+5,id:f[0],author:f[4],text:f[5],date:f[1]*1E3,language:f[3],target:"comments",flagCallback:a})}};
c.send(null);fa[x]=Date.now()}}function q(a){a||u();h.documentElement.setAttribute("lang",x);for(var b,c=["en","de"],a=0;a<c.length;a++)b=h.getElementById("language-"+c[a]),c[a]===x?b.classList.add("on"):b.classList.remove("on");var d,e,f,g;for(a in R)if(R.hasOwnProperty(a)){b=h.querySelectorAll(a);d=(R[a][x]||"").split("\n");for(f=0,g=b.length;f<g;f++)if((c=b[f])&&d.length&&d[0].length){c.innerHTML="";c.appendChild(h.createTextNode(d[0]));for(e=1;e<d.length;e++)c.appendChild(h.createElement("br")),
c.appendChild(h.createTextNode(d[e]))}}if(F){c=["comment-email","comment-name","comment-text"];d=[];b=[];for(a=0;a<c.length;a++)b.push(h.getElementById(c[a])),d.push(b[a].previousSibling.offsetWidth);for(a=0;a<c.length;a++)b[a].style.paddingLeft=d[a]+"px"}t("comments");t("subtitles");t("resources");w&&w.updateSubtitleLanguage&&w.updateSubtitleLanguage()}function s(){F=!0;p.pause();if(Math.abs(Y-p.currentTime)>10)h.getElementById("comment-text").value="";var a;a=p.duration?n(p.currentTime):"-:--";
if(F&&aa.innerHTML!==a)aa.innerHTML=a;h.getElementById("add-comment-controls").style.display="block";q(!0)}function j(a){if(!a.altKey&&!a.altGraphKey&&!a.metaKey&&(J=Date.now(),!F)){var b=a.keyCode||a.which;b>=65&&b<=90||b>=97&&b<=122||b>=256&&b<=658||b>=884&&b<=8191?(a.preventDefault(),s(),a=h.getElementById("comment-text"),a.value=String.fromCharCode(b),a.setSelectionRange(a.value.length,a.value.length),a.focus(),r()):(b===32&&(c(),a.preventDefault()),J=Date.now())}}function l(){var a=new XMLHttpRequest;
a.open("GET","save.php?language="+x,!0);a.send(null)}function v(a){if(a!==L){p.pause();o();e.location.hash=a||"";if(L)h.getElementById(L).style.display="none";if(a){if(!L&&(h.getElementById("back-controls").style.display="block",h.getElementById("bottom-controls").style.display="none",O))O.style.display="block";h.getElementById(a).style.display="block";S.style.zIndex="1500";L=a}else if(L=!1,!L&&(S.style.zIndex="",h.getElementById("back-controls").style.display="",h.getElementById("bottom-controls").style.display=
"",O))O.style.display=""}}function B(){var a,b=new Image;b.onload=function(){ca=[];var c=h.createElement("canvas");c.height=7;c.width=8;var d=c.getContext("2d");for(a=0;a<8;a++)d.clearRect(0,0,8,7),d.drawImage(b,-a,0),d.drawImage(b,8-a,0),ca.push(ba.createPattern(c,"repeat"))};b.src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAHCAYAAAA1WQxeAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAExJREFUeNpi/P//fzADA4MwAwLcAuIDUDYbE5DYDMRvkRSoAbEDlP0LpOAXPkWMQCtggmxA7ItuHRNUNQMuk5igRuFUxASlcSoCCDAA+ZwYM8U0vFEAAAAASUVORK5CYII=";
var c=h.getElementsByClassName("fade");for(a=0;a<c.length;a++)X.push(c.item(a))}function y(){function c(a){var e;a.which?e=a.which===3:a.button&&(e=a.button===2);if(e)return!1;o();d=d&&p.paused;a=b(a);g(a,C);a=(a.x-8.5)/(C.offsetWidth-17);a>=0&&a<=1&&(a*=p.duration,w.currentTime(a));p.pause();return!0}var d=!0;a(C,c,c,function(){d||(p.play(),d=!0)})}function z(){function c(a){var d;a.which?d=a.which===3:a.button&&(d=a.button===2);if(d)return!1;a=b(a);g(a,M);a=1-(a.y-8.5)/(M.offsetHeight-17);if(a>=
0&&a<=1)p.volume=a;return!0}a(M,c,c,null)}function I(){if(A>p.duration)A=p.duration;if(A)p.currentTime=A,ka||p.play(),W=!0;if(la)p.muted=!0;y();k()}function K(){var a,b,c,d,f=!1;c=e.location.pathname.split("/");c=c.concat(e.location.hash.substr(1).split("/"));for(d=c.length-1;d>=0;d--)if(a=c[d].toLowerCase(),a==="pause"?ka=!0:a==="mute"?la=!0:!b&&(a==="about"||a==="contact"||a==="disclaimer"||a==="terms-of-use")?b=a:!f&&a&&!isNaN(a)&&a>=0&&(f=!0,A=parseFloat(a)),b&&f&&la&&ka)break;if(ha=b)O?v(ha):
E.style.display="none";else if(p&&p.duration>A)p.currentTime=A}function D(){return x}var h=e.document,va=e.Popcorn,Z=h.getElementById("background"),$=h.getElementsByTagName("footer")[0],P=h.getElementById("video-frame"),p=h.getElementById("video"),ma=h.getElementById("play-timer"),aa=h.getElementById("add-comment-timer"),C=h.getElementById("progress"),M=h.getElementById("volume-canvas"),ia,ba,E=h.getElementById("intro"),S=h.getElementById("eu-logo"),O,ta,ua,w,A=0,ka=!1,la=!1,xa=RegExp("^[a-z0-9!#$%&'*+\\/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+\\/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+(?:[A-Z]{2}|aero|asia|biz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|pro|tel|travel|xxx)$",
"i"),na=function(){return e.requestAnimationFrame||e.webkitRequestAnimationFrame||e.mozRequestAnimationFrame||e.oRequestAnimationFrame||e.msRequestAnimationFrame||function(a){e.setTimeout(a,16)}}(),wa,sa,J=0,fa={},oa,pa,ra,qa,L,ha,N=!1,Y=-10,da={},H=!0,G={comments:!0,resources:!0,subtitles:!0},W=!1,F=!1,ea=!1,ga={},T=[],x,R={"#title":{en:"A First World War friendship \u2013 an interactive HTML5 video by Europeana",de:"Eine Erste Weltkrieg Freundschaft - ein interaktiver HTML5 Video von Europeana"},
"#about-button":{en:"About",de:"\u00fcber uns"},"#contact-button":{en:"Contact",de:"kontakt"},"#share-button":{en:"Share",de:"teilen"},"#comments-button-text":{en:"User Comments:",de:"User-Kommentare:"},"#resources-button-text":{en:"Related Items:",de:"relatierte Artikel:"},"#subtitles-button-text":{en:"Subtitles:",de:"Untertitel"},"#language-button-text":{en:"Language:",de:"Sprache:"},"#back-button":{en:"Back to film",de:"Zur\u00fcck zum Film"},".popcorn-source":{en:"source",de:"Quelle"},"#write-comment-at":{en:"Write a comment at:",
...
U=1024,V=576;(function(){if(!e.addEventListener||!Element.prototype.addEventListener)e.addEventListener=function(a,b){this.attachEvent(a,b)},h.addEventListener=e.addEventListener,Element.prototype.addEventListener=e.addEventListener;K();e.addEventListener("hashchange",K,!1);if(Modernizr.video){w=va("#video");try{ia=M.getContext("2d"),ba=C.getContext("2d")}catch(a){}p.readyState>=2?I():p.addEventListener("loadedmetadata",I,!1);if(h.body&&A>1.5)h.body.style.backgroundColor="#000"}else H=!1,A=0,h.getElementById("no-video").style.display=
"block",R["#intro-caption"]={en:"With the popcorn.js and HTML5 video technology on board, Europeana Remix is at the vanguard of using audiovisual heritage in engaging people with their history.",de:"Mit dem Popcorn.js und HTML5-Video-Technologie an Bord, ist Europeana Remix an der Spitze der Nutzung von Online-Video im Dialog mit Menschen mit ihrer Geschichte."};e.addEventListener("DOMContentLoaded",function(){d();if(A>1.5)h.body.style.backgroundColor="#000";x=h.documentElement.getAttribute("lang")||
"en";q();H&&(z(),B(),p.addEventListener("play",function(){h.getElementById("play-button").classList.add("active");J=Date.now();if(!W)A<1.5&&i("bottom-controls",{opacity:{from:0,to:1}},0.5),h.getElementById("intro-play").style.display="none",p.style.display="block",W=!0},!1),p.addEventListener("pause",function(){h.getElementById("play-button").classList.remove("active");J=Date.now()},!1),p.addEventListener("ended",function(){h.getElementById("play-button").classList.remove("active")},!1),p.addEventListener("volumechange",
function(){h.getElementById("volume-button").offsetHeight&&f();p.volume<0.05?h.getElementById("volume-button").classList.add("active"):h.getElementById("volume-button").classList.remove("active");if(e.localStorage)localStorage.euRemixVolume=p.volume},!1));p.addEventListener("click",o,!1);h.getElementById("resources").addEventListener("click",o,!1);h.getElementById("bottom-controls").addEventListener("click",o,!1);h.getElementById("top-controls").addEventListener("click",o,!1);h.getElementById("play-button").addEventListener("click",
c,!1);h.addEventListener("click",function(){},!1);if(H)h.getElementById("comments-button").addEventListener("click",function(){G.comments=!G.comments;t("comments");G.comments?w.enable("videoComment"):w.disable("videoComment")},!1),h.getElementById("resources-button").addEventListener("click",function(){var a,b;G.resources=!G.resources;t("resources");if(G.resources)for(a=0,b=T.length;a<b;a++)w.enable(T[a]);else for(a=0,b=T.length;a<b;a++)w.disable(T[a])},!1),h.getElementById("subtitles-button").addEventListener("click",
function(){G.subtitles=!G.subtitles;t("subtitles");G.subtitles?w.enable("subtitle"):w.disable("subtitle")},!1),h.getElementById("language-en").addEventListener("click",function(){x="en";q();l()},!1),h.getElementById("intro-en").addEventListener("click",function(){x="en";q();l()},!1),h.getElementById("language-de").addEventListener("click",function(){x="de";q();l()},!1),h.getElementById("intro-de").addEventListener("click",function(){x="de";q();l()},!1),h.getElementById("logo-link").addEventListener("click",
function(){p.pause()},!1),h.getElementById("settings-button").addEventListener("click",function(){var a=h.getElementById("settings-controls"),b=!a.offsetHeight;o();if(b)a.style.display="block",N=!0},!1),h.getElementById("volume-button").addEventListener("click",function(){var a=h.getElementById("volume-controls"),b=!a.offsetHeight;o();if(b)a.style.display="block",f(),N=!0},!1),h.getElementById("add-comment-button").addEventListener("click",function(){(F=!F)?s():(Y=p.currentTime,h.getElementById("add-comment-controls").style.display=
"none")},!1),h.getElementById("comment-tos-checkbox").addEventListener("click",function(){ea=this.checked;r()},!1),ea=h.getElementById("comment-tos-checkbox").checked,h.getElementById("comment-post").addEventListener("click",function(){if(ea){var a=new FormData,b=h.getElementById("comment-email").value,c=h.getElementById("comment-name").value,d=h.getElementById("comment-text").value;a.append("language",x);a.append("name",c);a.append("email",b);a.append("comment",d);a.append("time",p.currentTime);
var e=new XMLHttpRequest;e.open("POST","save-comment.php",!0);e.send(a);e.onreadystatechange=function(){if(e.readyState===4)if(e.status===200){var a=JSON.parse(e.responseText);if(a.success){if((a=a.data)&&!ga[a[0]])ga[a[0]]=a,w.videoComment({start:a[2],end:a[2]+5,id:a[0],author:a[4],text:a[5],date:a[1]*1E3,language:a[3],target:"comments"});F=!1;Y=p.currentTime;h.getElementById("add-comment-controls").style.display="none";h.getElementById("comment-text").value=""}}else console.log("error saving comment")}}},
!1),h.getElementById("end-close").addEventListener("click",function(){h.getElementById("end").style.display="none"},!0),h.getElementById("play-again").addEventListener("click",function(){p.currentTime=0;p.play()},!0),h.getElementById("comment-cancel").addEventListener("click",function(){F=!1;Y=p.currentTime;h.getElementById("add-comment-controls").style.display="none"},!0),h.getElementById("comment-name").addEventListener("change",r,!1),h.getElementById("comment-email").addEventListener("change",
r,!1),h.getElementById("comment-text").addEventListener("change",r,!1),h.getElementById("comment-name").addEventListener("keyup",r,!1),h.getElementById("comment-email").addEventListener("keyup",r,!1),h.getElementById("comment-text").addEventListener("keyup",r,!1);h.getElementById("about-button").addEventListener("click",function(){v("about")},!1);h.getElementById("contact-button").addEventListener("click",function(){v("contact")},!1);h.getElementById("back-button").addEventListener("click",function(){v()},
!1);h.getElementById("help-button").addEventListener("click",function(){var a=h.getElementById("help-controls"),b=!a.offsetHeight;o();if(b)a.style.display="block",N=!0},!1);h.getElementById("share-button").addEventListener("click",function(){var a=h.getElementById("share-controls"),b=!a.offsetHeight;o();if(b)a.style.display="block",N=!0},!1);h.getElementById("twitter-button").addEventListener("click",function(){var a=encodeURIComponent(e.location.protocol+"//"+e.location.host+e.location.pathname),
b=encodeURIComponent(R.shareTwitter[x]);ta=e.open("http://twitter.com/share?count=none&counturl="+a+"&text="+b+"&url=","europeana-share-tweet","left="+Math.round(screen.width/2-275)+",top="+Math.round(screen.height/2-225)+",width=550,height=450,personalbar=0,toolbar=0,scrollbars=1,resizable=1");ta.focus()},!1);h.getElementById("facebook-button").addEventListener("click",function(){var a=e.location.protocol+"//"+e.location.host+e.location.pathname,b=encodeURIComponent(R.shareFacebook[x]);ua=e.open("http://facebook.com/sharer.php?u="+
a+"&t="+b,"europeana-share-facebook","left="+Math.round(screen.width/2-275)+",top="+Math.round(screen.height/2-225)+",width=550,height=450,personalbar=0,toolbar=0,scrollbars=1,resizable=1");ua.focus()},!1);i("top-controls",{opacity:{from:0,to:1}},0.5)},!1);e.addEventListener("load",function(){d(!0)},!1);e.addEventListener("resize",d,!0);h.addEventListener("mousemove",function(a){J=Date.now();da=b(a)},!1);var g=[{url:"image/page-bg.jpg",category:"display"},"image/background.jpg",{url:"css/style.css",
mode:"font",id:"chevin",families:["Chevin-Light"],category:"display"},"image/bg.png","image/logo.png","image/icon_facebook.png","image/icon_twitter.png","image/radio.png","image/settings.png"];H&&(g=g.concat([{url:"video/otto-and-bernard.webm",element:p,id:"video",category:"play"},{url:"data/resources.txt?"+Date.now(),type:"json",category:"data",id:"resources"},{url:"data/subtitles.txt",type:"json",category:"data",id:"subtitles"},"image/playpause.png","image/check.png","image/comment.png","image/comments.png",
"image/volume.png","image/intro-play.png","image/media-icons.png"]));g=new Loaderator(g,"all",function(){if(!H)return!1;if(A>1.5)i("bottom-controls",{opacity:{from:0,to:1}},0.5);else{var a=h.getElementById("intro-play");a.style.display="block";a.addEventListener("click",function(){p.play()},!1)}e.addEventListener("keypress",j,!1)});g.addEventListener("all:chevin",function(){d();A<1.5||!H?(i("intro-text",{opacity:{from:0,to:1}},1),i("intro-en",{opacity:{from:0,to:1}},1),i("intro-de",{opacity:{from:0,
to:1}},1)):h.getElementById("intro-text").style.opacity=1});g.addEventListener("all:image/logo.png",function(){d();S.style.zIndex="1500";i(S,{opacity:{from:0,to:1}},1)});g.addEventListener("all:image/page-bg.jpg",function(a){a=a.element;a.id="page-background";O=a;E.parentNode.insertBefore(a,E.nextSibling);if(!H)E.style.display="block"});g.addEventListener("display",function(){ha&&!L&&v(ha);if(A<1.5||!H)E.style.display="block"});g.addEventListener("all:image/background.jpg",function(a){d();a=a.element;
E.insertBefore(a,E.firstChild);if(H){if(A<1.5){if(i(a,{opacity:{from:0,to:1}},1,function(){p.style.display="block"}),O)E.style.display="block"}else p.style.display="block";var b=h.getElementById("end"),a=a.cloneNode(!1);b.insertBefore(a,b.firstChild)}});H&&(g.addEventListener("all:video",function(a){a.element.style.visibility="visible";if(e.localStorage&&localStorage.euRemixVolume!==void 0)p.volume=localStorage.euRemixVolume;var b=h.getElementById("end"),c=h.getElementById("end-text"),d=h.getElementById("end-close"),
f=b.firstChild;w.code({start:"4:26",end:w.duration()-1,onStart:function(){b.style.display="block";d.style.display=""},onFrame:function(a,c){var d=Math.min((w.currentTime()-c.start)/1.5,1);if(b.style.opacity!==d)b.style.opacity=d},onEnd:function(a){if(w.currentTime()<a.start)b.style.display="";d.style.display="none"}});w.code({start:w.duration()-1,end:w.duration(),onStart:function(){if(!(f instanceof HTMLImageElement))f=b.firstChild;b.style.display="block";b.classList.add("final")},onFrame:function(a,
d){var e=Math.min((w.currentTime()-d.start)/0.5,1);if(f.style.opacity!==e)f.style.opacity=e;if(b.style.opacity<e)b.style.opacity=e;e=1-e;c.style.backgroundColor="rgba(255, 255, 255, "+e*0.85+")";c.style.borderColor="rgba(0, 0, 0, "+e*0.6+")"},onEnd:function(){b.style.cssText="";b.classList.remove("final")}})}),g.addEventListener("data:resources",function(a){var b={flickr:e.flickrApiKey||""},a=JSON.parse(a.element.responseText),c,d,f,g;for(c in a)if(a.hasOwnProperty(c)&&typeof w[c]==="function"){for(f=
0,g=a[c].length;f<g;f++){d=a[c][f];if(b[c])d.apikey=b[c];d.target="resources";if(d.fadeIn===void 0||isNaN(d.fadeIn))d.fadeIn=0.5;if(d.fadeOut===void 0||isNaN(d.fadeOut))d.fadeOut=0.5;w[c](d)}g&&T.indexOf(c)===-1&&(T.push(c),G.resources||w.disable(c))}}),g.addEventListener("data:subtitles",function(a){var b=JSON.parse(a.element.responseText);if(b)for(a=0;a<b.length;a++)b[a].languagesrc=D,w.subtitle(b[a])}),u(),e.addEventListener("keyup",function(a){var b=a.which||a.keyCode;if(F){if(J=Date.now(),b===
27)F=!1,Y=p.currentTime,h.getElementById("add-comment-controls").style.display="none",a.preventDefault()}else b===37?(p.currentTime-=0.04,console.log("left",p.currentTime)):b===39&&(p.currentTime+=0.04,console.log("right",p.currentTime))},!1),w.code({start:0,end:1.5,onStart:function(){E.style.display="block";h.body.style.backgroundColor="#fff";S.style.zIndex="1500"},onFrame:function(){var a=1-Math.min(w.currentTime()/1.5,1);E.style.opacity=a;a=Math.round(a*255);h.body.style.backgroundColor="rgb("+
a+", "+a+", "+a+")"},onEnd:function(){h.body.style.backgroundColor="#000";E.style.display="none";S.style.zIndex=""}}))})()})(window);
