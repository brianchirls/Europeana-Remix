...
"image";else if(a.type==="iframe")a.type="html";else if(a.type==="audio"||a.type==="video")a.element.doMediaEvents=!0;else return g.log("Resource Loader: unknown object type "+a.type),!1;d=a.element}if(d.loaded)e.resLoadCallback(a,null);else if(d.doMediaEvents){d.addEventListener("canplay",function(c){a.loaded||e.resLoadCallback(a,c)},!0);var f=function(){d.readyState>=3?a.loaded||e.resLoadCallback(a,null):setTimeout(f,0)};f()}return!0},font:function(d){var e=this;a.load({url:this.base.protocol+"//ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",
id:"webfont-script",type:"script",mode:"script"},"webfont");a.addEventListener("webfont",function(){var a,c=d.families.concat([]),i,f,p=!1,s=[],n=b.getElementsByTagName("link");for(a=0,i=n.length;a<i;a++)if(f=n.item(a),f.getAttribute("rel").toLowerCase()==="stylesheet"&&(f=f.href,f===d.fullUrl)){p=!0;break}p||s.push(d.fullUrl);WebFont.load({custom:{families:d.families,urls:s},fontactive:function(p){for(a=0;a<c.length;a++)if(c[a]===p){c.splice(a,1);break}c.length||e.resLoadCallback(d,this)},fontinactive:function(a){g.log("problem loading font:"+
a)},inactive:function(){g.log("WebFonts are inactive!")},active:function(){}})})}};i.prototype.extensionTypes={js:"script",ogg:"audio",mp3:"audio",wav:"audio",ogv:"video",webm:"video",mp4:"video",jpg:"image",jpeg:"image",png:"image",gif:"image",css:"style",xml:"xml",xhtml:"xml",json:"json",txt:"text",html:"html"};i.prototype.load=function(a,b,d){if(Object.prototype.toString.call(a)!=="[object Array]")if(a)a=[a];else return this;this.loadingCount+=1;var c,e,g,p,s,n=[];for(s=0;s<a.length;s++)if(c=a[s]){if(Object.prototype.toString.call(c)===
"[object String]"||typeof c==="string")c={url:c};if(c.url){var j;c.fullUrl===k&&(j=this.resolveUrl(c.url));g="";if((e=this.resources[j])&&(!c.mode||c.mode===e.mode))a[s]=e;else{e&&(g="#"+c.mode);e=c;e.Loaderator=this;this.resources[j+g]=e;e.fullUrl=j;if(!c.type)g=c.fullUrl.split("."),g.length>1&&(g=g.pop().toLowerCase()),c.type=this.extensionTypes[g]||"text";if(!c.mode)switch(c.type){case "script":c.mode="script";break;case "style":case "css":c.mode="css";break;case "audio":case "video":case "image":case "html":c.mode=
"object";break;case "xml":case "json":case "text":c.mode="ajax";break;default:c.mode="ajax"}}}else e=c.loader?c:!1;g=[];b&&g.push(b);var w;if(c.category){p=Object.prototype.toString.call(c.category)==="[object Array]"?c.category:[c.category];for(c=0;c<p.length;c++)w=p[c],g.indexOf(w)<0&&g.push(w)}g.length||g.push(e.fullUrl);if(e&&g.length&&(e.loader||e.mode&&this.loaders[e.mode])){for(c=0;c<g.length;c++){w=g[c];p=this.categories[w]||(this.categories[w]=new i.Category(w,this));if(e.categories===k)e.categories=
[];p.addResource(e)}e.loader||e.fullUrl&&this.loaders[e.mode].call(this,e)&&n.push(e)}}d!==k&&Object.prototype.toString.call(d)==="[object Function]"&&b!==k&&this.addEventListener(b,d);for(this.loadingCount-=1;this.callbackQueue.length;)this.callbackQueue.splice(0,1)[0].checkForAllLoaded();return this};i.prototype.resLoadCallback=function(a,b){a.loaded=!0;a.event=b;var d,c;c=this.eventListeners.length;for(d=0;d<c;d++)this.eventListeners[d].call(this,a);var e=function(a,c,p){return function(){a.call(c,
p)}};c=a.categories.length;var g;for(d=0;d<c;d++){var p;p=a.categories[d].eventListeners.single;if(a.id&&(g=p[a.id])||(g=p[a.url])||(g=p[a.fullUrl]))for(p=0;p<g.length;p++){var s=g[p];s.async?setTimeout(e(s,this,a),0):s.call(this,a)}}for(d=0;d<c;d++)a.categories[d].checkForAllLoaded()};i.prototype.addEventListener=function(a,b,d){if(!b||Object.prototype.toString.call(b)!=="[object Function]")return this;b.runAsync=d||!1;if(a==="*")this.eventListeners.push(b);else{typeof a==="string"&&(a=a.split(":"));
var c=a[0],c=this.categories[c]||(this.categories[c]=new i.Category(c,this)),e=a.length>1?a[1]:!1;if(e){var g,p;if(!(g=c.resourcesById[e]))for(a=c.resources.length-1;a>=0;a--)if(p=c.resources[a],p!==k&&p.fullUrl===e){g=p;break}g&&g.loaded?d?setTimeout(function(){b.call(this,g)},0):b.call(this,g):(c.eventListeners.single[e]||(c.eventListeners.single[e]=[])).push(b)}else c.eventListeners.load.push(b),c.checkForAllLoaded()}return this};var d=function(){var a=f.LDR8R;if(a){var b;for(b=0;b<a.length;b++)a[b]()}};
d.prototype.push=function(a){if(Object.prototype.toString.call(a)==="[object Function]"){var b=Array.prototype.slice.call(arguments,1);a.apply(null,b)}};a=new i;f.LDR8R=new d})(window);(function(f,k){if(k.addEventListener){var i=Array.prototype,a=Object.prototype,b=i.forEach,g=i.slice,e=a.hasOwnProperty,m=a.toString,d=/^(#([\w\-\_\.]+))$/,r=[],q=!1,o=function(){return f.requestAnimationFrame||f.webkitRequestAnimationFrame||f.mozRequestAnimationFrame||f.oRequestAnimationFrame||f.msRequestAnimationFrame||function(a){f.setTimeout(a,16)}}(),c=function(a,b){return new c.p.init(a,b||null)};c.instances=[];c.instanceIds={};c.removeInstance=function(a){if(c.instances.length)return c.instances.splice(c.instanceIds[a.id],
1),delete c.instanceIds[a.id],c.instances};c.addInstance=function(a){var b=c.instances.length,d=a.media.id&&a.media.id;a.id=!(d in c.instanceIds)&&d||"__popcorn"+b;c.instanceIds[a.id]=b;c.instances.push(a);return c.instances};c.getInstanceById=function(a){return c.instances[c.instanceIds[a]]};c.removeInstanceById=function(a){return c.removeInstance(c.instances[c.instanceIds[a]])};c.p=c.prototype={init:function(a,b){var n;if(typeof a==="function")if(k.readyState==="interactive"||k.readyState==="complete")a(k,
c);else{if(r.push(a),!q){q=!0;var j=function(){k.removeEventListener("DOMContentLoaded",j,!1);for(var a=0,b=r.length;a<b;a++)r[a].call(k,c);r=null};k.addEventListener("DOMContentLoaded",j,!1)}}else{this.media=(n=d.exec(a))&&n.length&&n[2]?k.getElementById(n[2]):a;this[this.media.nodeName&&this.media.nodeName.toLowerCase()||"video"]=this.media;c.addInstance(this);this.options=b||{};this.data={disabled:[],events:{},history:[],trackEvents:{byStart:[{start:-1,end:-1}],byEnd:[{start:-1,end:-1}],animating:[],
...
json:c};a.dataType&&(b=b[a.dataType]);a.success.call(a.ajax,b)}};return b};c.xhr.getJSONP=function(a,b,d){if(d&&k.querySelectorAll('script[src="'+a+'"]').length)b&&b(!0);else{var e=k.head||k.getElementsByTagName("head")[0]||k.documentElement,g=k.createElement("script"),i=a.split("?")[1],f=!1,m=[],o,r;i&&!d&&(m=i.split("&"));m.length&&(r=m[m.length-1].split("="));o=m.length?r[1]?r[1]:r[0]:"jsonp";!i&&!d&&(a+="?callback="+o);o&&!d&&(window[o]&&(o=c.guid(o)),window[o]=function(a){b&&b(a);f=!0},a=a.replace(r.join("="),
...
q))?(k=k.firstChild.nodeValue||"",k=i(k,50)):k="";var p=c("//dc:description",q),p=p?p.firstChild.nodeValue||"":"",x=c("//dc:source",q);x=x?x.firstChild.nodeValue||"":(x=c("//europeana:provider",q))?x.firstChild.nodeValue||"":"";x&&(x=i("Europeana/"+x,32));var q=(q=c("//europeana:object",q))?q.firstChild.nodeValue||"":"",h=document.createElement("div");h.setAttribute("class","content");var Z=document.createElement("article");Z.appendChild(document.createTextNode(p));h.appendChild(Z);h.appendChild(document.createElement("br"));
...
a.left;g=document.createElement("div");g.style.position="relative";b.appendChild(g);var L=function(){m="http://api.flickr.com/services/feeds/photos_public.gne?";e&&(m+="id="+e+"&");a.tags&&(m+="tags="+a.tags+"&");m+="lang=en-us&format=json&jsoncallback=flickr";f.xhr.getJSONP(m,function(b){g.innerHTML="<p style='padding:"+p+";'>"+b.title+"<p/>";f.forEach(b.items,function(b,e){if(e<q)d=document.createElement("a"),d.setAttribute("href",b.link),d.setAttribute("target","_blank"),r=document.createElement("img"),
r.setAttribute("src",b.media.m),r.setAttribute("height",o),r.setAttribute("width",c),r.setAttribute("style","border:"+s+";padding:"+p),d.appendChild(r),g.appendChild(d),a.loaded=!0;else return!1})})},N=function(){e?setTimeout(function(){N()},5):(m="http://api.flickr.com/services/rest/?method=flickr.people.findByUsername&",m+="username="+a.username+"&api_key="+a.apikey+"&format=json&jsoncallback=flickr",f.getJSONP(m,function(a){e=a.user.nsid;L()}))},F=function(){if(n.media&&n.media.buffered&&n.media.buffered.length){var b,
d,e=!1,j,i,k=n.media.buffered;for(b=0,d=k.length;b<d;b++)if(j=k.start(b),i=k.end(b),j>n.media.duration&&(j=0),j<=a.end&&i>=a.start){e=!0;break}if(!e){setTimeout(F,10);return}}m="http://api.flickr.com/services/rest/?method=flickr.photos.getInfo";a.apikey&&(m+="&api_key="+a.apikey);m+="&photo_id="+a.photoid+"&lang=en-us&format=json&jsoncallback=flickr";f.xhr.getJSONP(m,function(b){if(b&&b.stat==="ok"&&b.photo){var b=b.photo,d=document.createElement("img");d.src="http://farm"+b.farm+".static.flickr.com/"+
...
o=c*h/e+b,!d.width)d.style.height=100*h/e+"%";a.loaded=!0},!1);g.addEventListener("click",B,!1)}})};if(a.url&&!a.photoid){var x=/^((https?:\/\/)?(www\.)?flickr\.com\/photos\/[^\/]+\/)?(\d+)/.exec(a.url);if(x&&x.length>=5)a.photoid=x[4]}a.photoid?F():a.username&&a.apikey?N():(e=a.userid,L());x=a.end-a.start;if(isNaN(a.fadeIn))a.fadeIn=Math.min(0.25,x/8);else if(a.fadeIn>x)a.fadeIn=x;x-=a.fadeIn;if(isNaN(a.fadeOut))a.fadeOut=Math.min(0.25,(a.end-a.start)/8);else if(a.fadeOut>x)a.fadeIn=x;return{start:function(a,
...
f.plugin("googlemap",function(d){var f,q,o,c,t=!1,u=this,p,s=!1,n,j,w,B,z,C,L;b||m();d.map=null;B=function(a){(a.keyCode||a.which)===27&&w()};n=function(a){if(k(a))return!0;a=a.target;do if(a===o)return!0;while(a=a.parentNode);w();return!1};j=function(a){if(k(a))return!0;s=u.media.paused;u.pause();t||p();if(d.map)d.map.getDiv().style.display="block";c.removeEventListener("click",j,!1);window.addEventListener("click",n,!0);window.addEventListener("keydown",B,!0);o.classList.add("active");o.style.cssText=
"";if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1};w=function(a){if(k(a))return!0;if(d.map)d.map.getDiv().style.display="none";o.classList.remove("active");o.style.width=z;if(C||L)o.style.top=C,o.style.left=L,o.style.position="absolute";c.addEventListener("click",j,!1);window.removeEventListener("keydown",B,!0);window.removeEventListener("click",n,!0);s||u.play();if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&
a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1};d.loaded=!1;o=document.createElement("div");o.setAttribute("class","googlemap");o.id="googlemap"+i;if(d.width)o.style.width=d.width;if(d.height)o.style.height=d.height;o.style.display="none";i++;if(document.getElementById(d.target))document.getElementById(d.target).appendChild(o);else throw"googlemap target container doesn't exist";if(d.top||d.left)o.style.position="absolute",o.style.top=d.top,o.style.left=d.left;c=document.createElement("div");
c.style.position="relative";o.appendChild(c);var N=function(){if(u.media&&u.media.buffered&&u.media.buffered.length){var a,b,e=!1,g,i,n=u.media.buffered;for(a=0,b=n.length;a<b;a++)if(g=n.start(a),i=n.end(a),g>u.media.duration&&(g=0),g<=d.end&&i>=d.start){e=!0;break}if(!e){setTimeout(N,10);return}}a="http://maps.googleapis.com/maps/api/staticmap?sensor=false&size=320x320&maptype=roadmap&"+[["center",d.center||d.location],["markers",d.location],["visible",d.location+"|"+d.center]].map(function(a){return a[0]+
...
'</a></div><div class="watch">view map</div>';b.getElementsByClassName("minimize").item(0).addEventListener("click",w,!1);c.appendChild(b);z=d.width;C=d.top;L=d.left;k.addEventListener("load",function(){var a=/(\d*(\.\d*)?)\s*(px|em|\%|em|rem)?/,b;if(d.width&&!d.height&&(b=a.exec(d.width))&&b.length>1)a=b[3]||"",b=parseFloat(b[1]),b=b*k.height/k.width,c.style.height=b+a;d.loaded=!0},!1);c.addEventListener("click",j,!1)},F=d.end-d.start;if(isNaN(d.fadeIn))d.fadeIn=Math.min(0.25,F/8);else if(d.fadeIn>
F)d.fadeIn=F;F-=d.fadeIn;if(isNaN(d.fadeOut))d.fadeOut=Math.min(0.25,(d.end-d.start)/8);else if(d.fadeOut>F)d.fadeIn=F;if(!d.type)d.type="ROADMAP";f=document.createElement("div");f.id="actualmap"+a;f.style.width="100%";f.style.height="100%";f.style.top=0;f.style.left=0;f.style.position="absolute";a++;p=function(){g?d.location?(t=!0,e.geocode({address:d.location},function(a,b){if(b===google.maps.GeocoderStatus.OK)d.lat=a[0].geometry.location.lat(),d.lng=a[0].geometry.location.lng(),q=new google.maps.LatLng(d.lat,
d.lng),d.debug="now i have my map",d.map=new google.maps.Map(f,{mapTypeId:google.maps.MapTypeId[d.type]||google.maps.MapTypeId.HYBRID,draggable:!0}),new google.maps.Marker({position:q,map:d.map,title:d.location})})):(q=new google.maps.LatLng(d.lat,d.lng),d.debug="now i have my damn map",d.map=new google.maps.Map(f,{mapTypeId:google.maps.MapTypeId[d.type]||google.maps.MapTypeId.HYBRID,draggable:!0}),new google.maps.Marker({position:q,map:d.map,title:d.location})):setTimeout(function(){p()},5)};N();
...
i.fadeOut&&(b=(i.end-a)/i.fadeOut);i.div.style.opacity=b}})})(window.Popcorn);(function(f){function k(a){if(!a)return!1;if(a.which)return a.which===3;if(a.button)return a.button===2}if(f){var i=0;f.plugin("image",function(a){var b,g,e,f,d,r,q=this,o=!1,c,t,u,p;if(a.url){p=function(a){(a.keyCode||a.which)===27&&u()};c=function(a){if(!k(a)){a=a.target;do if(a===b)return!0;while(a=a.parentNode);u();return!1}};t=function(a){if(!k(a)){o=q.media.paused;q.pause();g.removeEventListener("click",t,!1);window.addEventListener("click",c,!0);window.addEventListener("keydown",p,!0);b.classList.add("active");
b.style.cssText="";if(f&&16/9*0.4*e.height/e.width>0.8)b.style.width=e.width/e.height*7.2/16*100+"%";if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};u=function(a){if(!k(a)){b.classList.remove("active");b.style.width=f;if(d||r)b.style.top=d,b.style.left=r,b.style.position="absolute";e.style.width="100%";g.addEventListener("click",t,!1);window.removeEventListener("keydown",p,!0);window.removeEventListener("click",c,!0);o||
...
b.style.top=a.top,b.style.left=a.left;g=document.createElement("div");g.style.position="relative";b.appendChild(g);var s=function(){if(q.media&&q.media.buffered&&q.media.buffered.length){var b,c,i=!1,n,o,k=q.media.buffered;for(b=0,c=k.length;b<c;b++)if(n=k.start(b),o=k.end(b),n>q.media.duration&&(n=0),n<=a.end&&o>=a.start){i=!0;break}if(!i){setTimeout(s,10);return}}e=document.createElement("img");e.src=a.url;e.style.width="100%";g.appendChild(e);b=document.createElement("div");b.setAttribute("class",
...
options:{start:{elem:"input",type:"number",label:"In"},end:{elem:"input",type:"number",label:"Out"},target:"image-container",height:{elem:"input",type:"text",label:"Height"},width:{elem:"input",type:"text",label:"Width"}}})}})(window.Popcorn);(function(f){if(f){var k=0,i=function(a){var g=a.container=document.createElement("div"),e=g.style,m=a.media;i=f.nop;var d=function(){var f=a.position();e.fontSize="18px";e.width=m.offsetWidth+"px";e.top=f.top+m.offsetHeight-g.offsetHeight-40+"px";e.left=f.left+"px";setTimeout(d,10)};g.id="subtitlediv";e.position="absolute";e.color="white";e.textShadow="black 2px 2px 6px";e.fontWeight="bold";e.textAlign="center";d();document.body.appendChild(g)},a=function(a){if(a.languagesrc){if(typeof a.languagesrc===
...
else throw"wikipedia target container doesn't exist";if(a.top||a.left)b.style.position="absolute",b.style.top=a.top,b.style.left=a.left;g=document.createElement("div");g.style.position="relative";b.appendChild(g);f.xhr.getJSONP("http://"+m+".wikipedia.org/w/api.php?action=parse&props=text&page="+e+"&format=json&callback=wikipedia",function(b){if(b&&b.parse){var c=b.parse.text["*"],c=c.substr(c.indexOf("<p>")+3),c=c.substr(0,c.indexOf("</p>")),c=c.replace(/((<(.|\n)+?>)|(\((.*?)\) )|(\[(.*?)\]))/g,
...
version:"0.1",author:"Brian Chirls",website:"http://chirls.com/"},options:{start:{elem:"input",type:"number",label:"In"},end:{elem:"input",type:"number",label:"Out"},url:{elem:"input",type:"text",label:"url"},target:"wikipedia-container"}})}})(window.Popcorn);(function(f){function k(a){if(!a)return!1;if(a.which)return a.which===3;if(a.button)return a.button===2}if(f){var i=0,a=!1,b=!1,g=function(){if(document.body){a=!0;var e=window.onYouTubePlayerAPIReady;window.onYouTubePlayerAPIReady=function(){b=!0;e&&e()};f.getScript("http://www.youtube.com/player_api")}else setTimeout(function(){g()},1)};f.plugin("youtube",function(e){var m,d,r,q,o,c,t,u=this,p=!1,s,n,j,w;a||g();w=function(a){var b=a.keyCode||a.which;if(b===27)j();else{if(b===32)t&&t.pauseVideo&&
(t.getPlayerState()===1?t.pauseVideo():t.getPlayerState()===2&&t.playVideo()),a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};s=function(a){if(!k(a)){a=a.target;do if(a===m)return!0;while(a=a.parentNode);j();return!1}};n=function(a){if(!k(a)){p=u.media.paused;u.pause();d.removeEventListener("click",n,!1);window.addEventListener("click",s,!0);window.addEventListener("keydown",w,!0);m.classList.add("active");m.style.cssText="";
t&&t.playVideo&&t.playVideo();if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};j=function(a){if(!k(a)){t&&t.pauseVideo&&t.pauseVideo();m.classList.remove("active");m.style.width=r;if(q||o)m.style.top=q,m.style.left=o,m.style.position="absolute";d.addEventListener("click",n,!1);window.removeEventListener("keydown",w,!0);window.removeEventListener("click",s,!0);p||u.play();if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&
a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};e.loaded=!1;m=document.createElement("div");m.setAttribute("class","youtube");m.id="youtube"+i;if(e.width)m.style.width=e.width;if(e.height)m.style.height=e.height;m.style.display="none";i++;if(document.getElementById(e.target))document.getElementById(e.target).appendChild(m);else throw"youtube target container doesn't exist";if(e.top||e.left)m.style.position="absolute",m.style.top=e.top,m.style.left=e.left;d=document.createElement("div");
d.style.position="relative";m.appendChild(d);var B=function(){if(u.media&&u.media.buffered&&u.media.buffered.length){var a,g,i=!1,k,m,h=u.media.buffered;for(a=0,g=h.length;a<g;a++)if(k=h.start(a),m=h.end(a),k>u.media.duration&&(k=0),k<=e.end&&m>=e.start){i=!0;break}if(!i){setTimeout(B,10);return}}c="http://gdata.youtube.com/feeds/api/videos/"+e.videoid+"?v=2&alt=jsonc&callback=youtube";f.xhr.getJSONP(c,function(a){if(a&&a.data){var c=a.data;(a=e.url)||(a="http://www.youtube.com/watch?v="+c.id);var f=
document.createElement("img");f.src=c.thumbnail.hqDefault;f.style.width="100%";d.appendChild(f);var g=document.createElement("div");g.id="ytplayer-"+c.id;g.setAttribute("class","player");d.appendChild(g);var h=function(){b?t=new window.YT.Player("ytplayer-"+c.id,{height:320,width:240,videoId:c.id,playerVars:{origin:document.location.protocol+"//"+document.location.hostname,html5:1,wmode:"opaque"},events:{onReady:function(){}}}):setTimeout(h,1)},g=document.createElement("div");g.setAttribute("class",
"info");g.innerHTML='<div class="media">video<span class="hiding"> | <span class="popcorn-source">source</span>: <a href="'+a+'" target="_new">YouTube</a></span></div><div><a href="'+a+'" target="_new">'+c.title+'</a></div><div class="watch">watch video</div>';d.appendChild(g);a=document.createElement("span");a.innerHTML="minimize window";a.setAttribute("class","minimize");a.style.zIndex=1500;a.addEventListener("click",j,!1);d.appendChild(a);h();r=e.width;q=e.top;o=e.left;f.addEventListener("load",
function(){var a=/(\d*(\.\d*)?)\s*(px|em|\%|em|rem)?/,b,c,g;c=f.width||f.naturalWidth;g=f.height||f.naturalHeight;if(e.width&&!e.height&&(b=a.exec(e.width))&&b.length>1)if(a=b[3]||"",b=parseFloat(b[1]),b=b*f.height/f.width,d.style.height=b+a,!f.width)f.style.height=100*g/c+"%";e.loaded=!0},!1);d.addEventListener("click",n,!1)}})};if(e.url&&!e.videoid){var z=/^(https?:\/\/)?(www\.)?(youtube\.com\/watch\?v=|youtu\.be\/)([A-Za-z0-9_\-]*)/i.exec(e.url);if(z&&z.length>=5)e.videoid=z[4]}z=e.end-e.start;
...
f*f),f=1-0.8*(f/b),f<0.2?f=0.2:f>1&&(f=1),h.style.opacity=c*f}sa=l.paused||l.ended;l.duration?(a=k(l.currentTime),b=a+" / "+k(l.duration)):(a="-:--",b="-:-- / -:--");if(na.innerHTML!==b)na.innerHTML=b;if(G&&$.innerHTML!==a)$.innerHTML=a}oa(o,ma)}function c(){l.paused?l.play():l.ended?(l.currentTime=0,l.play()):(l.pause(),H=!0)}function t(a){var b=h.getElementById(a+"-toggle");if(b)I[a]?(b.innerHTML=y==="de"?"ein":"On",b.classList.add("on")):(b.innerHTML=y==="de"?"aus":"Off",b.classList.remove("on"))}
...
5,id:f[0],author:f[4],text:f[5],date:f[1]*1E3,language:f[3],target:"comments",flagCallback:a})}};c.send(null);ea[y]=Date.now()}}function p(a){!a&&J&&u();h.documentElement.setAttribute("lang",y);for(var b,c=["en","de"],a=0;a<c.length;a++)b=h.getElementById("language-"+c[a]),c[a]===y?b.classList.add("on"):b.classList.remove("on");var d,e,f,g;for(a in U)if(U.hasOwnProperty(a)){try{d=h.querySelectorAll(a)}catch(i){d=(d=h.getElementById(a.substr(1)))?[d]:[]}c=(U[a][y]||"").split("\n");for(f=0,g=d.length;f<
g;f++)if((b=d[f])&&c.length&&c[0].length){for(;b.firstChild;)b.removeChild(b.firstChild);try{b.appendChild(h.createTextNode(c[0]));for(e=1;e<c.length;e++)b.appendChild(h.createElement("br")),b.appendChild(h.createTextNode(c[e]))}catch(j){if(a==="#title")h.title=c.join(" ")}}}if(G){e=["comment-email","comment-name","comment-text"];b=[];d=[];for(a=0;a<e.length;a++)d.push(h.getElementById(e[a])),b.push(d[a].previousSibling.offsetWidth);for(a=0;a<e.length;a++)d[a].style.paddingLeft=b[a]+"px"}t("comments");
t("subtitles");t("resources");v&&v.updateSubtitleLanguage&&v.updateSubtitleLanguage()}function s(){G=!0;l.pause();if(Math.abs(Y-l.currentTime)>10)h.getElementById("comment-text").value="";var a;a=l.duration?k(l.currentTime):"-:--";if(G&&$.innerHTML!==a)$.innerHTML=a;h.getElementById("add-comment-controls").style.display="block";p(!0)}function n(a){if(!a.altKey&&!a.altGraphKey&&!a.metaKey&&(M=Date.now(),!G)){var b=a.keyCode||a.which;b>=65&&b<=90||b>=97&&b<=122||b>=256&&b<=658||b>=884&&b<=8191?(a.preventDefault(),
s(),a=h.getElementById("comment-text"),a.value=String.fromCharCode(b),a.setSelectionRange(a.value.length,a.value.length),a.focus(),q()):(b===32&&(c(),a.preventDefault()),M=Date.now())}}function j(){var a=new XMLHttpRequest;a.open("GET","save.php?language="+y,!0);a.send(null)}function w(a){var b;if(a!==O){J?(l.pause(),r()):(b=h.getElementById("youtube-container"),l&&l.pauseVideo&&l.pauseVideo());f.location.hash=a||"";if(O)h.getElementById(O).style.display="none";if(a){if(b)b.style.display="none";if(!O&&
(h.getElementById("back-controls").style.display="block",h.getElementById("bottom-controls").style.display="none",Q))Q.style.display="block";h.getElementById(a).style.display="block";S.style.zIndex="1500";O=a}else if(O=!1,!O){if(b)b.style.display="";else{if(l.currentTime>K)S.style.zIndex="";h.getElementById("bottom-controls").style.display="";H||l.play()}h.getElementById("back-controls").style.display="";if(Q)Q.style.display=""}}}function B(){var a,b=new Image;b.onload=function(){ba=[];var c=h.createElement("canvas");
...
ka={},X=[],ba,K=1.5,ia=1024,ja=576;(function(){N();f.addEventListener("hashchange",N,!1);if(!f.Modernizr||!Modernizr.video||navigator.userAgent.match(/iPad/i)!==null)x();else{v=Z("#video");try{ha=P.getContext("2d"),aa=D.getContext("2d")}catch(a){}l.readyState>=2?L():l.addEventListener("loadedmetadata",L,!1);if(h.body&&A>K)h.body.style.backgroundColor="#000"}d();if(A>K)h.body.style.backgroundColor="#000";y=h.documentElement.getAttribute("lang")||"en";p();if(J)C(),B(),l.addEventListener("play",function(){h.getElementById("play-button").classList.add("active");
M=Date.now();if(!W)A<K&&i("bottom-controls",{opacity:{from:0,to:1}},0.5),h.getElementById("intro-play").style.display="none",l.style.display="block",W=!0;H=!1},!1),l.addEventListener("pause",function(){h.getElementById("play-button").classList.remove("active");M=Date.now()},!1),l.addEventListener("ended",function(){h.getElementById("play-button").classList.remove("active");H=!0},!1),l.addEventListener("volumechange",function(){h.getElementById("volume-button").offsetHeight&&e();l.volume<0.05?h.getElementById("volume-button").classList.add("active"):
h.getElementById("volume-button").classList.remove("active");if(f.localStorage)localStorage.euRemixVolume=l.volume},!1),l.addEventListener("click",r,!1),h.getElementById("resources").addEventListener("click",r,!1),h.getElementById("bottom-controls").addEventListener("click",r,!1),h.getElementById("comments-button").addEventListener("click",function(){I.comments=!I.comments;t("comments");I.comments?v.enable("videoComment"):v.disable("videoComment")},!1),h.getElementById("resources-button").addEventListener("click",
function(){var a,b;I.resources=!I.resources;t("resources");if(I.resources)for(a=0,b=V.length;a<b;a++)v.enable(V[a]);else for(a=0,b=V.length;a<b;a++)v.disable(V[a])},!1),h.getElementById("subtitles-button").addEventListener("click",function(){I.subtitles=!I.subtitles;t("subtitles");I.subtitles?v.enable("subtitle"):v.disable("subtitle")},!1),h.getElementById("language-en").addEventListener("click",function(){y="en";p();j()},!1),h.getElementById("language-de").addEventListener("click",function(){y="de";
p();j()},!1),h.getElementById("logo-link").addEventListener("click",function(){l.pause()},!1),h.getElementById("settings-button").addEventListener("click",function(){var a=h.getElementById("settings-controls"),b=!a.offsetHeight;l.pause();r();if(b)a.style.display="block",R=!0},!1),h.getElementById("volume-button").addEventListener("click",function(){var a=h.getElementById("volume-controls"),b=!a.offsetHeight;r();if(b)a.style.display="block",e(),R=!0},!1),h.getElementById("add-comment-button").addEventListener("click",
function(){(G=!G)?s():(Y=l.currentTime,h.getElementById("add-comment-controls").style.display="none",H||l.play())},!1),h.getElementById("comment-tos-checkbox").addEventListener("click",function(){da=this.checked;q()},!1),da=h.getElementById("comment-tos-checkbox").checked,h.getElementById("comment-post").addEventListener("click",function(){if(da){var a=new XMLHttpRequest;a.open("POST","save-comment.php",!0);var b,c=h.getElementById("comment-email").value,d=h.getElementById("comment-name").value,e=
h.getElementById("comment-text").value;f.FormData?(b=new FormData,b.append("language",y),b.append("name",d),b.append("email",c),b.append("comment",e),b.append("time",l.currentTime)):(b=["language="+encodeURIComponent(y),"name="+encodeURIComponent(d),"email="+encodeURIComponent(c),"comment="+encodeURIComponent(e),"time="+encodeURIComponent(l.currentTime)].join("&"),a.setRequestHeader("Content-type","application/x-www-form-urlencoded"),a.setRequestHeader("Content-length",b.length),a.setRequestHeader("Connection",
"close"));a.send(b);a.onreadystatechange=function(){if(a.readyState===4)if(a.status===200){var b=JSON.parse(a.responseText);if(b.success){if((b=b.data)&&!fa[b[0]])fa[b[0]]=b,v.videoComment({start:b[2],end:b[2]+5,id:b[0],author:b[4],text:b[5],date:b[1]*1E3,language:b[3],target:"comments"});G=!1;Y=l.currentTime;h.getElementById("add-comment-controls").style.display="none";H||l.play();h.getElementById("comment-text").value=""}}else console.log("error saving comment")}}},!1),h.getElementById("end-close").addEventListener("click",
function(){h.getElementById("end").style.display="none"},!0),h.getElementById("play-again").addEventListener("click",function(){l.currentTime=0;l.play()},!0),h.getElementById("comment-cancel").addEventListener("click",function(){G=!1;Y=l.currentTime;h.getElementById("add-comment-controls").style.display="none";H||l.play()},!0),h.getElementById("comment-name").addEventListener("change",q,!1),h.getElementById("comment-email").addEventListener("change",q,!1),h.getElementById("comment-text").addEventListener("change",
q,!1),h.getElementById("comment-name").addEventListener("keyup",q,!1),h.getElementById("comment-email").addEventListener("keyup",q,!1),h.getElementById("comment-text").addEventListener("keyup",q,!1);h.getElementById("top-controls").addEventListener("click",r,!1);h.getElementById("play-button").addEventListener("click",c,!1);h.getElementById("intro-en").addEventListener("click",function(){y="en";p();j()},!1);h.getElementById("intro-de").addEventListener("click",function(){y="de";p();j()},!1);h.getElementById("about-button").addEventListener("click",
function(){w("about")},!1);h.getElementById("contact-button").addEventListener("click",function(){w("contact")},!1);h.getElementById("back-button").addEventListener("click",function(){w()},!1);h.getElementById("help-button").addEventListener("click",function(){var a=h.getElementById("help-controls"),b=!a.offsetHeight;l.pause();r();if(b)a.style.display="block",R=!0},!1);h.getElementById("share-button").addEventListener("click",function(){var a=h.getElementById("share-controls"),b=!a.offsetHeight;l.pause();
r();if(b)a.style.display="block",R=!0},!1);h.getElementById("twitter-button").addEventListener("click",function(){var a=encodeURIComponent(f.location.protocol+"//"+f.location.host+f.location.pathname),b=encodeURIComponent(U.shareTwitter[y]);ta=f.open("http://twitter.com/share?count=none&counturl="+a+"&text="+b+"&url=","europeanasharetweet","left="+Math.round(screen.width/2-275)+",top="+Math.round(screen.height/2-225)+",width=550,height=450,personalbar=0,toolbar=0,scrollbars=1,resizable=1");ta.focus();
_gaq.push(["_trackSocial","twitter","tweet","remix.europeana.eu"])},!1);h.getElementById("facebook-button").addEventListener("click",function(){var a=f.location.protocol+"//"+f.location.host+f.location.pathname,b=encodeURIComponent(U.shareFacebook[y]);ua=f.open("http://facebook.com/sharer.php?u="+a+"&t="+b,"europeanasharefacebook","left="+Math.round(screen.width/2-275)+",top="+Math.round(screen.height/2-225)+",width=550,height=450,personalbar=0,toolbar=0,scrollbars=1,resizable=1");ua.focus();_gaq.push(["_trackSocial",
"facebook","send","remix.europeana.eu"])},!1);i("top-controls",{opacity:{from:0,to:1}},0.5);f.addEventListener("load",function(){d(!0)},!1);f.addEventListener("resize",d,!0);h.addEventListener("mousemove",function(a){M=Date.now();ca=b(a)},!1);var g=[{url:"image/page-bg.jpg",category:"display"},"image/background.jpg",{url:h.getElementById("main-style").getAttribute("href"),mode:"font",id:"chevin",families:["Chevin-Light"],category:"display"},"image/bg.png","image/logo.png","image/icon_facebook.png",
"image/icon_twitter.png","image/radio.png","image/settings.png"];J&&(g=g.concat([{url:"video/otto-and-bernard.webm",element:l,id:"video",category:"play"},{url:"data/resources.txt?"+Date.now(),type:"json",category:"data",id:"resources"},{url:"data/subtitles.txt",type:"json",category:"data",id:"subtitles"},"image/playpause.png","image/check.png","image/comment.png","image/comments.png","image/volume.png","image/intro-play.png","image/media-icons.png"]));g=new Loaderator(g,"all",function(){if(!J)return!1;
if(A>K)i("bottom-controls",{opacity:{from:0,to:1}},0.5);else{var a=h.getElementById("intro-play");a.innerHTML='<img src="image/intro-play.png"/>';a.addEventListener("click",function(){va.innerHTML='<a href="http://www.europeana.eu" target="_blank"><img src="image/poweredby-white.png"/></a>';l.play()},!1)}f.addEventListener("keypress",n,!1)});g.addEventListener("all:chevin",function(){d();A<K||!J?(i("intro-text",{opacity:{from:0,to:1}},1),i("intro-en",{opacity:{from:0,to:1}},1),i("intro-de",{opacity:{from:0,
to:1}},1)):h.getElementById("intro-text").style.opacity=1});g.addEventListener("all:image/logo.png",function(){d();S.style.zIndex="1500";i(S,{opacity:{from:0,to:1}},1)});g.addEventListener("all:image/page-bg.jpg",function(a){a=a.element;a.id="page-background";Q=a;E.parentNode.insertBefore(a,E.nextSibling);if(!J)E.style.display="block"});g.addEventListener("display",function(){ga&&!O&&w(ga);if(A<K||!J)E.style.display="block"});g.addEventListener("all:image/background.jpg",function(a){d();a=a.element;
E.insertBefore(a,E.firstChild);if(J){if(A<K){if(i(a,{opacity:{from:0,to:1}},1,function(){l.style.display="block"}),Q)E.style.display="block"}else l.style.display="block";var b=h.getElementById("end"),a=a.cloneNode(!1);b.insertBefore(a,b.firstChild)}});J&&(g.addEventListener("all:video",function(a){a.element.style.visibility="visible";var b=h.getElementById("end"),c=h.getElementById("end-text"),d=h.getElementById("end-close"),e=b.firstChild;v.code({start:"4:26",end:v.duration()-1,onStart:function(){b.style.display=
"block";d.style.display=""},onFrame:function(a,c){var d=Math.min((v.currentTime()-c.start)/K,1);if(b.style.opacity!==d)b.style.opacity=d},onEnd:function(a){if(v.currentTime()<a.start)b.style.display="";d.style.display="none"}});v.code({start:v.duration()-1,end:v.duration(),onStart:function(){if(!(e instanceof HTMLImageElement))e=b.firstChild;b.style.display="block";b.classList.add("final")},onFrame:function(a,d){var f=Math.min((v.currentTime()-d.start)/0.5,1);if(e.style.opacity!==f)e.style.opacity=
f;if(b.style.opacity<f)b.style.opacity=f;f=1-f;c.style.backgroundColor="rgba(255, 255, 255, "+f*0.85+")";c.style.borderColor="rgba(0, 0, 0, "+f*0.6+")"},onEnd:function(){b.style.cssText="";b.classList.remove("final")}})}),g.addEventListener("data:resources",function(a){var b={flickr:f.flickrApiKey||""},a=JSON.parse(a.element.responseText),c,d,e,g;for(c in a)if(a.hasOwnProperty(c)&&typeof v[c]==="function"){for(e=0,g=a[c].length;e<g;e++){d=a[c][e];if(b[c])d.apikey=b[c];d.target="resources";if(d.fadeIn===
void 0||isNaN(d.fadeIn))d.fadeIn=0.5;if(d.fadeOut===void 0||isNaN(d.fadeOut))d.fadeOut=0.5;v[c](d)}g&&V.indexOf(c)===-1&&(V.push(c),I.resources||v.disable(c))}}),g.addEventListener("data:subtitles",function(a){var b=JSON.parse(a.element.responseText);if(b)for(a=0;a<b.length;a++)b[a].languagesrc=F,v.subtitle(b[a])}),u(),f.addEventListener("keyup",function(a){var b=a.which||a.keyCode;if(G){if(M=Date.now(),b===27)G=!1,Y=l.currentTime,h.getElementById("add-comment-controls").style.display="none",a.preventDefault(),
H||l.play()}else b===37?(l.currentTime-=0.04,console.log("left",l.currentTime)):b===39&&(l.currentTime+=0.04,console.log("right",l.currentTime))},!1),v.code({start:0,end:K,onStart:function(){E.style.display="block";h.body.style.backgroundColor="#fff";S.style.zIndex="1500"},onFrame:function(){var a=1-Math.min(v.currentTime()/K,1);E.style.opacity=a;a=Math.round(a*255);h.body.style.backgroundColor="rgb("+a+", "+a+", "+a+")"},onEnd:function(){h.body.style.backgroundColor="#000";E.style.display="none";
S.style.zIndex=""}}))})()})(window);
