...
"object";break;case "xml":case "json":case "text":c.mode="ajax";break;default:c.mode="ajax"}}}else e=c.loader?c:!1;g=[];b&&g.push(b);var x;if(c.category){p=Object.prototype.toString.call(c.category)==="[object Array]"?c.category:[c.category];for(c=0;c<p.length;c++)x=p[c],g.indexOf(x)<0&&g.push(x)}g.length||g.push(e.fullUrl);if(e&&g.length&&(e.loader||e.mode&&this.loaders[e.mode])){for(c=0;c<g.length;c++){x=g[c];p=this.categories[x]||(this.categories[x]=new i.Category(x,this));if(e.categories===k)e.categories=
...
q))?(k=k.firstChild.nodeValue||"",k=i(k,32)):k="";var p=c("//dc:description",q),p=p?p.firstChild.nodeValue||"":"",v=c("//dc:source",q);v?(v=v.firstChild.nodeValue||"",v=i(v,50)):(v=c("//europeana:provider",q))?(v=v.firstChild.nodeValue||"",v=i(v,50)):v="";v&&(v="/"+v);var q=(q=c("//europeana:object",q))?q.firstChild.nodeValue||"":"",h=document.createElement("div");h.setAttribute("class","content");var Z=document.createElement("article");Z.appendChild(document.createTextNode(p));h.appendChild(Z);h.appendChild(document.createElement("br"));
...
o=c*h/e+b,!d.width)d.style.height=100*h/e+"%";a.loaded=!0},!1);g.addEventListener("click",B,!1)}})};if(a.url&&!a.photoid){var v=/^((https?:\/\/)?(www\.)?flickr\.com\/photos\/[^\/]+\/)?(\d+)/.exec(a.url);if(v&&v.length>=5)a.photoid=v[4]}a.photoid?G():a.username&&a.apikey?N():(e=a.userid,L());v=a.end-a.start;if(isNaN(a.fadeIn))a.fadeIn=Math.min(0.25,v/8);else if(a.fadeIn>v)a.fadeIn=v;v-=a.fadeIn;if(isNaN(a.fadeOut))a.fadeOut=Math.min(0.25,(a.end-a.start)/8);else if(a.fadeOut>v)a.fadeIn=v;return{start:function(a,
...
c=document.createElement("div");c.style.position="relative";o.appendChild(c);var N=function(){if(u.media&&u.media.buffered&&u.media.buffered.length){var a,b,e=!1,g,i,k=u.media.buffered;for(a=0,b=k.length;a<b;a++)if(g=k.start(a),i=k.end(a),g>u.media.duration&&(g=0),g<=d.end&&i>=d.start){e=!0;break}if(!e){setTimeout(N,10);return}}a="http://maps.googleapis.com/maps/api/staticmap?sensor=false&size=320x320&maptype=roadmap&"+[["center",d.center||d.location],["markers",d.location],["visible",d.location+
"|"+d.center]].map(function(a){return a[0]+"="+encodeURIComponent(a[1])}).join("&");var n=document.createElement("img");n.src=a;n.style.width="100%";c.appendChild(n);c.appendChild(f);b=document.createElement("div");b.setAttribute("class","info");b.innerHTML='<div class="media"><span class="hiding minimize" style="float: right; margin-right: 20px;">minimize window</span>map<span class="hiding"> | <span class="popcorn-source">source</span>: <a href="'+a+'" target="_new">Google Maps</a></span></div><div><a href="'+
a+'" target="_new">'+d.location+'</a></div><div class="watch">view map</div>';b.getElementsByClassName("minimize").item(0).addEventListener("click",x,!1);c.appendChild(b);z=d.width;C=d.top;L=d.left;n.addEventListener("load",function(){var a=/(\d*(\.\d*)?)\s*(px|em|\%|em|rem)?/,b;if(d.width&&!d.height&&(b=a.exec(d.width))&&b.length>1)a=b[3]||"",b=parseFloat(b[1]),b=b*n.height/n.width,c.style.height=b+a;d.loaded=!0},!1);c.addEventListener("click",j,!1)},G=d.end-d.start;if(isNaN(d.fadeIn))d.fadeIn=Math.min(0.25,
...
version:"0.1",author:"Brian Chirls",website:"http://chirls.com/"},options:{start:{elem:"input",type:"number",label:"In"},end:{elem:"input",type:"number",label:"Out"},url:{elem:"input",type:"text",label:"url"},target:"wikipedia-container"}})}})(window.Popcorn);(function(f){function k(a){if(!a)return!1;if(a.which)return a.which===3;if(a.button)return a.button===2}if(f){var i=0,a=!1,b=!1,g=function(){if(document.body){a=!0;var e=window.onYouTubePlayerAPIReady;window.onYouTubePlayerAPIReady=function(){b=!0;e&&e()};f.getScript("http://www.youtube.com/player_api")}else setTimeout(function(){g()},1)};f.plugin("youtube",function(e){var m,d,r,q,o,c,t,u=this,p=!1,s,n,j,x;a||g();x=function(a){var b=a.keyCode||a.which;if(b===27)j();else{if(b===32)t&&t.pauseVideo&&
(t.getPlayerState()===1?t.pauseVideo():t.getPlayerState()===2&&t.playVideo()),a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};s=function(a){if(!k(a)){var b=a.target;do if(b===m)return!0;while(b=b.parentNode);console.log(a);j();return!1}};n=function(a){if(!k(a)){p=u.media.paused;u.pause();d.removeEventListener("click",n,!1);window.addEventListener("click",s,!0);window.addEventListener("keydown",x,!0);m.classList.add("active");
m.style.cssText="";t&&t.playVideo&&t.playVideo();if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};j=function(a){if(!k(a)){t&&t.pauseVideo&&t.pauseVideo();m.classList.remove("active");m.style.width=r;if(q||o)m.style.top=q,m.style.left=o,m.style.position="absolute";d.addEventListener("click",n,!1);window.removeEventListener("keydown",x,!0);window.removeEventListener("click",s,!0);p||u.play();if(a)a.preventDefault&&a.preventDefault(),
...
z)e.fadeIn=z;z-=e.fadeIn;if(isNaN(e.fadeOut))e.fadeOut=Math.min(0.25,(e.end-e.start)/8);else if(e.fadeOut>z)e.fadeIn=z;e.videoid&&B();return{start:function(a,b){var c=function(){b.loaded?m.style.display="":setTimeout(c,1)};c()},end:function(){m.style.display="none";j()},_teardown:function(a){j();(a=document.getElementById(a.target))&&a.removeChild(m)},frame:function(a,b,c){if(b.loaded){var a=c-b.start,d=1;a<b.fadeIn?d=a/b.fadeIn:c>b.end-b.fadeOut&&(d=(b.end-c)/b.fadeOut);m.style.opacity=d}}}},{about:{name:"Popcorn YouTube Plugin",
...
$=h.getElementById("add-comment-timer"),D=h.getElementById("progress"),P=h.getElementById("volume-canvas"),ha,aa,E=h.getElementById("intro"),S=h.getElementById("eu-logo"),Q,ta,ua,w,A=0,I=!1,la=!1,xa=RegExp("^[a-z0-9!#$%&'*+\\/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+\\/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+(?:[A-Z]{2}|aero|asia|biz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|pro|tel|travel|xxx)$","i"),oa=function(){return f.requestAnimationFrame||f.webkitRequestAnimationFrame||
...
function(){y="en";p();j()},!1);h.getElementById("intro-de").addEventListener("click",function(){y="de";p();j()},!1);if(F)h.getElementById("comments-button").addEventListener("click",function(){J.comments=!J.comments;t("comments");J.comments?w.enable("videoComment"):w.disable("videoComment")},!1),h.getElementById("resources-button").addEventListener("click",function(){var a,b;J.resources=!J.resources;t("resources");if(J.resources)for(a=0,b=V.length;a<b;a++)w.enable(V[a]);else for(a=0,b=V.length;a<
b;a++)w.disable(V[a])},!1),h.getElementById("subtitles-button").addEventListener("click",function(){J.subtitles=!J.subtitles;t("subtitles");J.subtitles?w.enable("subtitle"):w.disable("subtitle")},!1),h.getElementById("language-en").addEventListener("click",function(){y="en";p();j()},!1),h.getElementById("language-de").addEventListener("click",function(){y="de";p();j()},!1),h.getElementById("logo-link").addEventListener("click",function(){l.pause();l.currentTime=0},!1),h.getElementById("settings-button").addEventListener("click",
...
q,!1),h.getElementById("comment-text").addEventListener("keyup",q,!1);h.getElementById("about-button").addEventListener("click",function(){x("about")},!1);h.getElementById("contact-button").addEventListener("click",function(){x("contact")},!1);h.getElementById("back-button").addEventListener("click",function(){x()},!1);h.getElementById("help-button").addEventListener("click",function(){var a=h.getElementById("help-controls"),b=!a.offsetHeight;l.pause();r();if(b)a.style.display="block",R=!0},!1);h.getElementById("share-button").addEventListener("click",
...
b[c];d.target="resources";if(d.fadeIn===void 0||isNaN(d.fadeIn))d.fadeIn=0.5;if(d.fadeOut===void 0||isNaN(d.fadeOut))d.fadeOut=0.5;w[c](d)}g&&V.indexOf(c)===-1&&(V.push(c),J.resources||w.disable(c))}}),g.addEventListener("data:subtitles",function(a){var b=JSON.parse(a.element.responseText);if(b)for(a=0;a<b.length;a++)b[a].languagesrc=G,w.subtitle(b[a])}),u(),f.addEventListener("keyup",function(a){var b=a.which||a.keyCode;if(H){if(M=Date.now(),b===27)H=!1,Y=l.currentTime,h.getElementById("add-comment-controls").style.display=
"none",a.preventDefault(),I||l.play()}else b===37?(l.currentTime-=0.04,console.log("left",l.currentTime)):b===39&&(l.currentTime+=0.04,console.log("right",l.currentTime))},!1),w.code({start:0,end:K,onStart:function(){E.style.display="block";h.body.style.backgroundColor="#fff";S.style.zIndex="1500"},onFrame:function(){var a=1-Math.min(w.currentTime()/K,1);E.style.opacity=a;a=Math.round(a*255);h.body.style.backgroundColor="rgb("+a+", "+a+", "+a+")"},onEnd:function(){h.body.style.backgroundColor="#000";
