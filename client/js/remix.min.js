...
fa=1024,ga=576;(function(){L();f.addEventListener("hashchange",L,!1);if(!Modernizr||!Modernizr.video)z();else{v=ta("#video");try{ea=N.getContext("2d"),Y=D.getContext("2d")}catch(a){}n.readyState>=2?J():n.addEventListener("loadedmetadata",J,!1);if(h.body&&B>1.5)h.body.style.backgroundColor="#000"}d();if(B>1.5)h.body.style.backgroundColor="#000";x=h.documentElement.getAttribute("lang")||"en";o();F&&(A(),C(),n.addEventListener("play",function(){h.getElementById("play-button").classList.add("active");
