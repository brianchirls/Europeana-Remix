...
this.loader,this.resourcesById),0):d.call(this.loader,this.resourcesById)}}}};j.prototype.setBase=function(a){var d=b.getElementsByTagName("base"),l;this.base=null;if(a){if(a=e.exec(a))this.base={},this.base.protocol=a[2]+":",this.base.hostname=a[3],this.base.port=a[7]||"",this.base.host=this.base.hostname+(this.base.port?":"+this.base.port:""),this.base.pathname=a[8]}else for(l=0;l<d.length;l++)if(a=d.item(l),a=a.getAttribute("href"))if(a=e.exec(a)){this.base={};this.base.protocol=a[2]+":";this.base.hostname=
...
g,h[i.startIndex]),h[i.startIndex]._natives.frame&&p.push(h[i.startIndex]);i.startIndex++}else{c.removeTrackEvent(a,h[i.startIndex]._id);return}for(;s<p.length;)p[s]._running==!1?p.splice(s,1):(p[s]._natives.frame.call(a,g,p[s],b),s++)}else if(d>b){for(;h[i.startIndex]&&h[i.startIndex].start>b;)if(!h[i.startIndex]._natives||a[h[i.startIndex]._natives.type]){if(h[i.startIndex]._running===!0)h[i.startIndex]._running=!1,h[i.startIndex]._natives.end.call(a,g,h[i.startIndex]);i.startIndex--}else{c.removeTrackEvent(a,
h[i.startIndex]._id);return}for(;e[i.endIndex]&&e[i.endIndex].end>b;)if(!e[i.endIndex]._natives||a[e[i.endIndex]._natives.type]){if(e[i.endIndex].start<=b&&e[i.endIndex]._running===!1&&a.data.disabled.indexOf(h[i.endIndex]._natives.type)===-1)e[i.endIndex]._running=!0,e[i.endIndex]._natives.start.call(a,g,e[i.endIndex]),e[i.endIndex]._natives.frame&&p.push(e[i.endIndex]);i.endIndex--}else{c.removeTrackEvent(a,e[i.endIndex]._id);return}for(;s<p.length;)p[s]._running==!1?p.splice(s,1):(p[s]._natives.frame.call(a,
g,p[s],b),s++)}i.previousUpdateTime=b;l(o)};l(o)}else f.setTimeout(function(){e(a)},1)};e(this);return this}}};c.p.init.prototype=c.p;c.forEach=function(a,c,d){if(!a||!c)return{};d=d||this;if(b&&a.forEach===b)return a.forEach(c,d);for(var i in a)e.call(a,i)&&c.call(d,a[i],i,a);return a};c.extend=function(a){var b=a,d=g.call(arguments,1);c.forEach(d,function(a){for(var c in a)b[c]=a[c]});return b};c.extend(c,{error:function(a){throw Error(a);},guid:function(a){c.guid.counter++;return(a?a:"")+(+new Date+
c.guid.counter)},sizeOf:function(a){var c=0,b;for(b in a)c++;return c},isArray:Array.isArray||function(a){return m.call(a)==="[object Array]"},nop:function(){},position:function(a){var a=a.getBoundingClientRect(),b={},d=k.documentElement,i=k.body,e,g,j;e=d.clientTop||i.clientTop||0;g=d.clientLeft||i.clientLeft||0;j=f.pageYOffset&&d.scrollTop||i.scrollTop;d=f.pageXOffset&&d.scrollLeft||i.scrollLeft;e=Math.ceil(a.top+j-e);g=Math.ceil(a.left+d-g);for(var C in a)b[C]=Math.round(a[C]);return c.extend({},
...
json:c};a.dataType&&(b=b[a.dataType]);a.success.call(a.ajax,b)}};return b};c.xhr.getJSONP=function(a,b,d){if(d&&k.querySelectorAll('script[src="'+a+'"]').length)b&&b(!0);else{var e=k.head||k.getElementsByTagName("head")[0]||k.documentElement,g=k.createElement("script"),j=a.split("?")[1],f=!1,m=[],l,r;j&&!d&&(m=j.split("&"));m.length&&(r=m[m.length-1].split("="));l=m.length?r[1]?r[1]:r[0]:"jsonp";!j&&!d&&(a+="?callback="+l);l&&!d&&(window[l]&&(l=c.guid(l)),window[l]=function(a){b&&b(a);f=!0},a=a.replace(r.join("="),
r[0]+"="+l));g.onload=g.onreadystatechange=function(){if(!g.readyState||/loaded|complete/.test(g.readyState))d&&b&&b(),f&&(delete window[l],e.removeChild(g))};g.src=a;e.insertBefore(g,e.firstChild)}};c.getJSONP=c.xhr.getJSONP;c.getScript=c.xhr.getScript=function(a,b){return c.xhr.getJSONP(a,b,!0)};c.util={toSeconds:function(a,b){var d=/^([0-9]+:){0,2}[0-9]+([.;][0-9]+)?$/;if(typeof a==="number")return a;else typeof a==="string"?d.test(a)||c.error("Invalid time format"):c.error("Invalid time format");
...
o,!0);window.removeEventListener("click",c,!0);l||q.play();if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};a.loaded=!1;b=document.createElement("div");b.setAttribute("class","europeana");b.id="europeana"+j;if(a.width)b.style.width=a.width;if(a.height)b.style.height=a.height;b.style.display="none";j++;if(document.getElementById(a.target))document.getElementById(a.target).appendChild(b);else throw"europeana target container doesn't exist";
if(a.top||a.left)b.style.position="absolute",b.style.top=a.top,b.style.left=a.left;g=document.createElement("div");g.style.position="relative";b.appendChild(g);var s=new XMLHttpRequest;s.open("GET","europeana.php?id="+a.id);s.onreadystatechange=function(){function b(a){return p[a]||null}function c(a,d){var e,h;e=d.ownerDocument||d;if(e.evaluate)return(e=e.evaluate(a,d,b,XPathResult.FIRST_ORDERED_NODE_TYPE,null))&&e.singleNodeValue;else{e.setProperty("SelectionLanguage","XPath");if(!j){j=[];for(h in p)j.push("xmlns:"+
h+'="'+p[h]+'"');j=j.join(" ");e.setProperty("SelectionNamespaces",j)}if(d===e&&e.documentElement)d=e.documentElement;return d.selectSingleNode(a)}}var j="",p={srw:"http://www.loc.gov/zing/srw/",diag:"http://www.loc.gov/zing/srw/diagnostic/",xcql:"http://www.loc.gov/zing/cql/xcql/",mods:"http://www.loc.gov/mods/v3",europeana:"http://www.europeana.eu",enrichment:"http://www.europeana.eu/schemas/ese/enrichment/",dcterms:"http://purl.org/dc/terms/",dc:"http://purl.org/dc/elements/1.1/",dcx:"http://purl.org/dc/elements/1.1/",
tel:"http://krait.kb.nl/coop/tel/handbook/telterms.html",xsi:"http://www.w3.org/2001/XMLSchema-instance"};if(s.readyState===4&&s.status===200){var l=s.responseXML;if(l){var k=!l.ownerDocument?l.documentElement:l.ownerDocument.documentElement,l=(l=c("//dc:title",k))?l.firstChild.nodeValue||"":"",q=c("//dc:description",k),q=q?q.firstChild.nodeValue||"":"",o=c("//dc:source",k);o=o?o.firstChild.nodeValue||"":(o=c("//europeana:provider",k))?o.firstChild.nodeValue||"":"";o&&(o="/"+o);var k=(k=c("//europeana:object",
k))?k.firstChild.nodeValue||"":"",z=document.createElement("div");z.setAttribute("class","content");var h=document.createElement("article");h.appendChild(document.createTextNode(q));z.appendChild(h);z.appendChild(document.createElement("br"));g.appendChild(z);q=document.createElement("div");q.setAttribute("class","info");l=l.replace("<","&lt;");l=l.replace(">","&gt;");q.innerHTML='<div class="media"><span class="hiding minimize" style="float: right; margin-right: 20px;">minimize window</span>image<span class="hiding"> | <span class="popcorn-source">source</span>: <a href="http://www.europeana.eu/portal/record/'+
a.id+'.html" target="_new">Europeana'+o+'</a></span></div><div><a href="http://www.europeana.eu/portal/record/'+a.id+'.html" target="_new">'+l+'</a></div><div class="watch">view details</div>';q.getElementsByClassName("minimize").item(0).addEventListener("click",u,!1);g.appendChild(q);k?(e=document.createElement("_image"),e.src=k,e.onload=function(){a.loaded=!0},z.insertBefore(e,z.firstChild)):a.loaded=!0;f=a.width;d=a.top;r=a.left;g.addEventListener("click",t,!1)}}};s.send(null);var p=a.end-a.start;
if(isNaN(a.fadeIn))a.fadeIn=Math.min(0.25,p/8);else if(a.fadeIn>p)a.fadeIn=p;p-=a.fadeIn;if(isNaN(a.fadeOut))a.fadeOut=Math.min(0.25,(a.end-a.start)/8);else if(a.fadeOut>p)a.fadeIn=p;return{start:function(a,c){var d=function(){c.loaded?b.style.display="":setTimeout(d,1)};d()},end:function(){b.style.display="none"},_teardown:function(a){(a=document.getElementById(a.target))&&a.removeChild(b)},frame:function(a,c,d){var a=d-c.start,e=1;a<c.fadeIn?e=a/c.fadeIn:d>c.end-c.fadeOut&&(e=(c.end-d)/c.fadeOut);
...
type:"text",label:"Height"},width:{elem:"input",type:"text",label:"Width"},padding:{elem:"input",type:"text",label:"Padding"},border:{elem:"input",type:"text",label:"Border"},numberofimages:{elem:"input",type:"text",label:"Number of Images"}}})}})(window.Popcorn);(function(f){function k(a){if(!a)return!1;if(a.which)return a.which===3;if(a.button)return a.button===2}if(f){var j=0;f.plugin("flickr",function(a){var b,g,e,m,d,r,q=a.numberofimages||4,l,c,t,u,o=a.padding||"5px",s=a.border||"0px",p=this,i=!1,w,B,y,C;C=function(a){(a.keyCode||a.which)===27&&y()};w=function(a){if(!k(a)){var c=a.target;do if(c===b)return!0;while(c=c.parentNode);console.log(a);y();return!1}};B=function(a){if(!k(a)){i=p.media.paused;p.pause();g.removeEventListener("click",B,!1);window.addEventListener("click",
w,!0);window.addEventListener("keydown",C,!0);b.classList.add("active");b.style.cssText="";if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};y=function(a){if(!k(a)){b.classList.remove("active");b.style.width=c;if(t||u)b.style.top=t,b.style.left=u,b.style.position="absolute";g.addEventListener("click",B,!1);window.removeEventListener("keydown",C,!0);window.removeEventListener("click",w,!0);i||p.play();if(a)a.preventDefault&&
...
a.left;g=document.createElement("div");g.style.position="relative";b.appendChild(g);var J=function(){m="http://api.flickr.com/services/feeds/photos_public.gne?";e&&(m+="id="+e+"&");a.tags&&(m+="tags="+a.tags+"&");m+="lang=en-us&format=json&jsoncallback=flickr";f.xhr.getJSONP(m,function(b){g.innerHTML="<p style='padding:"+o+";'>"+b.title+"<p/>";f.forEach(b.items,function(b,e){if(e<q)d=document.createElement("a"),d.setAttribute("href",b.link),d.setAttribute("target","_blank"),r=document.createElement("img"),
r.setAttribute("src",b.media.m),r.setAttribute("height",l),r.setAttribute("width",c),r.setAttribute("style","border:"+s+";padding:"+o),d.appendChild(r),g.appendChild(d),a.loaded=!0;else return!1})})},L=function(){e?setTimeout(function(){L()},5):(m="http://api.flickr.com/services/rest/?method=flickr.people.findByUsername&",m+="username="+a.username+"&api_key="+a.apikey+"&format=json&jsoncallback=flickr",f.getJSONP(m,function(a){e=a.user.nsid;J()}))},G=function(){if(p.media&&p.media.buffered){var b,
d,e=!1,i,j,k=p.media.buffered;for(b=0,d=k.length;b<d;b++)if(i=k.start(b),j=k.end(b),i>p.media.duration&&(i=0),i<=a.end&&j>=a.start){e=!0;break}if(!e){setTimeout(G,10);return}}m="http://api.flickr.com/services/rest/?method=flickr.photos.getInfo";a.apikey&&(m+="&api_key="+a.apikey);m+="&photo_id="+a.photoid+"&lang=en-us&format=json&jsoncallback=flickr";f.xhr.getJSONP(m,function(b){if(b&&b.stat==="ok"&&b.photo){var b=b.photo,d=document.createElement("img");d.src="http://farm"+b.farm+".static.flickr.com/"+
...
(function(f){function k(a){if(!a)return!1;if(a.which)return a.which===3;if(a.button)return a.button===2}if(f){var j=0,a=0,b=!1,g=!1,e,m;googleCallback=function(a){typeof window.google!=="undefined"&&window.google.maps&&window.google.maps.Geocoder&&window.google.maps.LatLng?(e=new window.google.maps.Geocoder,g=!0):setTimeout(function(){googleCallback(a)},1)};m=function(){document.body?(b=!0,f.getScript("http://maps.google.com/maps/api/js?sensor=false&callback=googleCallback")):setTimeout(function(){m()},1)};
f.plugin("googlemap",function(d){var f,q,l,c,t=!1,u=this,o,s=!1,p,i,w,B,y,C,J;b||m();d.map=null;B=function(a){(a.keyCode||a.which)===27&&w()};p=function(a){if(k(a))return!0;var b=a.target;do if(b===l)return!0;while(b=b.parentNode);console.log("otherwindows",a);w();return!1};i=function(a){if(k(a))return!0;s=u.media.paused;u.pause();t||o();if(d.map)d.map.getDiv().style.display="block";c.removeEventListener("click",i,!1);window.addEventListener("click",p,!0);window.addEventListener("keydown",B,!0);l.classList.add("active");
l.style.cssText="";if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1};w=function(a){if(k(a))return!0;if(d.map)d.map.getDiv().style.display="none";l.classList.remove("active");l.style.width=y;if(C||J)l.style.top=C,l.style.left=J,l.style.position="absolute";c.addEventListener("click",i,!1);window.removeEventListener("keydown",B,!0);window.removeEventListener("click",p,!0);s||u.play();if(a)a.preventDefault&&a.preventDefault(),
a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1};d.loaded=!1;l=document.createElement("div");l.setAttribute("class","googlemap");l.id="googlemap"+j;if(d.width)l.style.width=d.width;if(d.height)l.style.height=d.height;l.style.display="none";j++;if(document.getElementById(d.target))document.getElementById(d.target).appendChild(l);else throw"googlemap target container doesn't exist";if(d.top||d.left)l.style.position="absolute",l.style.top=d.top,l.style.left=d.left;
c=document.createElement("div");c.style.position="relative";l.appendChild(c);var L=function(){if(u.media&&u.media.buffered){var a,b,e=!1,g,j,l=u.media.buffered;for(a=0,b=l.length;a<b;a++)if(g=l.start(a),j=l.end(a),g>u.media.duration&&(g=0),g<=d.end&&j>=d.start){e=!0;break}if(!e){setTimeout(L,10);return}}a="http://maps.googleapis.com/maps/api/staticmap?sensor=false&size=320x320&maptype=roadmap&"+[["center",d.center||d.location],["markers",d.location],["visible",d.location+"|"+d.center]].map(function(a){return a[0]+
...
setTimeout(function(){o()},5)};return{start:function(a,b){var c=function(){if(!(u.media.currentTime>=b.end||u.media.currentTime<b.start))b.loaded?l.style.display="":setTimeout(c,1)};c();var d=this,e=function(){if(b.map){b.map.getDiv().style.display="block";google.maps.event.trigger(b.map,"resize");b.map.setCenter(q);if(b.zoom&&typeof b.zoom!=="number")b.zoom=+b.zoom;b.zoom=b.zoom||8;b.map.setZoom(b.zoom);if(b.heading&&typeof b.heading!=="number")b.heading=+b.heading;if(b.pitch&&typeof b.pitch!=="number")b.pitch=
+b.pitch}else d.media.currentTime>=b.start&&d.media.currentTime<=b.end&&setTimeout(function(){e()},13)};e()},end:function(a,b){l.style.display="none";if(b.map)b.map.getDiv().style.display="none"},_teardown:function(a){document.getElementById(a.target).removeChild(l);l=c=f=a.map=q=null},frame:function(a,b,c){var a=c-b.start,d=1;a<b.fadeIn?d=a/b.fadeIn:c>b.end-b.fadeOut&&(d=(b.end-c)/b.fadeOut);l.style.opacity=d}}},{about:{name:"Popcorn Google Map Plugin",version:"0.1",author:"@annasob",website:"annasob.wordpress.com"},
...
j.fadeOut&&(b=(j.end-a)/j.fadeOut);j.div.style.opacity=b}})})(window.Popcorn);(function(f){function k(a){if(!a)return!1;if(a.which)return a.which===3;if(a.button)return a.button===2}if(f){var j=0;f.plugin("image",function(a){var b,g,e,f,d,r,q=this,l=!1,c,t,u,o;if(a.url){o=function(a){(a.keyCode||a.which)===27&&u()};c=function(a){if(!k(a)){var c=a.target;do if(c===b)return!0;while(c=c.parentNode);console.log(a);u();return!1}};t=function(a){if(!k(a)){l=q.media.paused;q.pause();g.removeEventListener("click",t,!1);window.addEventListener("click",c,!0);window.addEventListener("keydown",
...
c,!0);l||q.play();if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};a.loaded=!1;b=document.createElement("div");b.setAttribute("class","image");b.id="image"+j;if(a.width)b.style.width=a.width;if(a.height)b.style.height=a.height;b.style.display="none";j++;if(document.getElementById(a.target))document.getElementById(a.target).appendChild(b);else throw"image target container doesn't exist";if(a.top||a.left)b.style.position=
"absolute",b.style.top=a.top,b.style.left=a.left;g=document.createElement("div");g.style.position="relative";b.appendChild(g);var s=function(){if(q.media&&q.media.buffered){var b,c,j=!1,l,p,k=q.media.buffered;for(b=0,c=k.length;b<c;b++)if(l=k.start(b),p=k.end(b),l>q.media.duration&&(l=0),l<=a.end&&p>=a.start){j=!0;break}if(!j){setTimeout(s,10);return}}e=document.createElement("img");e.src=a.url;e.style.width="100%";g.appendChild(e);b=document.createElement("div");b.setAttribute("class","info");c=
...
a.width;d=a.top;r=a.left;e.addEventListener("load",function(){var b=/(\d*(\.\d*)?)\s*(px|em|\%|em|rem)?/,c,d,f;d=e.width||e.naturalWidth;f=e.height||e.naturalHeight;if(a.width&&!a.height&&(c=b.exec(a.width))&&c.length>1)if(b=c[3]||"",c=parseFloat(c[1]),c=c*e.height/e.width,g.style.height=c+b,!e.width)e.style.height=100*f/d+"%";a.loaded=!0},!1);g.addEventListener("click",t,!1)};s();var p=a.end-a.start;if(isNaN(a.fadeIn))a.fadeIn=Math.min(0.25,p/8);else if(a.fadeIn>p)a.fadeIn=p;p-=a.fadeIn;if(isNaN(a.fadeOut))a.fadeOut=
Math.min(0.25,(a.end-a.start)/8);else if(a.fadeOut>p)a.fadeIn=p;return{start:function(a,c){var d=function(){c.loaded?b.style.display="":setTimeout(d,1)};d()},end:function(){b.style.display="none"},_teardown:function(a){(a=document.getElementById(a.target))&&a.removeChild(b)},frame:function(a,c,d){var a=d-c.start,e=1;a<c.fadeIn?e=a/c.fadeIn:d>c.end-c.fadeOut&&(e=(c.end-d)/c.fadeOut);b.style.opacity=e}}}},{about:{name:"Popcorn Image Plugin",version:"0.1",author:"Brian Chirls",website:"http://chirls.com/"},
options:{start:{elem:"input",type:"number",label:"In"},end:{elem:"input",type:"number",label:"Out"},target:"image-container",height:{elem:"input",type:"text",label:"Height"},width:{elem:"input",type:"text",label:"Width"}}})}})(window.Popcorn);(function(f){if(f){var k=0,j=function(a){var g=a.container=document.createElement("div"),e=g.style,m=a.media;j=f.nop;var d=function(){var f=a.position();e.fontSize="18px";e.width=m.offsetWidth+"px";e.top=f.top+m.offsetHeight-g.offsetHeight-40+"px";e.left=f.left+"px";setTimeout(d,10)};g.id="subtitlediv";e.position="absolute";e.color="white";e.textShadow="black 2px 2px 6px";e.fontWeight="bold";e.textAlign="center";d();document.body.appendChild(g)},a=function(a){if(a.languagesrc){if(typeof a.languagesrc===
...
""),e=[],j,l,k,s,e=e.concat(b.parse.images);for(s=0;s<e.length;s++)if(k=e[s].substr(-4).toLowerCase(),k===".jpg"){l=e[s];break}else k===".png"&&(j=e[s]);l||(l=j);var t=document.createElement("div");t.setAttribute("class","content");j=document.createElement("article");j.appendChild(document.createTextNode(c));t.appendChild(j);t.appendChild(document.createElement("br"));g.appendChild(t);c=document.createElement("div");c.setAttribute("class","info");b=b.parse.displaytitle;b=b.replace("<","&lt;");b=b.replace(">",
...
u,!1);l?(l="http://"+m+".wikipedia.org/w/api.php?action=query&prop=imageinfo&titles=File:"+l+"&iiprop=url|size&iiurlwidth=200&iiurlheight=200&format=json&callback=wikipediaImage",f.xhr.getJSONP(l,function(b){var c;b.query.pages&&b.query.pages[0]&&(c=b.query.pages[0].imageinfo[0]);if(c)b=document.createElement("img"),b.src=c.thumburl||c.url,b.onload=function(){a.loaded=!0},t.insertBefore(b,t.firstChild)})):a.loaded=!0}});e=a.end-a.start;if(isNaN(a.fadeIn))a.fadeIn=Math.min(0.25,e/8);else if(a.fadeIn>
...
version:"0.1",author:"Brian Chirls",website:"http://chirls.com/"},options:{start:{elem:"input",type:"number",label:"In"},end:{elem:"input",type:"number",label:"Out"},url:{elem:"input",type:"text",label:"url"},target:"wikipedia-container"}})}})(window.Popcorn);(function(f){function k(a){if(!a)return!1;if(a.which)return a.which===3;if(a.button)return a.button===2}if(f){var j=0,a=!1,b=!1,g=function(){if(document.body){a=!0;var e=window.onYouTubePlayerAPIReady;window.onYouTubePlayerAPIReady=function(){b=!0;e&&e()};f.getScript("http://www.youtube.com/player_api")}else setTimeout(function(){g()},1)};f.plugin("youtube",function(e){var m,d,r,q,l,c,t,u=this,o=!1,s,p,i,w;a||g();w=function(a){var b=a.keyCode||a.which;if(b===27)i();else{if(b===32)t&&t.pauseVideo&&
(t.getPlayerState()===1?t.pauseVideo():t.getPlayerState()===2&&t.playVideo()),a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};s=function(a){if(!k(a)){var b=a.target;do if(b===m)return!0;while(b=b.parentNode);console.log(a);i();return!1}};p=function(a){if(!k(a)){o=u.media.paused;u.pause();d.removeEventListener("click",p,!1);window.addEventListener("click",s,!0);window.addEventListener("keydown",w,!0);m.classList.add("active");
m.style.cssText="";t&&t.playVideo&&t.playVideo();if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};i=function(a){if(!k(a)){t&&t.pauseVideo&&t.pauseVideo();m.classList.remove("active");m.style.width=r;if(q||l)m.style.top=q,m.style.left=l,m.style.position="absolute";d.addEventListener("click",p,!1);window.removeEventListener("keydown",w,!0);window.removeEventListener("click",s,!0);o||u.play();if(a)a.preventDefault&&a.preventDefault(),
a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};e.loaded=!1;m=document.createElement("div");m.setAttribute("class","youtube");m.id="youtube"+j;if(e.width)m.style.width=e.width;if(e.height)m.style.height=e.height;m.style.display="none";j++;if(document.getElementById(e.target))document.getElementById(e.target).appendChild(m);else throw"youtube target container doesn't exist";if(e.top||e.left)m.style.position="absolute",m.style.top=e.top,m.style.left=e.left;d=document.createElement("div");
d.style.position="relative";m.appendChild(d);var B=function(){if(u.media&&u.media.buffered){var a,g,j=!1,k,m,h=u.media.buffered;for(a=0,g=h.length;a<g;a++)if(k=h.start(a),m=h.end(a),k>u.media.duration&&(k=0),k<=e.end&&m>=e.start){j=!0;break}if(!j){setTimeout(B,10);return}}c="http://gdata.youtube.com/feeds/api/videos/"+e.videoid+"?v=2&alt=jsonc&callback=youtube";f.xhr.getJSONP(c,function(a){if(a&&a.data){var c=a.data;(a=e.url)||(a="http://www.youtube.com/watch?v="+c.id);var g=document.createElement("img");
g.src=c.thumbnail.hqDefault;g.style.width="100%";d.appendChild(g);var f=document.createElement("div");f.id="ytplayer-"+c.id;f.setAttribute("class","player");d.appendChild(f);var h=function(){b?t=new window.YT.Player("ytplayer-"+c.id,{height:320,width:240,videoId:c.id,playerVars:{origin:document.location.protocol+"//"+document.location.hostname},events:{onReady:function(){}}}):setTimeout(h,1)},f=document.createElement("div");f.setAttribute("class","info");f.innerHTML='<div class="media">video<span class="hiding"> | <span class="popcorn-source">source</span>: <a href="'+
a+'" target="_new">YouTube</a></span></div><div><a href="'+a+'" target="_new">'+c.title+'</a></div><div class="watch">watch video</div>';d.appendChild(f);a=document.createElement("span");a.innerHTML="minimize window";a.setAttribute("class","minimize");a.addEventListener("click",i,!1);d.appendChild(a);h();r=e.width;q=e.top;l=e.left;g.addEventListener("load",function(){var a=/(\d*(\.\d*)?)\s*(px|em|\%|em|rem)?/,b,c,f;c=g.width||g.naturalWidth;f=g.height||g.naturalHeight;if(e.width&&!e.height&&(b=a.exec(e.width))&&
b.length>1)if(a=b[3]||"",b=parseFloat(b[1]),b=b*g.height/g.width,d.style.height=b+a,!g.width)g.style.height=100*f/c+"%";e.loaded=!0},!1);d.addEventListener("click",p,!1)}})};if(e.url&&!e.videoid){var y=/^(https?:\/\/)?(www\.)?(youtube\.com\/watch\?v=|youtu\.be\/)([A-Za-z0-9_\-]*)/i.exec(e.url);if(y&&y.length>=5)e.videoid=y[4]}e.videoid&&B();y=e.end-e.start;if(isNaN(e.fadeIn))e.fadeIn=Math.min(0.25,y/8);else if(e.fadeIn>y)e.fadeIn=y;y-=e.fadeIn;if(isNaN(e.fadeOut))e.fadeOut=Math.min(0.25,(e.end-e.start)/
8);else if(e.fadeOut>y)e.fadeIn=y;return{start:function(a,b){var c=function(){b.loaded?m.style.display="":setTimeout(c,1)};c()},end:function(){m.style.display="none";i()},_teardown:function(a){i();(a=document.getElementById(a.target))&&a.removeChild(m)},frame:function(a,b,c){if(b.loaded){var a=c-b.start,d=1;a<b.fadeIn?d=a/b.fadeIn:c>b.end-b.fadeOut&&(d=(b.end-c)/b.fadeOut);m.style.opacity=d}}}},{about:{name:"Popcorn YouTube Plugin",version:"0.1",author:"Brian Chirls",website:"http://chirls.com/"},
...
c;if(a)if(a.pageX!==void 0||a.pageY!==void 0)b=a.pageX,c=a.pageY;else if(a.clientX!==void 0||a.clientY!==void 0)b=a.clientX+h.body.scrollLeft+h.documentElement.scrollLeft,c=a.clientY+h.body.scrollTop+h.documentElement.scrollTop;return{x:b,y:c}}function g(a,b){var c=b;a.x-=b.clientLeft+b.offsetLeft;for(a.y-=b.clientTop+b.offsetTop;(c=c.offsetParent)&&c.nodeName!=="BODY";)a.x-=c.clientLeft+c.offsetLeft,a.y-=c.clientTop+c.offsetTop}function e(){if(ja){var a=N.height-17,b=a*(1-n.volume),c=ja;c.shadowOffsetX=
...
c.shadowOffsetX=1;c.shadowOffsetY=2;c.shadowBlur=5;c.shadowColor="rgba(0, 0, 0, 0.19)";c.arc(8.5,b,8.5,0,Math.PI*2,!0);c.fill();c.shadowOffsetX=0;c.shadowOffsetY=0;c.shadowBlur=0;c.beginPath();c.fillStyle="#02fdca";c.arc(8.5,b,3.5,0,Math.PI*2,!0);c.fill()}}function m(a){if(n.duration&&ca&&(a||!(xa===n.currentTime&&n.networkState>=4))){var b=D.width-17,a=b*n.currentTime/n.duration,c=ca;c.shadowOffsetX=0;c.shadowOffsetY=0;c.shadowBlur=0;c.clearRect(0,0,D.width,D.height);c.lineWidth=7;c.lineCap="round";
var d=c.createLinearGradient(0,0,0,7);d.addColorStop(0,"rgba(112, 112, 112, 0.38)");d.addColorStop(1,"rgba(241, 241, 241, 0.38)");c.strokeStyle=d;c.beginPath();c.moveTo(8.5,8.5);c.lineTo(b+8.5,8.5);c.stroke();var d=[],e,f,h,i=n.buffered,j=0;if(i){for(e=0,f=i.length;e<f;e++)h=i.start(e),h>n.duration&&(h=0),h!==j&&d.push({start:j,end:h}),j=i.end(e);j!==n.duration&&d.push({start:j,end:n.duration})}if(da){e=j===n.duration?0:Math.floor(Date.now()/40)%8;c.strokeStyle=da[e];for(e=0,f=d.length;e<f;e++)j=
...
b,0,Math.PI*2,!0),c.fill(),c.shadowOffsetX=0,c.shadowOffsetY=0,c.shadowBlur=0;c.beginPath();c.fillStyle="#02fdca";c.arc(a,8.5,3.5,0,Math.PI*2,!0);c.fill()}}function d(a){var b=f.innerWidth||800,c=f.innerHeight||b*9/16;if(a||b!==pa||c!==qa||!D.width){pa=b;qa=c;var d=V/W/(b/c),e,g,i,j,k,l;d>1.2?(l=Math.min(1,(d-1.2)/0.25),g=Math.min(l*30,Math.max(b-640,0)*0.1),i=Math.floor(b-g*2),k=i/V,j=Math.floor(W*k),e=(c*1.2/d-j)/2):d<1/1.05?(l=Math.min(1,(1/1.05-d)/0.2),e=Math.min(l*40,Math.max(b-360,0)*0.1),j=
Math.floor(c-e*2),k=j/W,i=Math.floor(V*k),g=(b*d/(1/1.05)-i)/2):(k=Math.min(c/W,b/V),i=Math.floor(V*k),j=Math.floor(W*k),g=(b-i)/2,e=(c-j)/2,l=0);h.body.style.overflow=i<640?"auto":"";if(ra!==l){if(l>0){if($.style.display!=="block")$.style.display="block";$.style.opacity=l;if(aa.style.display!=="block")aa.style.display="block";aa.style.opacity=l}else $.style.display="none",aa.style.display="none";ra=l}h.body.style.fontSize=Math.round(k*8)+"px";Q.style.width=i+"px";Q.style.height=j+"px";Q.style.marginLeft=
g+"px";Q.style.marginTop=e+"px";if(a||sa!==i){sa=i;a=D.parentNode;b=a.offsetWidth;for(c=0,d=a.childNodes.length;c<d;c++)e=a.childNodes[c],e.tagName&&e!==D&&(ka[e.id]===void 0&&e.offsetWidth>0&&(ka[e.id]=e.offsetWidth+6),b-=ka[e.id]);D.width=b-6;m(!0)}}K=Date.now()}function r(a){if(O&&(!a||!a.target||!(a.target!==a.currentTarget||a.target.classList.contains("button"))))h.getElementById("volume-controls").style.display="none",h.getElementById("settings-controls").style.display="none",h.getElementById("help-controls").style.display=
"none",h.getElementById("share-controls").style.display="none",O=!1}function q(a){var b=h.getElementById("comment-name"),c=h.getElementById("comment-email"),d=h.getElementById("comment-text"),e=h.getElementById("comment-post"),f;f=c.value;var g,i;for(g=0;g<f.length;g++)if(" \n\r\t\u000c".indexOf(f.charAt(g))<0)break;for(i=f.length-1;i>=g;i--)if(" \n\r\t\u000c".indexOf(f.charAt(i))<0)break;f=f.substring(g,i+1);b=b.value.length;f=!f.length||ya.test(f);if(a&&a.target===c)f?(h.getElementById("comment-email-invalid").style.display=
...
function l(){if(X){var a=Date.now()-K;m(a<=100);O&&a>5E3&&r();var b;if(n.paused||n.ended){if(ta!==(n.paused||n.ended))for(a=0,b=Y.length;a<b;a++)Y[a].style.opacity=1}else if(a<=5E3&&(a=ea,X)){b=0.4*Q.offsetWidth;var c=Math.max(0,1-(Date.now()-K)/5E3),d,e,f,h,i,j;for(d=0,e=Y.length;d<e;d++)h=Y[d],i=h.offsetWidth,j=h.offsetHeight,f={x:a.x,y:a.y},g(f,h),i=f.x<0?-f.x:f.x>i?f.x-i:0,f=f.y<0?-f.y:f.y>j?f.y-j:0,f=Math.sqrt(i*i+f*f),f=1-0.8*(f/b),f<0.2?f=0.2:f>1&&(f=1),h.style.opacity=c*f}ta=n.paused||n.ended;
n.duration?(a=k(n.currentTime),b=a+" / "+k(n.duration)):(a="-:--",b="-:-- / -:--");if(na.innerHTML!==b)na.innerHTML=b;if(H&&ba.innerHTML!==a)ba.innerHTML=a}oa(l,Q)}function c(){n.paused?n.play():n.ended?(n.currentTime=0,n.play()):n.pause()}function t(a){var b=h.getElementById(a+"-toggle");if(b)I[a]?(b.innerHTML=x==="de"?"ein":"On",b.classList.add("on")):(b.innerHTML=x==="de"?"aus":"Off",b.classList.remove("on"))}function u(){function a(b,c){var d=new XMLHttpRequest;d.open("GET","comments.php?"+(c?
"unflag":"flag")+"="+b,!0);d.send(null)}if(x){var b="comments.php?vtime="+(n.currentTime||0)+"&language="+x;if(ga[x]){if(Date.now()-ga[x]<5E3)return;b+="&since="+ga[x]/1E3}var c=new XMLHttpRequest;c.open("GET",b,!0);c.onreadystatechange=function(){if(c.readyState===4&&c.status===200){var b=JSON.parse(c.responseText),d,e,f;for(d=0,e=b.length;d<e;d++)if((f=b[d])&&!ha[f[0]])ha[f[0]]=f,v.videoComment({start:f[2],end:f[2]+5,id:f[0],author:f[4],text:f[5],date:f[1]*1E3,language:f[3],target:"comments",flagCallback:a})}};
c.send(null);ga[x]=Date.now()}}function o(a){!a&&F&&u();h.documentElement.setAttribute("lang",x);for(var b,c=["en","de"],a=0;a<c.length;a++)b=h.getElementById("language-"+c[a]),c[a]===x?b.classList.add("on"):b.classList.remove("on");var d,e,f,g;for(a in T)if(T.hasOwnProperty(a)){try{d=h.querySelectorAll(a)}catch(i){d=(d=h.getElementById(a.substr(1)))?[d]:[]}c=(T[a][x]||"").split("\n");for(f=0,g=d.length;f<g;f++)if((b=d[f])&&c.length&&c[0].length){for(;b.firstChild;)b.removeChild(b.firstChild);try{b.appendChild(h.createTextNode(c[0]));
for(e=1;e<c.length;e++)b.appendChild(h.createElement("br")),b.appendChild(h.createTextNode(c[e]))}catch(j){if(a==="#title")h.title=c.join(" ")}}}if(H){e=["comment-email","comment-name","comment-text"];b=[];d=[];for(a=0;a<e.length;a++)d.push(h.getElementById(e[a])),b.push(d[a].previousSibling.offsetWidth);for(a=0;a<e.length;a++)d[a].style.paddingLeft=b[a]+"px"}t("comments");t("subtitles");t("resources");v&&v.updateSubtitleLanguage&&v.updateSubtitleLanguage()}function s(){H=!0;n.pause();if(Math.abs(Z-
n.currentTime)>10)h.getElementById("comment-text").value="";var a;a=n.duration?k(n.currentTime):"-:--";if(H&&ba.innerHTML!==a)ba.innerHTML=a;h.getElementById("add-comment-controls").style.display="block";o(!0)}function p(a){if(!a.altKey&&!a.altGraphKey&&!a.metaKey&&(K=Date.now(),!H)){var b=a.keyCode||a.which;b>=65&&b<=90||b>=97&&b<=122||b>=256&&b<=658||b>=884&&b<=8191?(a.preventDefault(),s(),a=h.getElementById("comment-text"),a.value=String.fromCharCode(b),a.setSelectionRange(a.value.length,a.value.length),
a.focus(),q()):(b===32&&(c(),a.preventDefault()),K=Date.now())}}function i(){var a=new XMLHttpRequest;a.open("GET","save.php?language="+x,!0);a.send(null)}function w(a){var b;if(a!==M){F?(n.pause(),r()):(b=h.getElementById("youtube-container"),n&&n.pauseVideo&&n.pauseVideo());f.location.hash=a||"";if(M)h.getElementById(M).style.display="none";if(a){if(b)b.style.display="none";if(!M&&(h.getElementById("back-controls").style.display="block",h.getElementById("bottom-controls").style.display="none",P))P.style.display=
"block";h.getElementById(a).style.display="block";R.style.zIndex="1500";M=a}else if(M=!1,!M){R.style.zIndex="";h.getElementById("back-controls").style.display="";h.getElementById("bottom-controls").style.display="";if(P)P.style.display="";if(b)b.style.display=""}}}function B(){var a,b=new Image;b.onload=function(){da=[];var c=h.createElement("canvas");c.height=7;c.width=8;var d=c.getContext("2d");for(a=0;a<8;a++)d.clearRect(0,0,8,7),d.drawImage(b,-a,0),d.drawImage(b,8-a,0),da.push(ca.createPattern(c,
"repeat"))};b.src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAHCAYAAAA1WQxeAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAExJREFUeNpi/P//fzADA4MwAwLcAuIDUDYbE5DYDMRvkRSoAbEDlP0LpOAXPkWMQCtggmxA7ItuHRNUNQMuk5igRuFUxASlcSoCCDAA+ZwYM8U0vFEAAAAASUVORK5CYII=";var c=h.getElementsByClassName("fade");for(a=0;a<c.length;a++)Y.push(c.item(a))}function y(){function c(a){var e;a.which?e=a.which===3:a.button&&(e=a.button===2);if(e)return!1;r();d=d&&n.paused;a=b(a);g(a,D);a=(a.x-8.5)/(D.offsetWidth-
17);a>=0&&a<=1&&(a*=n.duration,v.currentTime(a));n.pause();return!0}var d=!0;a(D,c,c,function(){d||(n.play(),d=!0)})}function C(){function c(a){var d;a.which?d=a.which===3:a.button&&(d=a.button===2);if(d)return!1;a=b(a);g(a,N);a=1-(a.y-8.5)/(N.offsetHeight-17);if(a>=0&&a<=1)n.volume=a;return!0}a(N,c,c,null)}function J(){if(A>n.duration)A=n.duration;if(A)n.currentTime=A,la||n.play(),X=!0;if(ma)n.muted=!0;y();l()}function L(){var a,b,c,d,e=!1;c=f.location.pathname.split("/");c=c.concat(f.location.hash.substr(1).split("/"));
for(d=c.length-1;d>=0;d--)if(a=c[d].toLowerCase(),a==="pause"?la=!0:a==="mute"?ma=!0:!b&&(a==="about"||a==="contact"||a==="disclaimer"||a==="terms-of-use")?b=a:!e&&a&&!isNaN(a)&&a>=0&&(e=!0,A=parseFloat(a)),b&&e&&ma&&la)break;if(ia=b)P?w(ia):E.style.display="none";else if(e&&n&&n.duration>A)n.currentTime=A}function G(){return x}function z(){F=!1;A=0;h.getElementById("no-video").style.display="block";T["#intro-caption"]={en:"With the popcorn.js and HTML5 video technology on board, Europeana Remix is at the vanguard of using audiovisual heritage in engaging people with their history.",
de:"Mit dem Popcorn.js und HTML5-Video-Technologie an Bord, ist Europeana Remix an der Spitze der Nutzung von Online-Video im Dialog mit Menschen mit ihrer Geschichte."};var a=h.createElement("script");a.setAttribute("type","text/javascript");a.src="http://www.youtube.com/player_api";var b=h.createElement("div");b.id="youtube-container";b.style.display="none";E.insertBefore(b,h.getElementById("intro-text"));f.onYouTubePlayerAPIReady=function(){n=new f.YT.Player("youtube-container",{width:640,height:320,
videoId:"8uLOWsWod7c",playerVars:{origin:h.location.protocol+"//"+h.location.hostname}})};h.body.appendChild(a);h.getElementById("no-video-continue").onclick=function(){h.getElementById("intro-text").style.display="none";b.style.display=""};h.body.classList.add("no-video")}var h=f.document,wa=f.Popcorn,$=h.getElementById("background"),aa=h.getElementsByTagName("footer")[0],Q=h.getElementById("video-frame"),n=h.getElementById("video"),na=h.getElementById("play-timer"),ba=h.getElementById("add-comment-timer"),
D=h.getElementById("progress"),N=h.getElementById("volume-canvas"),ja,ca,E=h.getElementById("intro"),R=h.getElementById("eu-logo"),P,ua,va,v,A=0,la=!1,ma=!1,ya=RegExp("^[a-z0-9!#$%&'*+\\/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+\\/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+(?:[A-Z]{2}|aero|asia|biz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|pro|tel|travel|xxx)$","i"),oa=function(){return f.requestAnimationFrame||f.webkitRequestAnimationFrame||f.mozRequestAnimationFrame||f.oRequestAnimationFrame||
f.msRequestAnimationFrame||function(a){f.setTimeout(a,16)}}(),xa,ta,K=0,ga={},pa,qa,sa,ra,M,ia,O=!1,Z=-10,ea={},F=!0,I={comments:!0,resources:!0,subtitles:!0},X=!1,H=!1,fa=!1,ha={},U=[],x,T={"#title":{en:"A First World War friendship \u2013 an interactive HTML5 video by Europeana",de:"Eine Erste Weltkrieg Freundschaft - ein interaktiver HTML5 Video von Europeana"},"#about-button":{en:"About",de:"\u00fcber uns"},"#contact-button":{en:"Contact",de:"kontakt"},"#share-button":{en:"Share",de:"teilen"},
...
shareFacebook:{en:"Europeana Remix: an interactive video about an unlikely friendship in WW1",de:"Europeana Remix: ein interaktives Video \u00fcber eine ungew\u00f6hnliche Freundschaft in den 1. WK"}},ka={},Y=[],da,V=1024,W=576;(function(){L();f.addEventListener("hashchange",L,!1);if(!Modernizr||!Modernizr.video)z();else{v=wa("#video");try{ja=N.getContext("2d"),ca=D.getContext("2d")}catch(a){}n.readyState>=2?J():n.addEventListener("loadedmetadata",J,!1);if(h.body&&A>1.5)h.body.style.backgroundColor=
"#000"}d();if(A>1.5)h.body.style.backgroundColor="#000";x=h.documentElement.getAttribute("lang")||"en";o();F&&(C(),B(),n.addEventListener("play",function(){h.getElementById("play-button").classList.add("active");K=Date.now();if(!X)A<1.5&&j("bottom-controls",{opacity:{from:0,to:1}},0.5),h.getElementById("intro-play").style.display="none",n.style.display="block",X=!0},!1),n.addEventListener("pause",function(){h.getElementById("play-button").classList.remove("active");K=Date.now()},!1),n.addEventListener("ended",
function(){h.getElementById("play-button").classList.remove("active")},!1),n.addEventListener("volumechange",function(){h.getElementById("volume-button").offsetHeight&&e();n.volume<0.05?h.getElementById("volume-button").classList.add("active"):h.getElementById("volume-button").classList.remove("active");if(f.localStorage)localStorage.euRemixVolume=n.volume},!1));n.addEventListener("click",r,!1);h.getElementById("resources").addEventListener("click",r,!1);h.getElementById("bottom-controls").addEventListener("click",
r,!1);h.getElementById("top-controls").addEventListener("click",r,!1);h.getElementById("play-button").addEventListener("click",c,!1);h.addEventListener("click",function(){},!1);h.getElementById("intro-en").addEventListener("click",function(){x="en";o();i()},!1);h.getElementById("intro-de").addEventListener("click",function(){x="de";o();i()},!1);if(F)h.getElementById("comments-button").addEventListener("click",function(){I.comments=!I.comments;t("comments");I.comments?v.enable("videoComment"):v.disable("videoComment")},
!1),h.getElementById("resources-button").addEventListener("click",function(){var a,b;I.resources=!I.resources;t("resources");if(I.resources)for(a=0,b=U.length;a<b;a++)v.enable(U[a]);else for(a=0,b=U.length;a<b;a++)v.disable(U[a])},!1),h.getElementById("subtitles-button").addEventListener("click",function(){I.subtitles=!I.subtitles;t("subtitles");I.subtitles?v.enable("subtitle"):v.disable("subtitle")},!1),h.getElementById("language-en").addEventListener("click",function(){x="en";o();i()},!1),h.getElementById("language-de").addEventListener("click",
function(){x="de";o();i()},!1),h.getElementById("logo-link").addEventListener("click",function(){n.pause()},!1),h.getElementById("settings-button").addEventListener("click",function(){var a=h.getElementById("settings-controls"),b=!a.offsetHeight;r();if(b)a.style.display="block",O=!0},!1),h.getElementById("volume-button").addEventListener("click",function(){var a=h.getElementById("volume-controls"),b=!a.offsetHeight;r();if(b)a.style.display="block",e(),O=!0},!1),h.getElementById("add-comment-button").addEventListener("click",
function(){(H=!H)?s():(Z=n.currentTime,h.getElementById("add-comment-controls").style.display="none")},!1),h.getElementById("comment-tos-checkbox").addEventListener("click",function(){fa=this.checked;q()},!1),fa=h.getElementById("comment-tos-checkbox").checked,h.getElementById("comment-post").addEventListener("click",function(){if(fa){var a=new XMLHttpRequest;a.open("POST","save-comment.php",!0);var b,c=h.getElementById("comment-email").value,d=h.getElementById("comment-name").value,e=h.getElementById("comment-text").value;
f.FormData?(b=new FormData,b.append("language",x),b.append("name",d),b.append("email",c),b.append("comment",e),b.append("time",n.currentTime)):(b=["language="+encodeURIComponent(x),"name="+encodeURIComponent(d),"email="+encodeURIComponent(c),"comment="+encodeURIComponent(e),"time="+encodeURIComponent(n.currentTime)].join("&"),a.setRequestHeader("Content-type","application/x-www-form-urlencoded"),a.setRequestHeader("Content-length",b.length),a.setRequestHeader("Connection","close"));a.send(b);a.onreadystatechange=
function(){if(a.readyState===4)if(a.status===200){var b=JSON.parse(a.responseText);if(b.success){if((b=b.data)&&!ha[b[0]])ha[b[0]]=b,v.videoComment({start:b[2],end:b[2]+5,id:b[0],author:b[4],text:b[5],date:b[1]*1E3,language:b[3],target:"comments"});H=!1;Z=n.currentTime;h.getElementById("add-comment-controls").style.display="none";h.getElementById("comment-text").value=""}}else console.log("error saving comment")}}},!1),h.getElementById("end-close").addEventListener("click",function(){h.getElementById("end").style.display=
"none"},!0),h.getElementById("play-again").addEventListener("click",function(){n.currentTime=0;n.play()},!0),h.getElementById("comment-cancel").addEventListener("click",function(){H=!1;Z=n.currentTime;h.getElementById("add-comment-controls").style.display="none"},!0),h.getElementById("comment-name").addEventListener("change",q,!1),h.getElementById("comment-email").addEventListener("change",q,!1),h.getElementById("comment-text").addEventListener("change",q,!1),h.getElementById("comment-name").addEventListener("keyup",
q,!1),h.getElementById("comment-email").addEventListener("keyup",q,!1),h.getElementById("comment-text").addEventListener("keyup",q,!1);h.getElementById("about-button").addEventListener("click",function(){w("about")},!1);h.getElementById("contact-button").addEventListener("click",function(){w("contact")},!1);h.getElementById("back-button").addEventListener("click",function(){w()},!1);h.getElementById("help-button").addEventListener("click",function(){var a=h.getElementById("help-controls"),b=!a.offsetHeight;
r();if(b)a.style.display="block",O=!0},!1);h.getElementById("share-button").addEventListener("click",function(){var a=h.getElementById("share-controls"),b=!a.offsetHeight;r();if(b)a.style.display="block",O=!0},!1);h.getElementById("twitter-button").addEventListener("click",function(){var a=encodeURIComponent(f.location.protocol+"//"+f.location.host+f.location.pathname),b=encodeURIComponent(T.shareTwitter[x]);ua=f.open("http://twitter.com/share?count=none&counturl="+a+"&text="+b+"&url=","europeanasharetweet",
"left="+Math.round(screen.width/2-275)+",top="+Math.round(screen.height/2-225)+",width=550,height=450,personalbar=0,toolbar=0,scrollbars=1,resizable=1");ua.focus()},!1);h.getElementById("facebook-button").addEventListener("click",function(){var a=f.location.protocol+"//"+f.location.host+f.location.pathname,b=encodeURIComponent(T.shareFacebook[x]);va=f.open("http://facebook.com/sharer.php?u="+a+"&t="+b,"europeanasharefacebook","left="+Math.round(screen.width/2-275)+",top="+Math.round(screen.height/
2-225)+",width=550,height=450,personalbar=0,toolbar=0,scrollbars=1,resizable=1");va.focus()},!1);j("top-controls",{opacity:{from:0,to:1}},0.5);f.addEventListener("load",function(){d(!0)},!1);f.addEventListener("resize",d,!0);h.addEventListener("mousemove",function(a){K=Date.now();ea=b(a)},!1);var g=[{url:"image/page-bg.jpg",category:"display"},"image/background.jpg",{url:"css/style.css",mode:"font",id:"chevin",families:["Chevin-Light"],category:"display"},"image/bg.png","image/logo.png","image/icon_facebook.png",
"image/icon_twitter.png","image/radio.png","image/settings.png"];F&&(g=g.concat([{url:"video/otto-and-bernard.webm",element:n,id:"video",category:"play"},{url:"data/resources.txt?"+Date.now(),type:"json",category:"data",id:"resources"},{url:"data/subtitles.txt",type:"json",category:"data",id:"subtitles"},"image/playpause.png","image/check.png","image/comment.png","image/comments.png","image/volume.png","image/intro-play.png","image/media-icons.png"]));g=new Loaderator(g,"all",function(){if(!F)return!1;
if(A>1.5)j("bottom-controls",{opacity:{from:0,to:1}},0.5);else{var a=h.getElementById("intro-play");a.style.display="block";a.addEventListener("click",function(){n.play()},!1)}f.addEventListener("keypress",p,!1)});g.addEventListener("all:chevin",function(){d();A<1.5||!F?(j("intro-text",{opacity:{from:0,to:1}},1),j("intro-en",{opacity:{from:0,to:1}},1),j("intro-de",{opacity:{from:0,to:1}},1)):h.getElementById("intro-text").style.opacity=1});g.addEventListener("all:image/logo.png",function(){d();R.style.zIndex=
"1500";j(R,{opacity:{from:0,to:1}},1)});g.addEventListener("all:image/page-bg.jpg",function(a){a=a.element;a.id="page-background";P=a;E.parentNode.insertBefore(a,E.nextSibling);if(!F)E.style.display="block"});g.addEventListener("display",function(){ia&&!M&&w(ia);if(A<1.5||!F)E.style.display="block"});g.addEventListener("all:image/background.jpg",function(a){d();a=a.element;E.insertBefore(a,E.firstChild);if(F){if(A<1.5){if(j(a,{opacity:{from:0,to:1}},1,function(){n.style.display="block"}),P)E.style.display=
"block"}else n.style.display="block";var b=h.getElementById("end"),a=a.cloneNode(!1);b.insertBefore(a,b.firstChild)}});F&&(g.addEventListener("all:video",function(a){a.element.style.visibility="visible";if(f.localStorage&&localStorage.euRemixVolume!==void 0&&!isNaN(localStorage.euRemixVolume))n.volume=localStorage.euRemixVolume;var b=h.getElementById("end"),c=h.getElementById("end-text"),d=h.getElementById("end-close"),e=b.firstChild;v.code({start:"4:26",end:v.duration()-1,onStart:function(){b.style.display=
"block";d.style.display=""},onFrame:function(a,c){var d=Math.min((v.currentTime()-c.start)/1.5,1);if(b.style.opacity!==d)b.style.opacity=d},onEnd:function(a){if(v.currentTime()<a.start)b.style.display="";d.style.display="none"}});v.code({start:v.duration()-1,end:v.duration(),onStart:function(){if(!(e instanceof HTMLImageElement))e=b.firstChild;b.style.display="block";b.classList.add("final")},onFrame:function(a,d){var f=Math.min((v.currentTime()-d.start)/0.5,1);if(e.style.opacity!==f)e.style.opacity=
...
void 0||isNaN(d.fadeIn))d.fadeIn=0.5;if(d.fadeOut===void 0||isNaN(d.fadeOut))d.fadeOut=0.5;v[c](d)}g&&U.indexOf(c)===-1&&(U.push(c),I.resources||v.disable(c))}}),g.addEventListener("data:subtitles",function(a){var b=JSON.parse(a.element.responseText);if(b)for(a=0;a<b.length;a++)b[a].languagesrc=G,v.subtitle(b[a])}),u(),f.addEventListener("keyup",function(a){var b=a.which||a.keyCode;if(H){if(K=Date.now(),b===27)H=!1,Z=n.currentTime,h.getElementById("add-comment-controls").style.display="none",a.preventDefault()}else b===
37?(n.currentTime-=0.04,console.log("left",n.currentTime)):b===39&&(n.currentTime+=0.04,console.log("right",n.currentTime))},!1),v.code({start:0,end:1.5,onStart:function(){E.style.display="block";h.body.style.backgroundColor="#fff";R.style.zIndex="1500"},onFrame:function(){var a=1-Math.min(v.currentTime()/1.5,1);E.style.opacity=a;a=Math.round(a*255);h.body.style.backgroundColor="rgb("+a+", "+a+", "+a+")"},onEnd:function(){h.body.style.backgroundColor="#000";E.style.display="none";R.style.zIndex=""}}))})()})(window);
