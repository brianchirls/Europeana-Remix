...
a.left;g=document.createElement("div");g.style.position="relative";b.appendChild(g);var J=function(){l="http://api.flickr.com/services/feeds/photos_public.gne?";e&&(l+="id="+e+"&");a.tags&&(l+="tags="+a.tags+"&");l+="lang=en-us&format=json&jsoncallback=flickr";f.xhr.getJSONP(l,function(b){g.innerHTML="<p style='padding:"+o+";'>"+b.title+"<p/>";f.forEach(b.items,function(b,e){if(e<q)d=document.createElement("a"),d.setAttribute("href",b.link),d.setAttribute("target","_blank"),r=document.createElement("img"),
r.setAttribute("src",b.media.m),r.setAttribute("height",m),r.setAttribute("width",c),r.setAttribute("style","border:"+s+";padding:"+o),d.appendChild(r),g.appendChild(d),a.loaded=!0;else return!1})})},L=function(){e?setTimeout(function(){L()},5):(l="http://api.flickr.com/services/rest/?method=flickr.people.findByUsername&",l+="username="+a.username+"&api_key="+a.apikey+"&format=json&jsoncallback=flickr",f.getJSONP(l,function(a){e=a.user.nsid;J()}))},G=function(){if(p.media&&p.media.buffered){var b,
d,e=!1,i,j,k=p.media.buffered;for(b=0,d=k.length;b<d;b++)if(i=k.start(b),j=k.end(b),i>p.media.duration&&(i=0),i<=a.end&&j>=a.start){e=!0;break}if(!e){setTimeout(G,10);return}}l="http://api.flickr.com/services/rest/?method=flickr.photos.getInfo";a.apikey&&(l+="&api_key="+a.apikey);l+="&photo_id="+a.photoid+"&lang=en-us&format=json&jsoncallback=flickr";f.xhr.getJSONP(l,function(b){if(b&&b.stat==="ok"&&b.photo){var b=b.photo,d=document.createElement("img");d.src="http://farm"+b.farm+".static.flickr.com/"+
...
f.plugin("googlemap",function(d){var f,q,m,c,t=!1,u=this,o,s=!1,p,i,w,B,y,C,J;b||l();d.map=null;B=function(a){(a.keyCode||a.which)===27&&w()};p=function(a){if(k(a))return!0;var b=a.target;do if(b===m)return!0;while(b=b.parentNode);console.log("otherwindows",a);w();return!1};i=function(a){if(k(a))return!0;s=u.media.paused;u.pause();t||o();if(d.map)d.map.getDiv().style.display="block";c.removeEventListener("click",i,!1);window.addEventListener("click",p,!0);window.addEventListener("keydown",B,!0);m.classList.add("active");
m.style.cssText="";if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1};w=function(a){if(k(a))return!0;if(d.map)d.map.getDiv().style.display="none";m.classList.remove("active");m.style.width=y;if(C||J)m.style.top=C,m.style.left=J,m.style.position="absolute";c.addEventListener("click",i,!1);window.removeEventListener("keydown",B,!0);window.removeEventListener("click",p,!0);s||u.play();if(a)a.preventDefault&&a.preventDefault(),
...
"absolute",b.style.top=a.top,b.style.left=a.left;g=document.createElement("div");g.style.position="relative";b.appendChild(g);var s=function(){if(q.media&&q.media.buffered){var b,c,j=!1,m,p,k=q.media.buffered;for(b=0,c=k.length;b<c;b++)if(m=k.start(b),p=k.end(b),m>q.media.duration&&(m=0),m<=a.end&&p>=a.start){j=!0;break}if(!j){setTimeout(s,10);return}}e=document.createElement("img");e.src=a.url;e.style.width="100%";g.appendChild(e);b=document.createElement("div");b.setAttribute("class","info");c=
...
version:"0.1",author:"Brian Chirls",website:"http://chirls.com/"},options:{start:{elem:"input",type:"number",label:"In"},end:{elem:"input",type:"number",label:"Out"},url:{elem:"input",type:"text",label:"url"},target:"wikipedia-container"}})}})(window.Popcorn);(function(f){function k(a){if(!a)return!1;if(a.which)return a.which===3;if(a.button)return a.button===2}if(f){var j=0,a=!1,b=!1,g=function(){if(document.body){a=!0;var e=window.onYouTubePlayerAPIReady;window.onYouTubePlayerAPIReady=function(){b=!0;e&&e()};f.getScript("http://www.youtube.com/player_api")}else setTimeout(function(){g()},1)};f.plugin("youtube",function(e){var l,d,r,q,m,c,t,u=this,o=!1,s,p,i,w;a||g();w=function(a){var b=a.keyCode||a.which;if(b===27)i();else{if(b===32)t&&t.pauseVideo&&
(t.getPlayerState()===1?t.pauseVideo():t.getPlayerState()===2&&t.playVideo()),a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};s=function(a){if(!k(a)){var b=a.target;do if(b===l)return!0;while(b=b.parentNode);console.log(a);i();return!1}};p=function(a){if(!k(a)){o=u.media.paused;u.pause();d.removeEventListener("click",p,!1);window.addEventListener("click",s,!0);window.addEventListener("keydown",w,!0);l.classList.add("active");
l.style.cssText="";t&&t.playVideo&&t.playVideo();if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};i=function(a){if(!k(a)){t&&t.pauseVideo&&t.pauseVideo();l.classList.remove("active");l.style.width=r;if(q||m)l.style.top=q,l.style.left=m,l.style.position="absolute";d.addEventListener("click",p,!1);window.removeEventListener("keydown",w,!0);window.removeEventListener("click",s,!0);o||u.play();if(a)a.preventDefault&&a.preventDefault(),
...
d.style.position="relative";l.appendChild(d);var B=function(){if(u.media&&u.media.buffered){var a,g,j=!1,k,l,h=u.media.buffered;for(a=0,g=h.length;a<g;a++)if(k=h.start(a),l=h.end(a),k>u.media.duration&&(k=0),k<=e.end&&l>=e.start){j=!0;break}if(!j){setTimeout(B,10);return}}c="http://gdata.youtube.com/feeds/api/videos/"+e.videoid+"?v=2&alt=jsonc&callback=youtube";f.xhr.getJSONP(c,function(a){if(a&&a.data){var c=a.data;(a=e.url)||(a="http://www.youtube.com/watch?v="+c.id);var g=document.createElement("img");
...
a+'" target="_new">YouTube</a></span></div><div><a href="'+a+'" target="_new">'+c.title+'</a></div><div class="watch">watch video</div>';d.appendChild(f);a=document.createElement("span");a.innerHTML="minimize window";a.setAttribute("class","minimize");a.addEventListener("click",i,!1);d.appendChild(a);h();r=e.width;q=e.top;m=e.left;g.addEventListener("load",function(){var a=/(\d*(\.\d*)?)\s*(px|em|\%|em|rem)?/,b,c,f;c=g.width||g.naturalWidth;f=g.height||g.naturalHeight;if(e.width&&!e.height&&(b=a.exec(e.width))&&
...
var d=c.createLinearGradient(0,0,0,7);d.addColorStop(0,"rgba(112, 112, 112, 0.38)");d.addColorStop(1,"rgba(241, 241, 241, 0.38)");c.strokeStyle=d;c.beginPath();c.moveTo(8.5,8.5);c.lineTo(b+8.5,8.5);c.stroke();var d=[],e,f,h,i=n.buffered,j=0;if(i){for(e=0,f=i.length;e<f;e++)h=i.start(e),h>n.duration&&(h=0),h!==j&&d.push({start:j,end:h}),j=i.end(e);j!==n.duration&&d.push({start:j,end:n.duration})}if(Z){e=j===n.duration?0:Math.floor(Date.now()/40)%8;c.strokeStyle=Z[e];for(e=0,f=d.length;e<f;e++)j=d[e].start/
...
150)&&aa)?e.classList.remove("disabled"):e.classList.add("disabled");return b}function m(){if(U){var a=Date.now()-K;l(a<=100);P&&a>5E3&&r();var b;if(n.paused||n.ended){if(qa!==(n.paused||n.ended))for(a=0,b=V.length;a<b;a++)V[a].style.opacity=1}else if(a<=5E3&&(a=$,U)){b=0.4*ka.offsetWidth;var c=Math.max(0,1-(Date.now()-K)/5E3),d,e,f,h,i,j;for(d=0,e=V.length;d<e;d++)h=V[d],i=h.offsetWidth,j=h.offsetHeight,f={x:a.x,y:a.y},g(f,h),i=f.x<0?-f.x:f.x>i?f.x-i:0,f=f.y<0?-f.y:f.y>j?f.y-j:0,f=Math.sqrt(i*i+
...
t("resources");v&&v.updateSubtitleLanguage&&v.updateSubtitleLanguage()}function s(){H=!0;n.pause();if(Math.abs(W-n.currentTime)>10)h.getElementById("comment-text").value="";var a;a=n.duration?k(n.currentTime):"-:--";if(H&&X.innerHTML!==a)X.innerHTML=a;h.getElementById("add-comment-controls").style.display="block";o(!0)}function p(a){if(!a.altKey&&!a.altGraphKey&&!a.metaKey&&(K=Date.now(),!H)){var b=a.keyCode||a.which;b>=65&&b<=90||b>=97&&b<=122||b>=256&&b<=658||b>=884&&b<=8191?(a.preventDefault(),
...
a.which?e=a.which===3:a.button&&(e=a.button===2);if(e)return!1;r();d=d&&n.paused;a=b(a);g(a,D);a=(a.x-8.5)/(D.offsetWidth-17);a>=0&&a<=1&&(a*=n.duration,v.currentTime(a));n.pause();return!0}var d=!0;a(D,c,c,function(){d||(n.play(),d=!0)})}function C(){function c(a){var d;a.which?d=a.which===3:a.button&&(d=a.button===2);if(d)return!1;a=b(a);g(a,N);a=1-(a.y-8.5)/(N.offsetHeight-17);if(a>=0&&a<=1)n.volume=a;return!0}a(N,c,c,null)}function J(){if(A>n.duration)A=n.duration;if(A)n.currentTime=A,ia||n.play(),
U=!0;if(ja)n.muted=!0;y();m()}function L(){var a,b,c,d,e=!1;c=f.location.pathname.split("/");c=c.concat(f.location.hash.substr(1).split("/"));for(d=c.length-1;d>=0;d--)if(a=c[d].toLowerCase(),a==="pause"?ia=!0:a==="mute"?ja=!0:!b&&(a==="about"||a==="contact"||a==="disclaimer"||a==="terms-of-use")?b=a:!e&&a&&!isNaN(a)&&a>=0&&(e=!0,A=parseFloat(a)),b&&e&&ja&&ia)break;if(da=b)O?w(da):E.style.display="none";else if(e&&n&&n.duration>A)n.currentTime=A}function G(){return x}function z(){F=!1;A=0;h.getElementById("no-video").style.display=
"block";S["#intro-caption"]={en:"With the popcorn.js and HTML5 video technology on board, Europeana Remix is at the vanguard of using audiovisual heritage in engaging people with their history.",de:"Mit dem Popcorn.js und HTML5-Video-Technologie an Bord, ist Europeana Remix an der Spitze der Nutzung von Online-Video im Dialog mit Menschen mit ihrer Geschichte."};var a=h.createElement("script");a.setAttribute("type","text/javascript");a.src="http://www.youtube.com/player_api";var b=h.createElement("div");
b.id="youtube-container";b.style.display="none";E.insertBefore(b,h.getElementById("intro-text"));f.onYouTubePlayerAPIReady=function(){n=new f.YT.Player("youtube-container",{width:640,height:320,videoId:"8uLOWsWod7c",playerVars:{origin:h.location.protocol+"//"+h.location.hostname}})};h.body.appendChild(a);h.getElementById("no-video-continue").onclick=function(){h.getElementById("intro-text").style.display="none";b.style.display=""};h.body.classList.add("no-video")}var h=f.document,ta=f.Popcorn;h.getElementById("background");
var ua=h.getElementsByTagName("footer")[0],ka=h.getElementById("video-frame"),n=h.getElementById("video"),la=h.getElementById("play-timer"),X=h.getElementById("add-comment-timer"),D=h.getElementById("progress"),N=h.getElementById("volume-canvas"),ea,Y,E=h.getElementById("intro"),Q=h.getElementById("eu-logo"),O,ra,sa,v,A=0,ia=!1,ja=!1,wa=RegExp("^[a-z0-9!#$%&'*+\\/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+\\/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+(?:[A-Z]{2}|aero|asia|biz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|pro|tel|travel|xxx)$",
...
function(){var a=h.getElementById("settings-controls"),b=!a.offsetHeight;r();if(b)a.style.display="block",P=!0},!1),h.getElementById("volume-button").addEventListener("click",function(){var a=h.getElementById("volume-controls"),b=!a.offsetHeight;r();if(b)a.style.display="block",e(),P=!0},!1),h.getElementById("add-comment-button").addEventListener("click",function(){(H=!H)?s():(W=n.currentTime,h.getElementById("add-comment-controls").style.display="none")},!1),h.getElementById("comment-tos-checkbox").addEventListener("click",
...
q,!1);h.getElementById("about-button").addEventListener("click",function(){w("about")},!1);h.getElementById("contact-button").addEventListener("click",function(){w("contact")},!1);h.getElementById("back-button").addEventListener("click",function(){w()},!1);h.getElementById("help-button").addEventListener("click",function(){var a=h.getElementById("help-controls"),b=!a.offsetHeight;r();if(b)a.style.display="block",P=!0},!1);h.getElementById("share-button").addEventListener("click",function(){var a=
h.getElementById("share-controls"),b=!a.offsetHeight;r();if(b)a.style.display="block",P=!0},!1);h.getElementById("twitter-button").addEventListener("click",function(){var a=encodeURIComponent(f.location.protocol+"//"+f.location.host+f.location.pathname),b=encodeURIComponent(S.shareTwitter[x]);ra=f.open("http://twitter.com/share?count=none&counturl="+a+"&text="+b+"&url=","europeanasharetweet","left="+Math.round(screen.width/2-275)+",top="+Math.round(screen.height/2-225)+",width=550,height=450,personalbar=0,toolbar=0,scrollbars=1,resizable=1");
...
"image/radio.png","image/settings.png"];F&&(g=g.concat([{url:"video/otto-and-bernard.webm",element:n,id:"video",category:"play"},{url:"data/resources.txt?"+Date.now(),type:"json",category:"data",id:"resources"},{url:"data/subtitles.txt",type:"json",category:"data",id:"subtitles"},"image/playpause.png","image/check.png","image/comment.png","image/comments.png","image/volume.png","image/intro-play.png","image/media-icons.png"]));g=new Loaderator(g,"all",function(){if(!F)return!1;if(A>1.5)j("bottom-controls",
...
1});g.addEventListener("all:image/logo.png",function(){d();Q.style.zIndex="1500";j(Q,{opacity:{from:0,to:1}},1)});g.addEventListener("all:image/page-bg.jpg",function(a){a=a.element;a.id="page-background";O=a;E.parentNode.insertBefore(a,E.nextSibling);if(!F)E.style.display="block"});g.addEventListener("display",function(){da&&!M&&w(da);if(A<1.5||!F)E.style.display="block"});g.addEventListener("all:image/background.jpg",function(a){d();a=a.element;E.insertBefore(a,E.firstChild);if(F){if(A<1.5){if(j(a,
