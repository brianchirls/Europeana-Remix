(function(f,k){function j(r,a,m){this.categories={};this.resources={};this.eventListeners=[];this.loadingCount=0;this.callbackQueue=[];this._head=b.getElementsByTagName("head")[0];r&&this.load(r,a,m)}var a,b=f.document,g=f.console;g===k&&(g={log:function(){}});var e=/^(([A-Za-z]+):\/\/)+(([a-zA-Z0-9\._\-]+\.[a-zA-Z]{2,6})|([0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3})|localhost)(\:([0-9]+))*(\/[^#]*)?(\#.*)?$/;if(!Array.prototype.indexOf)Array.prototype.indexOf=function(r){if(this===void 0||this===
...
"//ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",id:"webfont-script",type:"script",mode:"script"},"webfont");a.addEventListener("webfont",function(){var a,c=d.families.concat([]),j,f,p=!1,s=[],o=b.getElementsByTagName("link");for(a=0,j=o.length;a<j;a++)if(f=o.item(a),f.getAttribute("rel").toLowerCase()==="stylesheet"&&(f=f.href,f===d.fullUrl)){p=!0;break}p||s.push(d.fullUrl);WebFont.load({custom:{families:d.families,urls:s},fontactive:function(p){for(a=0;a<c.length;a++)if(c[a]===p){c.splice(a,
...
g,h[i.startIndex]),h[i.startIndex]._natives.frame&&o.push(h[i.startIndex]);i.startIndex++}else{c.removeTrackEvent(a,h[i.startIndex]._id);return}for(;s<o.length;)o[s]._running==!1?o.splice(s,1):(o[s]._natives.frame.call(a,g,o[s],b),s++)}else if(d>b){for(;h[i.startIndex]&&h[i.startIndex].start>b;)if(!h[i.startIndex]._natives||a[h[i.startIndex]._natives.type]){if(h[i.startIndex]._running===!0)h[i.startIndex]._running=!1,h[i.startIndex]._natives.end.call(a,g,h[i.startIndex]);i.startIndex--}else{c.removeTrackEvent(a,
h[i.startIndex]._id);return}for(;e[i.endIndex]&&e[i.endIndex].end>b;)if(!e[i.endIndex]._natives||a[e[i.endIndex]._natives.type]){if(e[i.endIndex].start<=b&&e[i.endIndex]._running===!1&&a.data.disabled.indexOf(h[i.endIndex]._natives.type)===-1)e[i.endIndex]._running=!0,e[i.endIndex]._natives.start.call(a,g,e[i.endIndex]),e[i.endIndex]._natives.frame&&o.push(e[i.endIndex]);i.endIndex--}else{c.removeTrackEvent(a,e[i.endIndex]._id);return}for(;s<o.length;)o[s]._running==!1?o.splice(s,1):(o[s]._natives.frame.call(a,
g,o[s],b),s++)}i.previousUpdateTime=b;m(p)};m(p)}else f.setTimeout(function(){e(a)},1)};e(this);return this}}};c.p.init.prototype=c.p;c.forEach=function(a,c,d){if(!a||!c)return{};d=d||this;if(b&&a.forEach===b)return a.forEach(c,d);for(var i in a)e.call(a,i)&&c.call(d,a[i],i,a);return a};c.extend=function(a){var b=a,d=g.call(arguments,1);c.forEach(d,function(a){for(var c in a)b[c]=a[c]});return b};c.extend(c,{error:function(a){throw Error(a);},guid:function(a){c.guid.counter++;return(a?a:"")+(+new Date+
...
"function"||typeof b!=="string")){var i={};i[a]=function(a,i){if(!a)return this;var g=this;c.xhr({url:a,dataType:b,success:function(a){var b,c,j=0,a=d(a).data||[];if(b=a.length){for(;j<b;j++){c=a[j];for(var f in c)if(e.call(c,f)&&g[f])g[f](c[f])}i&&i()}}});return this};c.extend(c.p,i);return i}};var t=/\?/,u={url:"",data:"",dataType:"",success:c.nop,type:"GET",async:!0,xhr:function(){return new f.XMLHttpRequest}};c.xhr=function(a){a.dataType=a.dataType&&a.dataType.toLowerCase()||null;if(a.dataType&&
...
json:c};a.dataType&&(b=b[a.dataType]);a.success.call(a.ajax,b)}};return b};c.xhr.getJSONP=function(a,b,d){if(d&&k.querySelectorAll('script[src="'+a+'"]').length)b&&b(!0);else{var e=k.head||k.getElementsByTagName("head")[0]||k.documentElement,g=k.createElement("script"),j=a.split("?")[1],f=!1,l=[],m,r;j&&!d&&(l=j.split("&"));l.length&&(r=l[l.length-1].split("="));m=l.length?r[1]?r[1]:r[0]:"jsonp";!j&&!d&&(a+="?callback="+m);m&&!d&&(window[m]&&(m=c.guid(m)),window[m]=function(a){b&&b(a);f=!0},a=a.replace(r.join("="),
r[0]+"="+m));g.onload=g.onreadystatechange=function(){if(!g.readyState||/loaded|complete/.test(g.readyState))d&&b&&b(),f&&(delete window[m],e.removeChild(g))};g.src=a;e.insertBefore(g,e.firstChild)}};c.getJSONP=c.xhr.getJSONP;c.getScript=c.xhr.getScript=function(a,b){return c.xhr.getJSONP(a,b,!0)};c.util={toSeconds:function(a,b){var d=/^([0-9]+:){0,2}[0-9]+([.;][0-9]+)?$/;if(typeof a==="number")return a;else typeof a==="string"?d.test(a)||c.error("Invalid time format"):c.error("Invalid time format");
...
type:"text",label:"Height"},width:{elem:"input",type:"text",label:"Width"},padding:{elem:"input",type:"text",label:"Padding"},border:{elem:"input",type:"text",label:"Border"},numberofimages:{elem:"input",type:"text",label:"Number of Images"}}})}})(window.Popcorn);(function(f){function k(a){if(!a)return!1;if(a.which)return a.which===3;if(a.button)return a.button===2}if(f){var j=0;f.plugin("flickr",function(a){var b,g,e,l,d,r,q=a.numberofimages||4,m,c,t,u,p=a.padding||"5px",s=a.border||"0px",o=this,i=!1,w,B,y,C;C=function(a){(a.keyCode||a.which)===27&&y()};w=function(a){if(!k(a)){a=a.target;do if(a===b)return!0;while(a=a.parentNode);y();return!1}};B=function(a){if(!k(a)){i=o.media.paused;o.pause();g.removeEventListener("click",B,!1);window.addEventListener("click",
w,!0);window.addEventListener("keydown",C,!0);b.classList.add("active");b.style.cssText="";if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};y=function(a){if(!k(a)){b.classList.remove("active");b.style.width=c;if(t||u)b.style.top=t,b.style.left=u,b.style.position="absolute";g.addEventListener("click",B,!1);window.removeEventListener("keydown",C,!0);window.removeEventListener("click",w,!0);i||o.play();if(a)a.preventDefault&&
...
r.setAttribute("src",b.media.m),r.setAttribute("height",m),r.setAttribute("width",c),r.setAttribute("style","border:"+s+";padding:"+p),d.appendChild(r),g.appendChild(d),a.loaded=!0;else return!1})})},M=function(){e?setTimeout(function(){M()},5):(l="http://api.flickr.com/services/rest/?method=flickr.people.findByUsername&",l+="username="+a.username+"&api_key="+a.apikey+"&format=json&jsoncallback=flickr",f.getJSONP(l,function(a){e=a.user.nsid;K()}))},G=function(){if(o.media&&o.media.buffered&&o.media.buffered.length){var b,
d,e=!1,i,j,k=o.media.buffered;for(b=0,d=k.length;b<d;b++)if(i=k.start(b),j=k.end(b),i>o.media.duration&&(i=0),i<=a.end&&j>=a.start){e=!0;break}if(!e){setTimeout(G,10);return}}l="http://api.flickr.com/services/rest/?method=flickr.photos.getInfo";a.apikey&&(l+="&api_key="+a.apikey);l+="&photo_id="+a.photoid+"&lang=en-us&format=json&jsoncallback=flickr";f.xhr.getJSONP(l,function(b){if(b&&b.stat==="ok"&&b.photo){var b=b.photo,d=document.createElement("img");d.src="http://farm"+b.farm+".static.flickr.com/"+
...
m=c*h/e+b,!d.width)d.style.height=100*h/e+"%";a.loaded=!0},!1);g.addEventListener("click",B,!1)}})};if(a.url&&!a.photoid){var z=/^((https?:\/\/)?(www\.)?flickr\.com\/photos\/[^\/]+\/)?(\d+)/.exec(a.url);if(z&&z.length>=5)a.photoid=z[4]}a.photoid?G():a.username&&a.apikey?M():(e=a.userid,K());z=a.end-a.start;if(isNaN(a.fadeIn))a.fadeIn=Math.min(0.25,z/8);else if(a.fadeIn>z)a.fadeIn=z;z-=a.fadeIn;if(isNaN(a.fadeOut))a.fadeOut=Math.min(0.25,(a.end-a.start)/8);else if(a.fadeOut>z)a.fadeIn=z;return{start:function(a,
...
f.plugin("googlemap",function(d){var f,q,m,c,t=!1,u=this,p,s=!1,o,i,w,B,y,C,K;b||l();d.map=null;B=function(a){(a.keyCode||a.which)===27&&w()};o=function(a){if(k(a))return!0;var b=a.target;do if(b===m)return!0;while(b=b.parentNode);console.log("otherwindows",a);w();return!1};i=function(a){if(k(a))return!0;s=u.media.paused;u.pause();t||p();if(d.map)d.map.getDiv().style.display="block";c.removeEventListener("click",i,!1);window.addEventListener("click",o,!0);window.addEventListener("keydown",B,!0);m.classList.add("active");
m.style.cssText="";if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1};w=function(a){if(k(a))return!0;if(d.map)d.map.getDiv().style.display="none";m.classList.remove("active");m.style.width=y;if(C||K)m.style.top=C,m.style.left=K,m.style.position="absolute";c.addEventListener("click",i,!1);window.removeEventListener("keydown",B,!0);window.removeEventListener("click",o,!0);s||u.play();if(a)a.preventDefault&&a.preventDefault(),
...
c=document.createElement("div");c.style.position="relative";m.appendChild(c);var M=function(){if(u.media&&u.media.buffered&&u.media.buffered.length){var a,b,e=!1,g,j,m=u.media.buffered;for(a=0,b=m.length;a<b;a++)if(g=m.start(a),j=m.end(a),g>u.media.duration&&(g=0),g<=d.end&&j>=d.start){e=!0;break}if(!e){setTimeout(M,10);return}}a="http://maps.googleapis.com/maps/api/staticmap?sensor=false&size=320x320&maptype=roadmap&"+[["center",d.center||d.location],["markers",d.location],["visible",d.location+
"|"+d.center]].map(function(a){return a[0]+"="+encodeURIComponent(a[1])}).join("&");var o=document.createElement("img");o.src=a;o.style.width="100%";c.appendChild(o);c.appendChild(f);b=document.createElement("div");b.setAttribute("class","info");b.innerHTML='<div class="media"><span class="hiding minimize" style="float: right; margin-right: 20px;">minimize window</span>map<span class="hiding"> | <span class="popcorn-source">source</span>: <a href="'+a+'" target="_new">Google Maps</a></span></div><div><a href="'+
a+'" target="_new">'+d.location+'</a></div><div class="watch">view map</div>';b.getElementsByClassName("minimize").item(0).addEventListener("click",w,!1);c.appendChild(b);y=d.width;C=d.top;K=d.left;o.addEventListener("load",function(){var a=/(\d*(\.\d*)?)\s*(px|em|\%|em|rem)?/,b;if(d.width&&!d.height&&(b=a.exec(d.width))&&b.length>1)a=b[3]||"",b=parseFloat(b[1]),b=b*o.height/o.width,c.style.height=b+a;d.loaded=!0},!1);c.addEventListener("click",i,!1)},G=d.end-d.start;if(isNaN(d.fadeIn))d.fadeIn=Math.min(0.25,
...
map:d.map,title:d.location})):setTimeout(function(){p()},5)};M();return{start:function(a,b){var c=function(){if(!(u.media.currentTime>=b.end||u.media.currentTime<b.start))b.loaded?m.style.display="":setTimeout(c,1)};c();var d=this,e=function(){if(b.map){b.map.getDiv().style.display="block";google.maps.event.trigger(b.map,"resize");b.map.setCenter(q);if(b.zoom&&typeof b.zoom!=="number")b.zoom=+b.zoom;b.zoom=b.zoom||8;b.map.setZoom(b.zoom);if(b.heading&&typeof b.heading!=="number")b.heading=+b.heading;
if(b.pitch&&typeof b.pitch!=="number")b.pitch=+b.pitch}else d.media.currentTime>=b.start&&d.media.currentTime<=b.end&&setTimeout(function(){e()},13)};e()},end:function(a,b){m.style.display="none";if(b.map)b.map.getDiv().style.display="none"},_teardown:function(a){document.getElementById(a.target).removeChild(m);m=c=f=a.map=q=null},frame:function(a,b,c){var a=c-b.start,d=1;a<b.fadeIn?d=a/b.fadeIn:c>b.end-b.fadeOut&&(d=(b.end-c)/b.fadeOut);m.style.opacity=d}}},{about:{name:"Popcorn Google Map Plugin",
...
"absolute",b.style.top=a.top,b.style.left=a.left;g=document.createElement("div");g.style.position="relative";b.appendChild(g);var s=function(){if(q.media&&q.media.buffered&&q.media.buffered.length){var b,c,j=!1,o,m,k=q.media.buffered;for(b=0,c=k.length;b<c;b++)if(o=k.start(b),m=k.end(b),o>q.media.duration&&(o=0),o<=a.end&&m>=a.start){j=!0;break}if(!j){setTimeout(s,10);return}}e=document.createElement("img");e.src=a.url;e.style.width="100%";g.appendChild(e);b=document.createElement("div");b.setAttribute("class",
"info");c=a.source||"Image";j=a.title;a.link&&(j='<a href="'+a.link+'" target="_new">'+j+"</a>",c='<a href="'+a.link+'" target="_new">'+c+"</a>");b.innerHTML='<div class="media"><span class="hiding minimize" style="float: right; margin-right: 20px;">minimize window</span>image<span class="hiding"> | <span class="popcorn-source">source</span>: '+c+"</span></div><div>"+j+'</div><div class="watch">view image</div>';b.getElementsByClassName("minimize").item(0).addEventListener("click",u,!1);g.appendChild(b);
f=a.width;d=a.top;r=a.left;e.addEventListener("load",function(){var b=/(\d*(\.\d*)?)\s*(px|em|\%|em|rem)?/,c,d,f;d=e.width||e.naturalWidth;f=e.height||e.naturalHeight;if(a.width&&!a.height&&(c=b.exec(a.width))&&c.length>1)if(b=c[3]||"",c=parseFloat(c[1]),c=c*e.height/e.width,g.style.height=c+b,!e.width)e.style.height=100*f/d+"%";a.loaded=!0},!1);g.addEventListener("click",t,!1)},o=a.end-a.start;if(isNaN(a.fadeIn))a.fadeIn=Math.min(0.25,o/8);else if(a.fadeIn>o)a.fadeIn=o;o-=a.fadeIn;if(isNaN(a.fadeOut))a.fadeOut=
Math.min(0.25,(a.end-a.start)/8);else if(a.fadeOut>o)a.fadeIn=o;s();return{start:function(a,c){var d=function(){c.loaded?b.style.display="":setTimeout(d,1)};d()},end:function(){b.style.display="none"},_teardown:function(a){(a=document.getElementById(a.target))&&a.removeChild(b)},frame:function(a,c,d){var a=d-c.start,e=1;a<c.fadeIn?e=a/c.fadeIn:d>c.end-c.fadeOut&&(e=(c.end-d)/c.fadeOut);b.style.opacity=e}}}},{about:{name:"Popcorn Image Plugin",version:"0.1",author:"Brian Chirls",website:"http://chirls.com/"},
...
version:"0.1",author:"Brian Chirls",website:"http://chirls.com/"},options:{start:{elem:"input",type:"number",label:"In"},end:{elem:"input",type:"number",label:"Out"},url:{elem:"input",type:"text",label:"url"},target:"wikipedia-container"}})}})(window.Popcorn);(function(f){function k(a){if(!a)return!1;if(a.which)return a.which===3;if(a.button)return a.button===2}if(f){var j=0,a=!1,b=!1,g=function(){if(document.body){a=!0;var e=window.onYouTubePlayerAPIReady;window.onYouTubePlayerAPIReady=function(){b=!0;e&&e()};f.getScript("http://www.youtube.com/player_api")}else setTimeout(function(){g()},1)};f.plugin("youtube",function(e){var l,d,r,q,m,c,t,u=this,p=!1,s,o,i,w;a||g();w=function(a){var b=a.keyCode||a.which;if(b===27)i();else{if(b===32)t&&t.pauseVideo&&
(t.getPlayerState()===1?t.pauseVideo():t.getPlayerState()===2&&t.playVideo()),a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};s=function(a){if(!k(a)){var b=a.target;do if(b===l)return!0;while(b=b.parentNode);console.log(a);i();return!1}};o=function(a){if(!k(a)){p=u.media.paused;u.pause();d.removeEventListener("click",o,!1);window.addEventListener("click",s,!0);window.addEventListener("keydown",w,!0);l.classList.add("active");
l.style.cssText="";t&&t.playVideo&&t.playVideo();if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};i=function(a){if(!k(a)){t&&t.pauseVideo&&t.pauseVideo();l.classList.remove("active");l.style.width=r;if(q||m)l.style.top=q,l.style.left=m,l.style.position="absolute";d.addEventListener("click",o,!1);window.removeEventListener("keydown",w,!0);window.removeEventListener("click",s,!0);p||u.play();if(a)a.preventDefault&&a.preventDefault(),
...
d.style.position="relative";l.appendChild(d);var B=function(){if(u.media&&u.media.buffered&&u.media.buffered.length){var a,g,j=!1,l,k,h=u.media.buffered;for(a=0,g=h.length;a<g;a++)if(l=h.start(a),k=h.end(a),l>u.media.duration&&(l=0),l<=e.end&&k>=e.start){j=!0;break}if(!j){setTimeout(B,10);return}}c="http://gdata.youtube.com/feeds/api/videos/"+e.videoid+"?v=2&alt=jsonc&callback=youtube";f.xhr.getJSONP(c,function(a){if(a&&a.data){var c=a.data;(a=e.url)||(a="http://www.youtube.com/watch?v="+c.id);var f=
...
'<div class="media">video<span class="hiding"> | <span class="popcorn-source">source</span>: <a href="'+a+'" target="_new">YouTube</a></span></div><div><a href="'+a+'" target="_new">'+c.title+'</a></div><div class="watch">watch video</div>';d.appendChild(g);a=document.createElement("span");a.innerHTML="minimize window";a.setAttribute("class","minimize");a.addEventListener("click",i,!1);d.appendChild(a);h();r=e.width;q=e.top;m=e.left;f.addEventListener("load",function(){var a=/(\d*(\.\d*)?)\s*(px|em|\%|em|rem)?/,
b,c,g;c=f.width||f.naturalWidth;g=f.height||f.naturalHeight;if(e.width&&!e.height&&(b=a.exec(e.width))&&b.length>1)if(a=b[3]||"",b=parseFloat(b[1]),b=b*f.height/f.width,d.style.height=b+a,!f.width)f.style.height=100*g/c+"%";e.loaded=!0},!1);d.addEventListener("click",o,!1)}})};if(e.url&&!e.videoid){var y=/^(https?:\/\/)?(www\.)?(youtube\.com\/watch\?v=|youtu\.be\/)([A-Za-z0-9_\-]*)/i.exec(e.url);if(y&&y.length>=5)e.videoid=y[4]}y=e.end-e.start;if(isNaN(e.fadeIn))e.fadeIn=Math.min(0.25,y/8);else if(e.fadeIn>
y)e.fadeIn=y;y-=e.fadeIn;if(isNaN(e.fadeOut))e.fadeOut=Math.min(0.25,(e.end-e.start)/8);else if(e.fadeOut>y)e.fadeIn=y;e.videoid&&B();return{start:function(a,b){var c=function(){b.loaded?l.style.display="":setTimeout(c,1)};c()},end:function(){l.style.display="none";i()},_teardown:function(a){i();(a=document.getElementById(a.target))&&a.removeChild(l)},frame:function(a,b,c){if(b.loaded){var a=c-b.start,d=1;a<b.fadeIn?d=a/b.fadeIn:c>b.end-b.fadeOut&&(d=(b.end-c)/b.fadeOut);l.style.opacity=d}}}},{about:{name:"Popcorn YouTube Plugin",
...
label:"Bottom position"},right:{elem:"input",type:"number",label:"Right position"}}})}})(window.Popcorn);(function(f){function k(a){var a=Math.floor(a),b=a%60,a=(a-b)/60;b<10&&(b="0"+b);if(a>59){var c=Math.floor(a/60);a%=60;a<10&&(a="0"+a);return c+":"+a+":"+b}return a+":"+b}function j(a,b,c,d){var e,f,g=[],j=[],i,l,m=Date.now(),k,n;typeof a==="string"&&(a=h.getElementById(a));if(a)if(Modernizr.cssanimations){a.style.MozTransitionProperty="";a.style.webkitTransitionProperty="";a.style.oTransitionProperty="";a.style.transitionProperty="";for(e in b){f=b[e];g.push(e);if(f.from!==void 0)a.style[e]=f.from;
j.push(f.to)}i=g.join(",");setTimeout(function(){a.style.MozTransitionProperty=i;a.style.webkitTransitionProperty=i;a.style.oTransitionProperty=i;a.style.transitionProperty=i;a.style.MozTransitionDuration=c+"s";a.style.webkitTransitionDuration=c+"s";a.style.oTransitionDuration=c+"s";a.style.transitionDuration=c+"s";d&&(k=function(){d();a.removeEventListener("transitionend",k,!0);a.removeEventListener("webkitTransitionEnd",k,!0);a.removeEventListener("oTransitionEnd",k,!0)},a.addEventListener("transitionend",
k,!0),a.addEventListener("webkitTransitionEnd",k,!0),a.addEventListener("oTransitionEnd",k,!0));for(e=0;e<g.length;e++)a.style[g[e]]=j[e]},0)}else{l=/(\d*(\.\d*)?)\s*(px|em|\%|em|rem)?/;for(e in b)if(f=b[e],(i=l.exec(f.from))&&i.length>1&&i[1])g.push({prop:e,from:parseFloat(i[1]),to:parseFloat(f.to),unit:i[3]}),a.style[e]=f.from;n=function(){var b=(Date.now()-m)/1E3,e=Math.min(b/c,1),f,h,S;for(f=0,h=g.length;f<h;f++)S=g[f],a.style[S.prop]=S.from+e*(S.to-S.from)+(S.unit||"");b<c?na(n,a):d&&d()};n()}}
...
c;if(a)if(a.pageX!==void 0||a.pageY!==void 0)b=a.pageX,c=a.pageY;else if(a.clientX!==void 0||a.clientY!==void 0)b=a.clientX+h.body.scrollLeft+h.documentElement.scrollLeft,c=a.clientY+h.body.scrollTop+h.documentElement.scrollTop;return{x:b,y:c}}function g(a,b){var c=b;a.x-=b.clientLeft+b.offsetLeft;for(a.y-=b.clientTop+b.offsetTop;(c=c.offsetParent)&&c.nodeName!=="BODY";)a.x-=c.clientLeft+c.offsetLeft,a.y-=c.clientTop+c.offsetTop}function e(){if(fa){var a=O.height-17,b=a*(1-n.volume),c=fa;c.shadowOffsetX=
...
c.shadowOffsetX=1;c.shadowOffsetY=2;c.shadowBlur=5;c.shadowColor="rgba(0, 0, 0, 0.19)";c.arc(8.5,b,8.5,0,Math.PI*2,!0);c.fill();c.shadowOffsetX=0;c.shadowOffsetY=0;c.shadowBlur=0;c.beginPath();c.fillStyle="#02fdca";c.arc(8.5,b,3.5,0,Math.PI*2,!0);c.fill()}}function l(a){if(n.duration&&Z&&(a||!(wa===n.currentTime&&n.networkState>=4))){var b=D.width-17,a=b*n.currentTime/n.duration,c=Z;c.shadowOffsetX=0;c.shadowOffsetY=0;c.shadowBlur=0;c.clearRect(0,0,D.width,D.height);c.lineWidth=7;c.lineCap="round";
var d=c.createLinearGradient(0,0,0,7);d.addColorStop(0,"rgba(112, 112, 112, 0.38)");d.addColorStop(1,"rgba(241, 241, 241, 0.38)");c.strokeStyle=d;c.beginPath();c.moveTo(8.5,8.5);c.lineTo(b+8.5,8.5);c.stroke();var d=[],e,f,h,i=n.buffered,j=0;if(i){for(e=0,f=i.length;e<f;e++)h=i.start(e),h>n.duration&&(h=0),h!==j&&d.push({start:j,end:h}),j=i.end(e);j!==n.duration&&d.push({start:j,end:n.duration})}if($){e=j===n.duration?0:Math.floor(Date.now()/40)%8;c.strokeStyle=$[e];for(e=0,f=d.length;e<f;e++)j=d[e].start/
n.duration*b,h=d[e].end/n.duration*b,c.beginPath(),c.moveTo(j+8.5,8.5),c.lineTo(h+8.5,8.5),c.stroke()}a+=8.5;c.strokeStyle="rgba(0, 0, 0, 0.3)";c.beginPath();c.moveTo(8.5,8.5);c.lineTo(a,8.5);c.stroke();b={x:aa.x,y:aa.y};g(b,D);b=Math.sqrt(Math.pow(b.x-a,2)+Math.pow(b.y-8.5,2))-20;b=Math.max(0,b);if(b<100&&(b=8.5*(1-b/100),b*2>7))c.beginPath(),c.lineWidth=1,c.fillStyle="rgb(128, 128, 128)",c.shadowOffsetX=1,c.shadowOffsetY=2,c.shadowBlur=5,c.shadowColor="rgba(0, 0, 0, 0.19)",c.arc(a,8.5,b,0,Math.PI*
2,!0),c.fill(),c.shadowOffsetX=0,c.shadowOffsetY=0,c.shadowBlur=0;c.beginPath();c.fillStyle="#02fdca";c.arc(a,8.5,3.5,0,Math.PI*2,!0);c.fill()}}function d(a){var b=f.innerWidth||800,c=f.innerHeight||b*9/16;if(a||b!==oa||c!==pa||!D.width){oa=b;pa=c;var d=ga/ha/(b/c);d>1.2?(d=Math.min(1,(d-1.2)/0.25),c=Math.min(d*30,Math.max(b-640,0)*0.1),b=Math.floor(b-c*2)):(d<1/1.05?(d=Math.min(1,(1/1.05-d)/0.2),b=Math.min(d*40,Math.max(b-360,0)*0.1),b=Math.floor(c-b*2),b/=ha):b=Math.min(c/ha,b/ga),b=Math.floor(ga*
b));h.body.style.overflow=b<640?"auto":"";if(a||qa!==b){qa=b;var a=D.parentNode,b=a.offsetWidth,e;for(c=0,d=a.childNodes.length;c<d;c++)e=a.childNodes[c],e.tagName&&e!==D&&(ia[e.id]===void 0&&e.offsetWidth>0&&(ia[e.id]=e.offsetWidth+6),b-=ia[e.id]);D.width=b-6;l(!0)}}L=Date.now()}function r(a){if(Q&&(!a||!a.target||!(a.target!==a.currentTarget||a.target.classList.contains("button"))))h.getElementById("volume-controls").style.display="none",h.getElementById("settings-controls").style.display="none",
h.getElementById("help-controls").style.display="none",h.getElementById("share-controls").style.display="none",Q=!1}function q(a){var b=h.getElementById("comment-name"),c=h.getElementById("comment-email"),d=h.getElementById("comment-text"),e=h.getElementById("comment-post"),f;f=c.value;var g,i;for(g=0;g<f.length;g++)if(" \n\r\t\u000c".indexOf(f.charAt(g))<0)break;for(i=f.length-1;i>=g;i--)if(" \n\r\t\u000c".indexOf(f.charAt(i))<0)break;f=f.substring(g,i+1);b=b.value.length;f=!f.length||xa.test(f);
...
150)&&ba)?e.classList.remove("disabled"):e.classList.add("disabled");return b}function m(){if(V){var a=Date.now()-L;l(a<=100);Q&&a>5E3&&r();var b;if(n.paused||n.ended){if(ra!==(n.paused||n.ended))for(a=0,b=W.length;a<b;a++)W[a].style.opacity=1}else if(a<=5E3&&(a=aa,V)){b=0.4*la.offsetWidth;var c=Math.max(0,1-(Date.now()-L)/5E3),d,e,f,h,i,j;for(d=0,e=W.length;d<e;d++)h=W[d],i=h.offsetWidth,j=h.offsetHeight,f={x:a.x,y:a.y},g(f,h),i=f.x<0?-f.x:f.x>i?f.x-i:0,f=f.y<0?-f.y:f.y>j?f.y-j:0,f=Math.sqrt(i*i+
f*f),f=1-0.8*(f/b),f<0.2?f=0.2:f>1&&(f=1),h.style.opacity=c*f}ra=n.paused||n.ended;n.duration?(a=k(n.currentTime),b=a+" / "+k(n.duration)):(a="-:--",b="-:-- / -:--");if(ma.innerHTML!==b)ma.innerHTML=b;if(H&&Y.innerHTML!==a)Y.innerHTML=a}na(m,la)}function c(){n.paused?n.play():n.ended?(n.currentTime=0,n.play()):n.pause()}function t(a){var b=h.getElementById(a+"-toggle");if(b)I[a]?(b.innerHTML=x==="de"?"ein":"On",b.classList.add("on")):(b.innerHTML=x==="de"?"aus":"Off",b.classList.remove("on"))}function u(){function a(b,
c){var d=new XMLHttpRequest;d.open("GET","comments.php?"+(c?"unflag":"flag")+"="+b,!0);d.send(null)}if(x){var b="comments.php?vtime="+(n.currentTime||0)+"&language="+x;if(ca[x]){if(Date.now()-ca[x]<5E3)return;b+="&since="+ca[x]/1E3}var c=new XMLHttpRequest;c.open("GET",b,!0);c.onreadystatechange=function(){if(c.readyState===4&&c.status===200){var b=JSON.parse(c.responseText),d,e,f;for(d=0,e=b.length;d<e;d++)if((f=b[d])&&!da[f[0]])da[f[0]]=f,v.videoComment({start:f[2],end:f[2]+5,id:f[0],author:f[4],
text:f[5],date:f[1]*1E3,language:f[3],target:"comments",flagCallback:a})}};c.send(null);ca[x]=Date.now()}}function p(a){!a&&F&&u();h.documentElement.setAttribute("lang",x);for(var b,c=["en","de"],a=0;a<c.length;a++)b=h.getElementById("language-"+c[a]),c[a]===x?b.classList.add("on"):b.classList.remove("on");var d,e,f,g;for(a in T)if(T.hasOwnProperty(a)){try{d=h.querySelectorAll(a)}catch(i){d=(d=h.getElementById(a.substr(1)))?[d]:[]}c=(T[a][x]||"").split("\n");for(f=0,g=d.length;f<g;f++)if((b=d[f])&&
...
t("resources");v&&v.updateSubtitleLanguage&&v.updateSubtitleLanguage()}function s(){H=!0;n.pause();if(Math.abs(X-n.currentTime)>10)h.getElementById("comment-text").value="";var a;a=n.duration?k(n.currentTime):"-:--";if(H&&Y.innerHTML!==a)Y.innerHTML=a;h.getElementById("add-comment-controls").style.display="block";p(!0)}function o(a){if(!a.altKey&&!a.altGraphKey&&!a.metaKey&&(L=Date.now(),!H)){var b=a.keyCode||a.which;b>=65&&b<=90||b>=97&&b<=122||b>=256&&b<=658||b>=884&&b<=8191?(a.preventDefault(),
s(),a=h.getElementById("comment-text"),a.value=String.fromCharCode(b),a.setSelectionRange(a.value.length,a.value.length),a.focus(),q()):(b===32&&(c(),a.preventDefault()),L=Date.now())}}function i(){var a=new XMLHttpRequest;a.open("GET","save.php?language="+x,!0);a.send(null)}function w(a){var b;if(a!==N){F?(n.pause(),r()):(b=h.getElementById("youtube-container"),n&&n.pauseVideo&&n.pauseVideo());f.location.hash=a||"";if(N)h.getElementById(N).style.display="none";if(a){if(b)b.style.display="none";if(!N&&
(h.getElementById("back-controls").style.display="block",h.getElementById("bottom-controls").style.display="none",P))P.style.display="block";h.getElementById(a).style.display="block";R.style.zIndex="1500";N=a}else if(N=!1,!N){if(n.currentTime>J)R.style.zIndex="";h.getElementById("back-controls").style.display="";h.getElementById("bottom-controls").style.display="";if(P)P.style.display="";if(b)b.style.display=""}}}function B(){var a,b=new Image;b.onload=function(){$=[];var c=h.createElement("canvas");
c.height=7;c.width=8;var d=c.getContext("2d");for(a=0;a<8;a++)d.clearRect(0,0,8,7),d.drawImage(b,-a,0),d.drawImage(b,8-a,0),$.push(Z.createPattern(c,"repeat"))};b.src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAHCAYAAAA1WQxeAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAExJREFUeNpi/P//fzADA4MwAwLcAuIDUDYbE5DYDMRvkRSoAbEDlP0LpOAXPkWMQCtggmxA7ItuHRNUNQMuk5igRuFUxASlcSoCCDAA+ZwYM8U0vFEAAAAASUVORK5CYII=";var c=h.getElementsByClassName("fade");for(a=0;a<c.length;a++)W.push(c.item(a))}function y(){function c(a){var e;
a.which?e=a.which===3:a.button&&(e=a.button===2);if(e)return!1;r();d=d&&n.paused;a=b(a);g(a,D);a=(a.x-8.5)/(D.offsetWidth-17);a>=0&&a<=1&&(a*=n.duration,v.currentTime(a));n.pause();return!0}var d=!0;a(D,c,c,function(){d||(n.play(),d=!0)})}function C(){function c(a){var d;a.which?d=a.which===3:a.button&&(d=a.button===2);if(d)return!1;a=b(a);g(a,O);a=1-(a.y-8.5)/(O.offsetHeight-17);if(a>=0&&a<=1)n.volume=a;return!0}a(O,c,c,null)}function K(){if(A>n.duration)A=n.duration;if(A)n.currentTime=A,ja||n.play(),
V=!0;if(ka)n.muted=!0;y();m()}function M(){var a,b,c,d,e=!1;c=f.location.pathname.split("/");c=c.concat(f.location.hash.substr(1).split("/"));for(d=c.length-1;d>=0;d--)if(a=c[d].toLowerCase(),a==="pause"?ja=!0:a==="mute"?ka=!0:!b&&(a==="about"||a==="contact"||a==="disclaimer"||a==="terms-of-use")?b=a:!e&&a&&!isNaN(a)&&a>=0&&(e=!0,A=parseFloat(a)),b&&e&&ka&&ja)break;if(ea=b)P?w(ea):E.style.display="none";else if(e&&n&&n.duration>A)n.currentTime=A}function G(){return x}function z(){F=!1;A=0;h.getElementById("no-video").style.display=
"block";h.getElementById("intro-play").style.display="none";T["#intro-caption"]={en:"With the popcorn.js and HTML5 video technology on board, Europeana Remix is at the vanguard of using audiovisual heritage in engaging people with their history.",de:"Mit dem Popcorn.js und HTML5-Video-Technologie an Bord, ist Europeana Remix an der Spitze der Nutzung von Online-Video im Dialog mit Menschen mit ihrer Geschichte."};var a=h.createElement("script");a.setAttribute("type","text/javascript");a.src="http://www.youtube.com/player_api";
var b=h.createElement("div");b.id="youtube-container";b.style.display="none";E.insertBefore(b,h.getElementById("intro-text"));f.onYouTubePlayerAPIReady=function(){var a=navigator.userAgent.match(/iPad/i)?1:0;n=new f.YT.Player("youtube-container",{width:640,height:320,videoId:"8uLOWsWod7c",playerVars:{origin:h.location.protocol+"//"+h.location.hostname,html5:a}})};h.body.appendChild(a);h.getElementById("no-video-continue").onclick=function(){h.getElementById("intro-text").style.display="none";b.style.display=
""};h.body.classList.add("no-video")}var h=f.document,ua=f.Popcorn;h.getElementById("background");var va=h.getElementsByTagName("footer")[0],la=h.getElementById("video-frame"),n=h.getElementById("video"),ma=h.getElementById("play-timer"),Y=h.getElementById("add-comment-timer"),D=h.getElementById("progress"),O=h.getElementById("volume-canvas"),fa,Z,E=h.getElementById("intro"),R=h.getElementById("eu-logo"),P,sa,ta,v,A=0,ja=!1,ka=!1,xa=RegExp("^[a-z0-9!#$%&'*+\\/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+\\/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+(?:[A-Z]{2}|aero|asia|biz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|pro|tel|travel|xxx)$",
"i"),na=function(){return f.requestAnimationFrame||f.webkitRequestAnimationFrame||f.mozRequestAnimationFrame||f.oRequestAnimationFrame||f.msRequestAnimationFrame||function(a){f.setTimeout(a,16)}}(),wa,ra,L=0,ca={},oa,pa,qa,N,ea,Q=!1,X=-10,aa={},F=!0,I={comments:!0,resources:!0,subtitles:!0},V=!1,H=!1,ba=!1,da={},U=[],x,T={"#title":{en:"A First World War friendship \u2013 an interactive HTML5 video by Europeana",de:"Eine Erste Weltkrieg Freundschaft - ein interaktiver HTML5 Video von Europeana"},"#about-button":{en:"About",
...
J=1.5,ga=1024,ha=576;(function(){M();f.addEventListener("hashchange",M,!1);if(!Modernizr||!Modernizr.video||navigator.userAgent.match(/iPad/i)!==null)z();else{v=ua("#video");try{fa=O.getContext("2d"),Z=D.getContext("2d")}catch(a){}n.readyState>=2?K():n.addEventListener("loadedmetadata",K,!1);if(h.body&&A>J)h.body.style.backgroundColor="#000"}d();if(A>J)h.body.style.backgroundColor="#000";x=h.documentElement.getAttribute("lang")||"en";p();F&&(C(),B(),n.addEventListener("play",function(){h.getElementById("play-button").classList.add("active");
L=Date.now();if(!V)A<J&&j("bottom-controls",{opacity:{from:0,to:1}},0.5),h.getElementById("intro-play").style.display="none",n.style.display="block",V=!0},!1),n.addEventListener("pause",function(){h.getElementById("play-button").classList.remove("active");L=Date.now()},!1),n.addEventListener("ended",function(){h.getElementById("play-button").classList.remove("active")},!1),n.addEventListener("volumechange",function(){h.getElementById("volume-button").offsetHeight&&e();n.volume<0.05?h.getElementById("volume-button").classList.add("active"):
h.getElementById("volume-button").classList.remove("active");if(f.localStorage)localStorage.euRemixVolume=n.volume},!1));n.addEventListener("click",r,!1);h.getElementById("resources").addEventListener("click",r,!1);h.getElementById("bottom-controls").addEventListener("click",r,!1);h.getElementById("top-controls").addEventListener("click",r,!1);h.getElementById("play-button").addEventListener("click",c,!1);h.addEventListener("click",function(){},!1);h.getElementById("intro-en").addEventListener("click",
function(){x="en";p();i()},!1);h.getElementById("intro-de").addEventListener("click",function(){x="de";p();i()},!1);if(F)h.getElementById("comments-button").addEventListener("click",function(){I.comments=!I.comments;t("comments");I.comments?v.enable("videoComment"):v.disable("videoComment")},!1),h.getElementById("resources-button").addEventListener("click",function(){var a,b;I.resources=!I.resources;t("resources");if(I.resources)for(a=0,b=U.length;a<b;a++)v.enable(U[a]);else for(a=0,b=U.length;a<
b;a++)v.disable(U[a])},!1),h.getElementById("subtitles-button").addEventListener("click",function(){I.subtitles=!I.subtitles;t("subtitles");I.subtitles?v.enable("subtitle"):v.disable("subtitle")},!1),h.getElementById("language-en").addEventListener("click",function(){x="en";p();i()},!1),h.getElementById("language-de").addEventListener("click",function(){x="de";p();i()},!1),h.getElementById("logo-link").addEventListener("click",function(){n.pause()},!1),h.getElementById("settings-button").addEventListener("click",
function(){var a=h.getElementById("settings-controls"),b=!a.offsetHeight;r();if(b)a.style.display="block",Q=!0},!1),h.getElementById("volume-button").addEventListener("click",function(){var a=h.getElementById("volume-controls"),b=!a.offsetHeight;r();if(b)a.style.display="block",e(),Q=!0},!1),h.getElementById("add-comment-button").addEventListener("click",function(){(H=!H)?s():(X=n.currentTime,h.getElementById("add-comment-controls").style.display="none")},!1),h.getElementById("comment-tos-checkbox").addEventListener("click",
function(){ba=this.checked;q()},!1),ba=h.getElementById("comment-tos-checkbox").checked,h.getElementById("comment-post").addEventListener("click",function(){if(ba){var a=new XMLHttpRequest;a.open("POST","save-comment.php",!0);var b,c=h.getElementById("comment-email").value,d=h.getElementById("comment-name").value,e=h.getElementById("comment-text").value;f.FormData?(b=new FormData,b.append("language",x),b.append("name",d),b.append("email",c),b.append("comment",e),b.append("time",n.currentTime)):(b=
["language="+encodeURIComponent(x),"name="+encodeURIComponent(d),"email="+encodeURIComponent(c),"comment="+encodeURIComponent(e),"time="+encodeURIComponent(n.currentTime)].join("&"),a.setRequestHeader("Content-type","application/x-www-form-urlencoded"),a.setRequestHeader("Content-length",b.length),a.setRequestHeader("Connection","close"));a.send(b);a.onreadystatechange=function(){if(a.readyState===4)if(a.status===200){var b=JSON.parse(a.responseText);if(b.success){if((b=b.data)&&!da[b[0]])da[b[0]]=
...
!0),h.getElementById("comment-cancel").addEventListener("click",function(){H=!1;X=n.currentTime;h.getElementById("add-comment-controls").style.display="none"},!0),h.getElementById("comment-name").addEventListener("change",q,!1),h.getElementById("comment-email").addEventListener("change",q,!1),h.getElementById("comment-text").addEventListener("change",q,!1),h.getElementById("comment-name").addEventListener("keyup",q,!1),h.getElementById("comment-email").addEventListener("keyup",q,!1),h.getElementById("comment-text").addEventListener("keyup",
q,!1);h.getElementById("about-button").addEventListener("click",function(){w("about")},!1);h.getElementById("contact-button").addEventListener("click",function(){w("contact")},!1);h.getElementById("back-button").addEventListener("click",function(){w()},!1);h.getElementById("help-button").addEventListener("click",function(){var a=h.getElementById("help-controls"),b=!a.offsetHeight;r();if(b)a.style.display="block",Q=!0},!1);h.getElementById("share-button").addEventListener("click",function(){var a=
h.getElementById("share-controls"),b=!a.offsetHeight;r();if(b)a.style.display="block",Q=!0},!1);h.getElementById("twitter-button").addEventListener("click",function(){var a=encodeURIComponent(f.location.protocol+"//"+f.location.host+f.location.pathname),b=encodeURIComponent(T.shareTwitter[x]);sa=f.open("http://twitter.com/share?count=none&counturl="+a+"&text="+b+"&url=","europeanasharetweet","left="+Math.round(screen.width/2-275)+",top="+Math.round(screen.height/2-225)+",width=550,height=450,personalbar=0,toolbar=0,scrollbars=1,resizable=1");
sa.focus();_gaq.push(["_trackSocial","twitter","tweet","remix.europeana.eu"])},!1);h.getElementById("facebook-button").addEventListener("click",function(){var a=f.location.protocol+"//"+f.location.host+f.location.pathname,b=encodeURIComponent(T.shareFacebook[x]);ta=f.open("http://facebook.com/sharer.php?u="+a+"&t="+b,"europeanasharefacebook","left="+Math.round(screen.width/2-275)+",top="+Math.round(screen.height/2-225)+",width=550,height=450,personalbar=0,toolbar=0,scrollbars=1,resizable=1");ta.focus();
_gaq.push(["_trackSocial","facebook","send","remix.europeana.eu"])},!1);j("top-controls",{opacity:{from:0,to:1}},0.5);f.addEventListener("load",function(){d(!0)},!1);f.addEventListener("resize",d,!0);h.addEventListener("mousemove",function(a){L=Date.now();aa=b(a)},!1);var g=[{url:"image/page-bg.jpg",category:"display"},"image/background.jpg",{url:"css/style.css",mode:"font",id:"chevin",families:["Chevin-Light"],category:"display"},"image/bg.png","image/logo.png","image/icon_facebook.png","image/icon_twitter.png",
"image/radio.png","image/settings.png"];F&&(g=g.concat([{url:"video/otto-and-bernard.webm",element:n,id:"video",category:"play"},{url:"data/resources.txt?"+Date.now(),type:"json",category:"data",id:"resources"},{url:"data/subtitles.txt",type:"json",category:"data",id:"subtitles"},"image/playpause.png","image/check.png","image/comment.png","image/comments.png","image/volume.png","image/intro-play.png","image/media-icons.png"]));g=new Loaderator(g,"all",function(){if(!F)return!1;if(A>J)j("bottom-controls",
{opacity:{from:0,to:1}},0.5);else{var a=h.getElementById("intro-play");a.innerHTML='<img src="image/intro-play.png"/>';a.addEventListener("click",function(){va.innerHTML='<a href="http://www.europeana.eu" target="_blank"><img src="image/poweredby-white.png"/></a>';n.play()},!1)}f.addEventListener("keypress",o,!1)});g.addEventListener("all:chevin",function(){d();A<J||!F?(j("intro-text",{opacity:{from:0,to:1}},1),j("intro-en",{opacity:{from:0,to:1}},1),j("intro-de",{opacity:{from:0,to:1}},1)):h.getElementById("intro-text").style.opacity=
1});g.addEventListener("all:image/logo.png",function(){d();R.style.zIndex="1500";j(R,{opacity:{from:0,to:1}},1)});g.addEventListener("all:image/page-bg.jpg",function(a){a=a.element;a.id="page-background";P=a;E.parentNode.insertBefore(a,E.nextSibling);if(!F)E.style.display="block"});g.addEventListener("display",function(){ea&&!N&&w(ea);if(A<J||!F)E.style.display="block"});g.addEventListener("all:image/background.jpg",function(a){d();a=a.element;E.insertBefore(a,E.firstChild);if(F){if(A<J){if(j(a,{opacity:{from:0,
to:1}},1,function(){n.style.display="block"}),P)E.style.display="block"}else n.style.display="block";var b=h.getElementById("end"),a=a.cloneNode(!1);b.insertBefore(a,b.firstChild)}});F&&(g.addEventListener("all:video",function(a){a.element.style.visibility="visible";var b=h.getElementById("end"),c=h.getElementById("end-text"),d=h.getElementById("end-close"),e=b.firstChild;v.code({start:"4:26",end:v.duration()-1,onStart:function(){b.style.display="block";d.style.display=""},onFrame:function(a,c){var d=
Math.min((v.currentTime()-c.start)/J,1);if(b.style.opacity!==d)b.style.opacity=d},onEnd:function(a){if(v.currentTime()<a.start)b.style.display="";d.style.display="none"}});v.code({start:v.duration()-1,end:v.duration(),onStart:function(){if(!(e instanceof HTMLImageElement))e=b.firstChild;b.style.display="block";b.classList.add("final")},onFrame:function(a,d){var f=Math.min((v.currentTime()-d.start)/0.5,1);if(e.style.opacity!==f)e.style.opacity=f;if(b.style.opacity<f)b.style.opacity=f;f=1-f;c.style.backgroundColor=
"rgba(255, 255, 255, "+f*0.85+")";c.style.borderColor="rgba(0, 0, 0, "+f*0.6+")"},onEnd:function(){b.style.cssText="";b.classList.remove("final")}})}),g.addEventListener("data:resources",function(a){var b={flickr:f.flickrApiKey||""},a=JSON.parse(a.element.responseText),c,d,e,g;for(c in a)if(a.hasOwnProperty(c)&&typeof v[c]==="function"){for(e=0,g=a[c].length;e<g;e++){d=a[c][e];if(b[c])d.apikey=b[c];d.target="resources";if(d.fadeIn===void 0||isNaN(d.fadeIn))d.fadeIn=0.5;if(d.fadeOut===void 0||isNaN(d.fadeOut))d.fadeOut=
0.5;v[c](d)}g&&U.indexOf(c)===-1&&(U.push(c),I.resources||v.disable(c))}}),g.addEventListener("data:subtitles",function(a){var b=JSON.parse(a.element.responseText);if(b)for(a=0;a<b.length;a++)b[a].languagesrc=G,v.subtitle(b[a])}),u(),f.addEventListener("keyup",function(a){var b=a.which||a.keyCode;if(H){if(L=Date.now(),b===27)H=!1,X=n.currentTime,h.getElementById("add-comment-controls").style.display="none",a.preventDefault()}else b===37?(n.currentTime-=0.04,console.log("left",n.currentTime)):b===
39&&(n.currentTime+=0.04,console.log("right",n.currentTime))},!1),v.code({start:0,end:J,onStart:function(){E.style.display="block";h.body.style.backgroundColor="#fff";R.style.zIndex="1500"},onFrame:function(){var a=1-Math.min(v.currentTime()/J,1);E.style.opacity=a;a=Math.round(a*255);h.body.style.backgroundColor="rgb("+a+", "+a+", "+a+")"},onEnd:function(){h.body.style.backgroundColor="#000";E.style.display="none";R.style.zIndex=""}}))})()})(window);
