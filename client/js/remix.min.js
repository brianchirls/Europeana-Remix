...
version:"0.1",author:"Brian Chirls",website:"http://chirls.com/"},options:{start:{elem:"input",type:"number",label:"In"},end:{elem:"input",type:"number",label:"Out"},url:{elem:"input",type:"text",label:"url"},target:"wikipedia-container"}})}})(window.Popcorn);(function(f){function k(a){if(!a)return!1;if(a.which)return a.which===3;if(a.button)return a.button===2}if(f){var i=0,a=!1,b=!1,g=function(){if(document.body){a=!0;var e=window.onYouTubePlayerAPIReady;window.onYouTubePlayerAPIReady=function(){b=!0;e&&e()};f.getScript("http://www.youtube.com/player_api")}else setTimeout(function(){g()},1)};f.plugin("youtube",function(e){var l,d,r,q,o,c,t,u=this,p=!1,s,n,j,x;a||g();x=function(a){var b=a.keyCode||a.which;if(b===27)j();else{if(b===32)t&&t.pauseVideo&&
(t.getPlayerState()===1?t.pauseVideo():t.getPlayerState()===2&&t.playVideo()),a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};s=function(a){if(!k(a)){var b=a.target;do if(b===l)return!0;while(b=b.parentNode);console.log(a);j();return!1}};n=function(a){if(!k(a)){p=u.media.paused;u.pause();d.removeEventListener("click",n,!1);window.addEventListener("click",s,!0);window.addEventListener("keydown",x,!0);l.classList.add("active");
l.style.cssText="";t&&t.playVideo&&t.playVideo();if(a)a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation(),a.returnValue=!1,a.cancelBubble=!0;return!1}};j=function(a){if(!k(a)){t&&t.pauseVideo&&t.pauseVideo();l.classList.remove("active");l.style.width=r;if(q||o)l.style.top=q,l.style.left=o,l.style.position="absolute";d.addEventListener("click",n,!1);window.removeEventListener("keydown",x,!0);window.removeEventListener("click",s,!0);p||u.play();if(a)a.preventDefault&&a.preventDefault(),
...
c;if(a)if(a.pageX!==void 0||a.pageY!==void 0)b=a.pageX,c=a.pageY;else if(a.clientX!==void 0||a.clientY!==void 0)b=a.clientX+h.body.scrollLeft+h.documentElement.scrollLeft,c=a.clientY+h.body.scrollTop+h.documentElement.scrollTop;return{x:b,y:c}}function g(a,b){var c=b;a.x-=b.clientLeft+b.offsetLeft;for(a.y-=b.clientTop+b.offsetTop;(c=c.offsetParent)&&c.nodeName!=="BODY";)a.x-=c.clientLeft+c.offsetLeft,a.y-=c.clientTop+c.offsetTop}function e(){if(ga){var a=O.height-17,b=a*(1-m.volume),c=ga;c.shadowOffsetX=
...
c.shadowOffsetX=1;c.shadowOffsetY=2;c.shadowBlur=5;c.shadowColor="rgba(0, 0, 0, 0.19)";c.arc(8.5,b,8.5,0,Math.PI*2,!0);c.fill();c.shadowOffsetX=0;c.shadowOffsetY=0;c.shadowBlur=0;c.beginPath();c.fillStyle="#02fdca";c.arc(8.5,b,3.5,0,Math.PI*2,!0);c.fill()}}function l(a){if(m.duration&&$&&(a||!(wa===m.currentTime&&m.networkState>=4))){var b=D.width-17,a=b*m.currentTime/m.duration,c=$;c.shadowOffsetX=0;c.shadowOffsetY=0;c.shadowBlur=0;c.clearRect(0,0,D.width,D.height);c.lineWidth=7;c.lineCap="round";
var d=c.createLinearGradient(0,0,0,7);d.addColorStop(0,"rgba(112, 112, 112, 0.38)");d.addColorStop(1,"rgba(241, 241, 241, 0.38)");c.strokeStyle=d;c.beginPath();c.moveTo(8.5,8.5);c.lineTo(b+8.5,8.5);c.stroke();var d=[],e,f,h,i=m.buffered,j=0;if(i){for(e=0,f=i.length;e<f;e++)h=i.start(e),h>m.duration&&(h=0),h!==j&&d.push({start:j,end:h}),j=i.end(e);j!==m.duration&&d.push({start:j,end:m.duration})}if(aa){e=j===m.duration?0:Math.floor(Date.now()/40)%8;c.strokeStyle=aa[e];for(e=0,f=d.length;e<f;e++)j=
...
150)&&ca)?e.classList.remove("disabled"):e.classList.add("disabled");return b}function o(){if(V){var a=Date.now()-L;l(a<=100);Q&&a>5E3&&r();var b;if(m.paused||m.ended){if(sa!==(m.paused||m.ended))for(a=0,b=W.length;a<b;a++)W[a].style.opacity=1}else if(a<=5E3&&(a=ba,V)){b=0.4*ma.offsetWidth;var c=Math.max(0,1-(Date.now()-L)/5E3),d,e,f,h,i,j;for(d=0,e=W.length;d<e;d++)h=W[d],i=h.offsetWidth,j=h.offsetHeight,f={x:a.x,y:a.y},g(f,h),i=f.x<0?-f.x:f.x>i?f.x-i:0,f=f.y<0?-f.y:f.y>j?f.y-j:0,f=Math.sqrt(i*i+
f*f),f=1-0.8*(f/b),f<0.2?f=0.2:f>1&&(f=1),h.style.opacity=c*f}sa=m.paused||m.ended;m.duration?(a=k(m.currentTime),b=a+" / "+k(m.duration)):(a="-:--",b="-:-- / -:--");if(na.innerHTML!==b)na.innerHTML=b;if(H&&Z.innerHTML!==a)Z.innerHTML=a}oa(o,ma)}function c(){m.paused?m.play():m.ended?(m.currentTime=0,m.play()):m.pause()}function t(a){var b=h.getElementById(a+"-toggle");if(b)I[a]?(b.innerHTML=y==="de"?"ein":"On",b.classList.add("on")):(b.innerHTML=y==="de"?"aus":"Off",b.classList.remove("on"))}function u(){function a(b,
c){var d=new XMLHttpRequest;d.open("GET","comments.php?"+(c?"unflag":"flag")+"="+b,!0);d.send(null)}if(y){var b="comments.php?vtime="+(m.currentTime||0)+"&language="+y;if(da[y]){if(Date.now()-da[y]<5E3)return;b+="&since="+da[y]/1E3}var c=new XMLHttpRequest;c.open("GET",b,!0);c.onreadystatechange=function(){if(c.readyState===4&&c.status===200){var b=JSON.parse(c.responseText),d,e,f;for(d=0,e=b.length;d<e;d++)if((f=b[d])&&!ea[f[0]])ea[f[0]]=f,w.videoComment({start:f[2],end:f[2]+5,id:f[0],author:f[4],
...
t("resources");w&&w.updateSubtitleLanguage&&w.updateSubtitleLanguage()}function s(){H=!0;m.pause();if(Math.abs(X-m.currentTime)>10)h.getElementById("comment-text").value="";var a;a=m.duration?k(m.currentTime):"-:--";if(H&&Z.innerHTML!==a)Z.innerHTML=a;h.getElementById("add-comment-controls").style.display="block";p(!0)}function n(a){if(!a.altKey&&!a.altGraphKey&&!a.metaKey&&(L=Date.now(),!H)){var b=a.keyCode||a.which;b>=65&&b<=90||b>=97&&b<=122||b>=256&&b<=658||b>=884&&b<=8191?(a.preventDefault(),
s(),a=h.getElementById("comment-text"),a.value=String.fromCharCode(b),a.setSelectionRange(a.value.length,a.value.length),a.focus(),q()):(b===32&&(c(),a.preventDefault()),L=Date.now())}}function j(){var a=new XMLHttpRequest;a.open("GET","save.php?language="+y,!0);a.send(null)}function x(a){var b;if(a!==N){F?(m.pause(),r()):(b=h.getElementById("youtube-container"),m&&m.pauseVideo&&m.pauseVideo());f.location.hash=a||"";if(N)h.getElementById(N).style.display="none";if(a){if(b)b.style.display="none";if(!N&&
(h.getElementById("back-controls").style.display="block",h.getElementById("bottom-controls").style.display="none",P))P.style.display="block";h.getElementById(a).style.display="block";R.style.zIndex="1500";N=a}else if(N=!1,!N){if(b)b.style.display="";else{if(m.currentTime>J)R.style.zIndex="";h.getElementById("bottom-controls").style.display=""}h.getElementById("back-controls").style.display="";if(P)P.style.display=""}}}function B(){var a,b=new Image;b.onload=function(){aa=[];var c=h.createElement("canvas");
...
function z(){function c(a){var e;a.which?e=a.which===3:a.button&&(e=a.button===2);if(e)return!1;r();d=d&&m.paused;a=b(a);g(a,D);a=(a.x-8.5)/(D.offsetWidth-17);a>=0&&a<=1&&(a*=m.duration,w.currentTime(a));m.pause();return!0}var d=!0;a(D,c,c,function(){d||(m.play(),d=!0)})}function C(){function c(a){var d;a.which?d=a.which===3:a.button&&(d=a.button===2);if(d)return!1;a=b(a);g(a,O);a=1-(a.y-8.5)/(O.offsetHeight-17);if(a>=0&&a<=1)m.volume=a;return!0}a(O,c,c,null)}function K(){if(A>m.duration)A=m.duration;
if(A)m.currentTime=A,ka||m.play(),V=!0;if(la)m.muted=!0;z();o()}function M(){var a,b,c,d,e=!1;c=f.location.pathname.split("/");c=c.concat(f.location.hash.substr(1).split("/"));for(d=c.length-1;d>=0;d--)if(a=c[d].toLowerCase(),a==="pause"?ka=!0:a==="mute"?la=!0:!b&&(a==="about"||a==="contact"||a==="disclaimer"||a==="terms-of-use")?b=a:!e&&a&&!isNaN(a)&&a>=0&&(e=!0,A=parseFloat(a)),b&&e&&la&&ka)break;if(fa=b)P?x(fa):E.style.display="none";else if(e&&m&&m.duration>A)m.currentTime=A}function G(){return y}
function v(){F=!1;A=0;h.getElementById("no-video").style.display="block";h.getElementById("intro-play").style.display="none";T["#intro-caption"]={en:"With the popcorn.js and HTML5 video technology on board, Europeana Remix is at the vanguard of using audiovisual heritage in engaging people with their history.",de:"Mit dem Popcorn.js und HTML5-Video-Technologie an Bord, ist Europeana Remix an der Spitze der Nutzung von Online-Video im Dialog mit Menschen mit ihrer Geschichte."};var a,b=navigator.userAgent.match(/iPad/i)?
1:0,c=h.createElement("div");c.id="youtube-container";c.style.display="none";E.insertBefore(c,h.getElementById("intro-text"));b?(a=h.createElement("script"),a.setAttribute("type","text/javascript"),a.src="http://www.youtube.com/player_api",f.onYouTubePlayerAPIReady=function(){m=new f.YT.Player("youtube-container",{width:640,height:320,videoId:"8uLOWsWod7c",playerVars:{origin:h.location.protocol+"//"+h.location.hostname,html5:b}})},h.body.appendChild(a)):(a=h.createElement("iframe"),a.setAttribute("width",
640),a.setAttribute("height",320),a.setAttribute("frameborder",0),a.setAttribute("allowfullscreen",1),a.src="http://www.youtube.com/embed/8uLOWsWod7c",c.appendChild(a));h.getElementById("no-video-continue").onclick=function(){h.getElementById("intro-text").style.display="none";c.style.display=""};h.body.classList.add("no-video")}var h=f.document,Y=f.Popcorn;h.getElementById("background");var va=h.getElementsByTagName("footer")[0],ma=h.getElementById("video-frame"),m=h.getElementById("video"),na=h.getElementById("play-timer"),
Z=h.getElementById("add-comment-timer"),D=h.getElementById("progress"),O=h.getElementById("volume-canvas"),ga,$,E=h.getElementById("intro"),R=h.getElementById("eu-logo"),P,ta,ua,w,A=0,ka=!1,la=!1,xa=RegExp("^[a-z0-9!#$%&'*+\\/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+\\/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+(?:[A-Z]{2}|aero|asia|biz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|pro|tel|travel|xxx)$","i"),oa=function(){return f.requestAnimationFrame||f.webkitRequestAnimationFrame||
f.mozRequestAnimationFrame||f.oRequestAnimationFrame||f.msRequestAnimationFrame||function(a){f.setTimeout(a,16)}}(),wa,sa,L=0,da={},pa,qa,ra,N,fa,Q=!1,X=-10,ba={},F=!0,I={comments:!0,resources:!0,subtitles:!0},V=!1,H=!1,ca=!1,ea={},U=[],y,T={"#title":{en:"A First World War friendship \u2013 an interactive HTML5 video by Europeana",de:"Eine Erste Weltkrieg Freundschaft - ein interaktiver HTML5 Video von Europeana"},"#about-button":{en:"About",de:"\u00fcber uns"},"#contact-button":{en:"Contact",de:"kontakt"},
...
ja={},W=[],aa,J=1.5,ha=1024,ia=576;(function(){M();f.addEventListener("hashchange",M,!1);if(!Modernizr||!Modernizr.video||navigator.userAgent.match(/iPad/i)!==null)v();else{w=Y("#video");try{ga=O.getContext("2d"),$=D.getContext("2d")}catch(a){}m.readyState>=2?K():m.addEventListener("loadedmetadata",K,!1);if(h.body&&A>J)h.body.style.backgroundColor="#000"}d();if(A>J)h.body.style.backgroundColor="#000";y=h.documentElement.getAttribute("lang")||"en";p();F&&(C(),B(),m.addEventListener("play",function(){h.getElementById("play-button").classList.add("active");
L=Date.now();if(!V)A<J&&i("bottom-controls",{opacity:{from:0,to:1}},0.5),h.getElementById("intro-play").style.display="none",m.style.display="block",V=!0},!1),m.addEventListener("pause",function(){h.getElementById("play-button").classList.remove("active");L=Date.now()},!1),m.addEventListener("ended",function(){h.getElementById("play-button").classList.remove("active")},!1),m.addEventListener("volumechange",function(){h.getElementById("volume-button").offsetHeight&&e();m.volume<0.05?h.getElementById("volume-button").classList.add("active"):
h.getElementById("volume-button").classList.remove("active");if(f.localStorage)localStorage.euRemixVolume=m.volume},!1));m.addEventListener("click",r,!1);h.getElementById("resources").addEventListener("click",r,!1);h.getElementById("bottom-controls").addEventListener("click",r,!1);h.getElementById("top-controls").addEventListener("click",r,!1);h.getElementById("play-button").addEventListener("click",c,!1);h.addEventListener("click",function(){},!1);h.getElementById("intro-en").addEventListener("click",
function(){y="en";p();j()},!1);h.getElementById("intro-de").addEventListener("click",function(){y="de";p();j()},!1);if(F)h.getElementById("comments-button").addEventListener("click",function(){I.comments=!I.comments;t("comments");I.comments?w.enable("videoComment"):w.disable("videoComment")},!1),h.getElementById("resources-button").addEventListener("click",function(){var a,b;I.resources=!I.resources;t("resources");if(I.resources)for(a=0,b=U.length;a<b;a++)w.enable(U[a]);else for(a=0,b=U.length;a<
b;a++)w.disable(U[a])},!1),h.getElementById("subtitles-button").addEventListener("click",function(){I.subtitles=!I.subtitles;t("subtitles");I.subtitles?w.enable("subtitle"):w.disable("subtitle")},!1),h.getElementById("language-en").addEventListener("click",function(){y="en";p();j()},!1),h.getElementById("language-de").addEventListener("click",function(){y="de";p();j()},!1),h.getElementById("logo-link").addEventListener("click",function(){m.pause()},!1),h.getElementById("settings-button").addEventListener("click",
function(){var a=h.getElementById("settings-controls"),b=!a.offsetHeight;m.pause();r();if(b)a.style.display="block",Q=!0},!1),h.getElementById("volume-button").addEventListener("click",function(){var a=h.getElementById("volume-controls"),b=!a.offsetHeight;r();if(b)a.style.display="block",e(),Q=!0},!1),h.getElementById("add-comment-button").addEventListener("click",function(){(H=!H)?s():(X=m.currentTime,h.getElementById("add-comment-controls").style.display="none")},!1),h.getElementById("comment-tos-checkbox").addEventListener("click",
function(){ca=this.checked;q()},!1),ca=h.getElementById("comment-tos-checkbox").checked,h.getElementById("comment-post").addEventListener("click",function(){if(ca){var a=new XMLHttpRequest;a.open("POST","save-comment.php",!0);var b,c=h.getElementById("comment-email").value,d=h.getElementById("comment-name").value,e=h.getElementById("comment-text").value;f.FormData?(b=new FormData,b.append("language",y),b.append("name",d),b.append("email",c),b.append("comment",e),b.append("time",m.currentTime)):(b=
["language="+encodeURIComponent(y),"name="+encodeURIComponent(d),"email="+encodeURIComponent(c),"comment="+encodeURIComponent(e),"time="+encodeURIComponent(m.currentTime)].join("&"),a.setRequestHeader("Content-type","application/x-www-form-urlencoded"),a.setRequestHeader("Content-length",b.length),a.setRequestHeader("Connection","close"));a.send(b);a.onreadystatechange=function(){if(a.readyState===4)if(a.status===200){var b=JSON.parse(a.responseText);if(b.success){if((b=b.data)&&!ea[b[0]])ea[b[0]]=
b,w.videoComment({start:b[2],end:b[2]+5,id:b[0],author:b[4],text:b[5],date:b[1]*1E3,language:b[3],target:"comments"});H=!1;X=m.currentTime;h.getElementById("add-comment-controls").style.display="none";h.getElementById("comment-text").value=""}}else console.log("error saving comment")}}},!1),h.getElementById("end-close").addEventListener("click",function(){h.getElementById("end").style.display="none"},!0),h.getElementById("play-again").addEventListener("click",function(){m.currentTime=0;m.play()},
!0),h.getElementById("comment-cancel").addEventListener("click",function(){H=!1;X=m.currentTime;h.getElementById("add-comment-controls").style.display="none"},!0),h.getElementById("comment-name").addEventListener("change",q,!1),h.getElementById("comment-email").addEventListener("change",q,!1),h.getElementById("comment-text").addEventListener("change",q,!1),h.getElementById("comment-name").addEventListener("keyup",q,!1),h.getElementById("comment-email").addEventListener("keyup",q,!1),h.getElementById("comment-text").addEventListener("keyup",
q,!1);h.getElementById("about-button").addEventListener("click",function(){x("about")},!1);h.getElementById("contact-button").addEventListener("click",function(){x("contact")},!1);h.getElementById("back-button").addEventListener("click",function(){x()},!1);h.getElementById("help-button").addEventListener("click",function(){var a=h.getElementById("help-controls"),b=!a.offsetHeight;m.pause();r();if(b)a.style.display="block",Q=!0},!1);h.getElementById("share-button").addEventListener("click",function(){var a=
h.getElementById("share-controls"),b=!a.offsetHeight;m.pause();r();if(b)a.style.display="block",Q=!0},!1);h.getElementById("twitter-button").addEventListener("click",function(){var a=encodeURIComponent(f.location.protocol+"//"+f.location.host+f.location.pathname),b=encodeURIComponent(T.shareTwitter[y]);ta=f.open("http://twitter.com/share?count=none&counturl="+a+"&text="+b+"&url=","europeanasharetweet","left="+Math.round(screen.width/2-275)+",top="+Math.round(screen.height/2-225)+",width=550,height=450,personalbar=0,toolbar=0,scrollbars=1,resizable=1");
ta.focus();_gaq.push(["_trackSocial","twitter","tweet","remix.europeana.eu"])},!1);h.getElementById("facebook-button").addEventListener("click",function(){var a=f.location.protocol+"//"+f.location.host+f.location.pathname,b=encodeURIComponent(T.shareFacebook[y]);ua=f.open("http://facebook.com/sharer.php?u="+a+"&t="+b,"europeanasharefacebook","left="+Math.round(screen.width/2-275)+",top="+Math.round(screen.height/2-225)+",width=550,height=450,personalbar=0,toolbar=0,scrollbars=1,resizable=1");ua.focus();
_gaq.push(["_trackSocial","facebook","send","remix.europeana.eu"])},!1);i("top-controls",{opacity:{from:0,to:1}},0.5);f.addEventListener("load",function(){d(!0)},!1);f.addEventListener("resize",d,!0);h.addEventListener("mousemove",function(a){L=Date.now();ba=b(a)},!1);var g=[{url:"image/page-bg.jpg",category:"display"},"image/background.jpg",{url:h.getElementById("main-style").getAttribute("href"),mode:"font",id:"chevin",families:["Chevin-Light"],category:"display"},"image/bg.png","image/logo.png",
"image/icon_facebook.png","image/icon_twitter.png","image/radio.png","image/settings.png"];F&&(g=g.concat([{url:"video/otto-and-bernard.webm",element:m,id:"video",category:"play"},{url:"data/resources.txt?"+Date.now(),type:"json",category:"data",id:"resources"},{url:"data/subtitles.txt",type:"json",category:"data",id:"subtitles"},"image/playpause.png","image/check.png","image/comment.png","image/comments.png","image/volume.png","image/intro-play.png","image/media-icons.png"]));g=new Loaderator(g,
"all",function(){if(!F)return!1;if(A>J)i("bottom-controls",{opacity:{from:0,to:1}},0.5);else{var a=h.getElementById("intro-play");a.innerHTML='<img src="image/intro-play.png"/>';a.addEventListener("click",function(){va.innerHTML='<a href="http://www.europeana.eu" target="_blank"><img src="image/poweredby-white.png"/></a>';m.play()},!1)}f.addEventListener("keypress",n,!1)});g.addEventListener("all:chevin",function(){d();A<J||!F?(i("intro-text",{opacity:{from:0,to:1}},1),i("intro-en",{opacity:{from:0,
to:1}},1),i("intro-de",{opacity:{from:0,to:1}},1)):h.getElementById("intro-text").style.opacity=1});g.addEventListener("all:image/logo.png",function(){d();R.style.zIndex="1500";i(R,{opacity:{from:0,to:1}},1)});g.addEventListener("all:image/page-bg.jpg",function(a){a=a.element;a.id="page-background";P=a;E.parentNode.insertBefore(a,E.nextSibling);if(!F)E.style.display="block"});g.addEventListener("display",function(){fa&&!N&&x(fa);if(A<J||!F)E.style.display="block"});g.addEventListener("all:image/background.jpg",
function(a){d();a=a.element;E.insertBefore(a,E.firstChild);if(F){if(A<J){if(i(a,{opacity:{from:0,to:1}},1,function(){m.style.display="block"}),P)E.style.display="block"}else m.style.display="block";var b=h.getElementById("end"),a=a.cloneNode(!1);b.insertBefore(a,b.firstChild)}});F&&(g.addEventListener("all:video",function(a){a.element.style.visibility="visible";var b=h.getElementById("end"),c=h.getElementById("end-text"),d=h.getElementById("end-close"),e=b.firstChild;w.code({start:"4:26",end:w.duration()-
...
b[c];d.target="resources";if(d.fadeIn===void 0||isNaN(d.fadeIn))d.fadeIn=0.5;if(d.fadeOut===void 0||isNaN(d.fadeOut))d.fadeOut=0.5;w[c](d)}g&&U.indexOf(c)===-1&&(U.push(c),I.resources||w.disable(c))}}),g.addEventListener("data:subtitles",function(a){var b=JSON.parse(a.element.responseText);if(b)for(a=0;a<b.length;a++)b[a].languagesrc=G,w.subtitle(b[a])}),u(),f.addEventListener("keyup",function(a){var b=a.which||a.keyCode;if(H){if(L=Date.now(),b===27)H=!1,X=m.currentTime,h.getElementById("add-comment-controls").style.display=
"none",a.preventDefault()}else b===37?(m.currentTime-=0.04,console.log("left",m.currentTime)):b===39&&(m.currentTime+=0.04,console.log("right",m.currentTime))},!1),w.code({start:0,end:J,onStart:function(){E.style.display="block";h.body.style.backgroundColor="#fff";R.style.zIndex="1500"},onFrame:function(){var a=1-Math.min(w.currentTime()/J,1);E.style.opacity=a;a=Math.round(a*255);h.body.style.backgroundColor="rgb("+a+", "+a+", "+a+")"},onEnd:function(){h.body.style.backgroundColor="#000";E.style.display=
"none";R.style.zIndex=""}}))})()})(window);
