...
q))?(k=k.firstChild.nodeValue||"",k=i(k,32)):k="";var p=c("//dc:description",q),p=p?p.firstChild.nodeValue||"":"",x=c("//dc:source",q);x=x?x.firstChild.nodeValue||"":(x=c("//europeana:provider",q))?x.firstChild.nodeValue||"":"";x&&(x=i("/"+x,50));var q=(q=c("//europeana:object",q))?q.firstChild.nodeValue||"":"",h=document.createElement("div");h.setAttribute("class","content");var Z=document.createElement("article");Z.appendChild(document.createTextNode(p));h.appendChild(Z);h.appendChild(document.createElement("br"));
g.appendChild(h);p=document.createElement("div");p.setAttribute("class","info");k=k.replace("<","&lt;");k=k.replace(">","&gt;");p.innerHTML='<div class="media"><span class="hiding minimize" style="float: right; margin-right: 20px;">minimize window</span>image<span class="hiding"> | <span class="popcorn-source">source</span>: <a href="http://www.europeana.eu/portal/record/'+a.id+'.html" target="_new">Europeana'+x+'</a></span></div><div><a href="http://www.europeana.eu/portal/record/'+a.id+'.html" target="_new">'+
